var projectTaskTotal = {
	...
	createPaingGrid : function(programNo, pjtNo){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			id : 'SampleSearchGrid',
			Sort : '-pjtNo',
			perPageOnChange : 'javascript:projectTaskTotal.search(Value);',
			Data : {
				Url : '/plm/ext/dashboard/projectTaskTotalSetting?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
			...
			Cols : [
					...
					{Name : 'taskName', RelWidth:50, Width:90, Align : 'Left', CanSort : '1', CanEdit : '0',Spanned:'1'},
					...
					{Name : 'reason', Width:70, Align : 'Center', CanSort : '1', CanEdit : '0',Spanned:'1'},
				...
				},
				{
					...
					pjtNo : "Project No", pjtNoRowSpan:'2',//제목
					pjtName : "Project Name", pjtNameRowSpan:'2',//'등록일'
					carType : LocaleUtil.getMessage('04122'), carTypeRowSpan:'2',
					stateState : LocaleUtil.getMessage('01760'), stateStateRowSpan : '2',
					taskName :"Task" , taskNameRowSpan :'2',
					departName : LocaleUtil.getMessage('07274'), departNameRowSpan :'2',
					userName : LocaleUtil.getMessage('07275'), userNameRowSpan:'2',
		...
		//row click event
		Grids.OnClick = projectTaskTotal.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/projectTaskTotalSetting?sortName=*Sort0';
	...
	goView : function(grid,row,col,x,y){
			...
			}else if(col == "taskName" && row.oid != "mOid"){
