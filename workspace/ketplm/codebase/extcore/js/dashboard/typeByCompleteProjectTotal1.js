var CompleteProductProjectTotal = {
	...
	createPaingGrid : function(pjtType,type,devType,year){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			id : 'SampleSearchGrid',
			Sort : '-pjtNo',
			perPageOnChange : 'javascript:CompleteProductProjectTotal.search(Value);',
			Data : {
				Url : '/plm/ext/dashboard/typeByCompleteProjectTotal1?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
			...
			Cols : [
					...
					{Name : 'resultCost', Width:90, Align : 'Right', CanSort : '1', CanEdit : '0', Type:'Int', Format:",0", Spanned:'1'},
		...
		//row click event
		Grids.OnClick = CompleteProductProjectTotal.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/typeByCompleteProjectTotal1?sortName=*Sort0';
