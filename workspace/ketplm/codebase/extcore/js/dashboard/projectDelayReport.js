var Sample = {
	...
	createPaingGrid : function(type,state,year,month,moldType,division){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			...
			Data : {
				Url : '/plm/ext/dashboard/projectDelayReport?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
			...
			Cols : [
				...
				{Name : 'type', 	Width:60,  Align : 'Center', CanSort : '1', CanEdit : '0', Type:'Text', Spanned:'1'},
				...
				{Name : 'outsourcing', Width:80, Align : 'Center', CanSort : '1', CanEdit : '0',Spanned:'1'},
		...
		Grids.OnDownloadPage = function(grid,row){
			...
			grid.Data.Page.Url = '/plm/ext/dashboard/projectDelayReport?sortName=*Sort0';
