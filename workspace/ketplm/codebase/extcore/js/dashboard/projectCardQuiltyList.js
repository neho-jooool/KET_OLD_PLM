var projectCardQuiltyList = {
	
	/**
	 * server paging grid
	 */
	createPaingGrid : function(type, pjtNo){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			id : 'SampleSearchGrid',
			Sort : '-pjtNo',
			perPageOnChange : 'javascript:projectCardQuiltyList.search(Value);',
			Data : {
				Url : '/plm/ext/dashboard/projectCardQuiltyListSetting?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
			...
			Cols : [
					...
					{Name : 'problem', 	Width:50,  Align : 'Center', CanSort : '1', CanEdit : '0' ,Spanned:'1'},
					...
					{Name : 'occurName', 	Width:80,  Align : 'Center', CanSort : '1', CanEdit : '0' ,Spanned:'1'},
					{Name : 'occurDate', Type:'Date', Format:"yyyy-MM-dd",	Width:80,  Align : 'Center', CanSort : '1', CanEdit : '0' ,Spanned:'1'},
					...
					{Name : 'occurDivName', 	Width:80,  Align : 'Center', CanSort : '1', CanEdit : '0' ,Spanned:'1'},
					{Name : 'ecrNumber', 	Width:80,  Align : 'Center', CanSort : '0', CanEdit : '0' ,Spanned:'1'},
					{Name : 'completeDate', 	Width:80,  Align : 'Center', Type:'Date', Format:"yyyy-MM-dd" ,CanSort : '1', CanEdit : '0' ,Spanned:'1'},
			...
			Header : 
			{
				...
				occurDate : LocaleUtil.getMessage('07138'), 
				partNo : "Part No",
				carType : LocaleUtil.getMessage('02745'),
				occurDivName : LocaleUtil.getMessage('07139'),
				completeDate : LocaleUtil.getMessage('02179'),
		...
		//row click event
		Grids.OnClick = projectCardQuiltyList.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/projectCardQuiltyListSetting?sortName=*Sort0';
	...
	goView : function(grid,row,col,x,y){
		...
		}else if(col == "problem" && row.oid != undefined){
