var CompleteReviewProject = {
	...
	createPaingGrid : function(pjtType1,type,devType,year){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			id : 'SampleSearchGrid',
			Sort : '-pjtNo',
			perPageOnChange : 'javascript:CompleteReviewProject.search(Value);',
			Data : {
				Url : '/plm/ext/dashboard/typeByCompleteProjectReview?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
			...
			Cols : [
				...
				{Name : 'budgetCostStr', Width:90, Align : 'Right', CanSort : '0', CanEdit : '0',Spanned:'1'},
				{Name : 'resultCostStr', Width:90, Align : 'Right', CanSort : '0', CanEdit : '0',Spanned:'1'},
			...
			Head :[
			{
				...
				displayPlanEndDate : LocaleUtil.getMessage('00591'), displayPlanEndDateSpan:'2', displayPlanEndDateType : "Text",//'수정일'
				...
				resultCostStr : LocaleUtil.getMessage('02032'),resultCostStrRowSpan:'2',//'수정일'
			...
			},
			{
				...
				term : LocaleUtil.getMessage('02733'), termRowSpan:'2',//'수정일'
				departName : LocaleUtil.getMessage('02672'), departNameRowSpan:'2',//'수정일'
				budgetCostStr : LocaleUtil.getMessage('02143'), budgetCostStrRowSpan:'2',//'수정일'
				resultCostStr : LocaleUtil.getMessage('02032'),resultCostStrRowSpan:'2',//'수정일'
				stateState : LocaleUtil.getMessage('01760'), stateStateRowSpan : '2'
			}
			]
		...
		//row click event
		Grids.OnClick = CompleteReviewProject.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/typeByCompleteProjectReview?sortName=*Sort0';
