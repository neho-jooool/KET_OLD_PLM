var moldReport = {
	 ...
	 * server paging grid
	 */
	createPaingGrid : function(programNo, making, itemType){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			id : 'SampleSearchGrid',
			Sort : '-pjtNo',
			perPageOnChange : 'javascript:moldReport.search(Value);',
			Data : {
				Url : '/plm/ext/dashboard/moldReportProjectList?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
			...
			Cols : [
				...
				{Name : 'itemType', Width:80, Align : 'Center', CanSort : '1', CanEdit : '0',Spanned:'1'},
		...
		//row click event
		Grids.OnClick = moldReport.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/moldReportProjectList?sortName=*Sort0';
