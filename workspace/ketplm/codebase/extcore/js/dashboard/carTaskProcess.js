var carTaskProcess = {
	 ...
	 * server paging grid
	 */
	createPaingGrid : function(pjtNo,carType,customer){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			id : 'SampleSearchGrid',
			Sort : '-displayPlanEndDate',
			perPageOnChange : 'javascript:carTaskProcess.search(Value);',
			Data : {
				Url : '/plm/ext/dashboard/carTaskProcessSetting?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
			...
			Cols : [
					...
					{Name : 'taskName', Width:140, Align : 'Left', CanSort : '1', CanEdit : '0',Spanned:'1'},
					...
					{Name : 'displayPlanEndDate',	Width:80, Align : 'Center', CanSort : '0', CanEdit : '0', Type:'Date', Format:"yyyy-MM-dd" , Spanned:'1'}, //RelWidth:50
					{Name : 'displayExecEndDate', Width:80, Align : 'Center', CanSort : '0', CanEdit : '0',Type:'Date', Format:"yyyy-MM-dd", Spanned:'1'},
					{Name : 'debug', Width:60, Align : 'Center', CanSort : '1', CanEdit : '0',Spanned:'1'},
				...
				Head :[
				{
					...
					displayPlanEndDate : LocaleUtil.getMessage('00822'), displayPlanEndDateSpan:'2', displayPlanEndDateType:"Text",//'수정일'
				...
				},
				{
					...
					debug : LocaleUtil.getMessage('03349'), resultCostRowSpan:'2',//'수정일'
				}
				]
			/*,
			SelectingSingle : '1',
		...
		//row click event
		Grids.OnClick = carTaskProcess.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/carTaskProcessSetting?sortName=*Sort0';
	...
	goView : function(grid,row,col,x,y){
			...
			}else if(col == "taskName" && row.mOid != "mOid"){
