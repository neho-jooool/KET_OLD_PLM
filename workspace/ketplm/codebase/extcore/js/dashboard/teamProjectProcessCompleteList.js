var teamProjectProcessCompleteList = {
	...
	createPaingGrid : function(departName,userName,startDate,endDate){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			...
			Data : {
				Url : '/plm/ext/dashboard/teamProjectProcessCompleteListSetting?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
		...
		//row click event
		Grids.OnClick = teamProjectProcessCompleteList.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/teamProjectProcessCompleteListSetting?sortName=*Sort0';
