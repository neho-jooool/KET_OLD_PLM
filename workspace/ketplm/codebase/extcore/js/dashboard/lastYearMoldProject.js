var lastYearMoldProject = {
	
	/**
	 * server paging grid
	 */
	createPaingGrid : function(type,devType,year,division){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			id : 'SampleSearchGrid',
			Sort : '-pjtNo',
			perPageOnChange : 'javascript:lastYearMoldProject.search(Value);',
			Data : {
				Url : '/plm/ext/dashboard/lastYearMoldProjectProjectList?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
		...
		//row click event
		Grids.OnClick = lastYearMoldProject.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/lastYearMoldProjectProjectList?sortName=*Sort0';
