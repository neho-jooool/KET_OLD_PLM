var prodTypeProdProc = {
	...
	createPaingGrid : function(level2){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			id : 'SampleSearchGrid',
			Sort : '-pjtNo',
			perPageOnChange : 'javascript:prodTypeProdProc.search(Value);',
			Data : {
				Url : '/plm/ext/dashboard/prodTypeProdProcSetting?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
			...
			Cols : [
				...
				Head :[
						...
						Toolbar : {
							...
							perPageOnChange:'javascript:prodTypeProdComp.search(Value);',
		...
		//row click event
		Grids.OnClick = prodTypeProdProc.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/prodTypeProdProcSetting?sortName=*Sort0';
