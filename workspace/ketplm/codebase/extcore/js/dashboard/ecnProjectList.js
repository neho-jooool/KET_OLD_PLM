var ecnProjectList = {
	...
	createPaingGrid : function(devType, year, divisionFlag){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			id : 'SampleSearchGrid',
			Sort : '-ecnNo',
			perPageOnChange : 'javascript:ecnProjectList.search(Value);',
			Data : {
				Url : '/plm/ext/dashboard/ecnProjectList?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
			...
			Header :
			{
				...
				ecoNo : "ECO No", pjtNoRowSpan:'2',//제목
				ecoName : LocaleUtil.getMessage('00193'),
		...
		//row click event
		Grids.OnClick = ecnProjectList.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/ecnProjectList?sortName=*Sort0';
