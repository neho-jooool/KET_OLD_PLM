var currentSetting1 = {
	...
	createPaingGrid : function(pjtType,type,devType,year,month){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			id : 'SampleSearchGrid',
			Sort : '-pjtNo',
			perPageOnChange : 'javascript:currentSetting1.search(Value);',
			Data : {
				Url : '/plm/ext/dashboard/currentSettingList1?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
			...
			Head :[
					{
						...
						budgetCost : LocaleUtil.getMessage('02143'), budgetCostRowSpan:'2',//'수정일'
		...
		//row click event
		Grids.OnClick = currentSetting1.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/currentSettingList1?sortName=*Sort0';
