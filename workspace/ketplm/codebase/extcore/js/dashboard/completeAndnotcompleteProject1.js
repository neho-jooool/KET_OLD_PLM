var completeAndnotcompleteProject = {
	...
	createPaingGrid : function(pjtType,type,devType,year){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			id : 'SampleSearchGrid',
			Sort : '-pjtNo',
			perPageOnChange : 'javascript:completeAndnotcompleteProject.search(Value);',
			Data : {
				Url : '/plm/ext/dashboard/completeAndnotcompleteProjectList1?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
			...
			Cols : [
				...
				{Name : 'pjtName', 	Width:150,  Align : 'Left', CanSort : '1', CanEdit : '0' ,Spanned:'1'},
				...
				{Name : 'isDone', 	Width:100,  Align : 'Center', CanSort : '1', CanEdit : '0' ,Spanned:'1'},
		...
		//row click event
		Grids.OnClick = completeAndnotcompleteProject.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/completeAndnotcompleteProjectList1?sortName=*Sort0';
