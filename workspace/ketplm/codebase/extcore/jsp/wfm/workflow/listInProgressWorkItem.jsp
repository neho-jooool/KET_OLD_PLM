...
<script src="/plm/extcore/js/wfm/workflow/listInProgressWorkItem.js"></script>
<script type="text/javascript">
    $(document).ready(function(e) {
        ...
        WorkItem.createGrid();
        treeGridResize("#listInProgressWorkItemGrid","#listInProgressWorkItemGridDiv");//크롬에서 그리드 리사이즈 하기 위한 코드 param1 : grid Id, param2 : divId
        // Enter
      ...
      <td valign="top">
            ...
            <td><table style="width: 100%; height: 28px;" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td align="right"><img src="/plm/portal/images/icon_navi.gif">Home<img src="/plm/portal/images/icon_navi.gif"><%=messageService.getString("e3ps.message.ket_message", "00788")%><%--결재함--%>
                    <img src="/plm/portal/images/icon_navi.gif"><%=messageService.getString("e3ps.message.ket_message", "00787")%><%--결재진행함--%></td>
                </tr>
              </table></td>
          </tr>
          <tr>
        ...
        <table border="0" cellspacing="0" cellpadding="0" style="width: 100%;">
          ...
          <tr>
            ...
            <td class="tdblueM"><%=messageService.getString("e3ps.message.ket_message", "05111")%><!-- 상신일 --></td>
        ...
        <div class="container-fluid">
          <div class="row-fluid">
            <div id="listInProgressWorkItemGridDiv" style="WIDTH: 100%; HEIGHT: 100%"></div>
          </div>
