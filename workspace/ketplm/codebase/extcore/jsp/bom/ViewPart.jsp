        ...
        <div id="tabs">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="left">
                <ul>
                  <li><a class="tabref" href="#tabs-1" rel="">PART</a></li>
                  <li><a class="tabref" href="#tabs-2" rel="/plm/extcore/jsp/bom/KETBomEditor.jsp?oid=<%=poid%>" onClick="alert(document.iframes.length);document.getElementById('tabs-2').iframe[0].storeLoad();">BOM</a></li>
                </ul>
              </td>
              <td align="right">
          ...
          <div id="tabs-1" class="tabMain">
            <div class="tabIframeWrapper">
              <iframe class="iframetab" src="/plm/ext/part/base/viewDetailPartForm.do?isIframe=<%=isIframe %>&partOid=<%=poid%>">Load Failed?</iframe>
            </div>
          </div>
