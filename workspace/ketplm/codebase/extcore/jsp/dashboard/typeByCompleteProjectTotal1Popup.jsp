...
<script type="text/javascript" src="/plm/extcore/js/dashboard/typeByCompleteProjectTotal1.js"></script>
...
$(document).ready(function(){
   ...
   // alert("${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
    ...
    CompleteProductProjectTotal.createPaingGrid("${dashBoardDTO.pjtType}","${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
});
