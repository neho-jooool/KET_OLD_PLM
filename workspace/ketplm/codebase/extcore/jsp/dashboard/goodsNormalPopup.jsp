...
<script type="text/javascript" src="/plm/extcore/js/dashboard/goodsNormal.js"></script>
<!-- EJS TreeGrid End -->
<body class="popup-background popup-space t-space50">
<!-- EJS TreeGrid Start -->
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.customer}"+" "+"${dashBoardDTO.carType}"+"  "+"${dashBoardDTO.year}");
    ...
    goodsNormal.createPaingGrid("${dashBoardDTO.programNo}");
});
