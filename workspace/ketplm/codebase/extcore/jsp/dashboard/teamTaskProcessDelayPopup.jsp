...
<script type="text/javascript" src="/plm/extcore/js/dashboard/teamTaskProcessDelayData.js"></script>
<!-- EJS TreeGrid End -->
...
$(document).ready(function(){
    ...
    teamTaskProcessDelayData.createPaingGrid("${dashBoardDTO.userName}","${dashBoardDTO.startDate}","${dashBoardDTO.endDate}","${dashBoardDTO.departName}");
});
