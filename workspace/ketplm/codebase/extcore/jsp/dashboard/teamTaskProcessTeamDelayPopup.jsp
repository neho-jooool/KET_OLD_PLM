...
<script type="text/javascript" src="/plm/extcore/js/dashboard/teamTaskProcessTeamDelayData.js"></script>
<!-- EJS TreeGrid End -->
...
$(document).ready(function(){
    ...
    teamTaskProcessTeamDelayData.createPaingGrid("${dashBoardDTO.displayCode}","${dashBoardDTO.startDate}","${dashBoardDTO.endDate}","${dashBoardDTO.departName}");
});
