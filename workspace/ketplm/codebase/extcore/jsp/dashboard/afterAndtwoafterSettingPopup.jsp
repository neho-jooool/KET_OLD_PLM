...
<script type="text/javascript" src="/plm/extcore/js/dashboard/afterAndtwoafterProject.js"></script>
...
$(document).ready(function(){
   ...
   // alert("${dashBoardDTO.type}"+" "+"${dashBoardDTO.devType}"+"  "+"${dashBoardDTO.year}"+" "+"${dashBoardDTO.month}");
    afterAndtwoafterProject.createPaingGrid("${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}","${dashBoardDTO.month}","${dashBoardDTO.pjtType}");
