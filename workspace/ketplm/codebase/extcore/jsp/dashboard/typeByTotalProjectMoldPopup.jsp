...
<script type="text/javascript" src="/plm/extcore/js/dashboard/typeByTotalProjectMold.js"></script>
...
$(document).ready(function(){
 ...
 //   alert("${dashBoardDTO.type}"+"  "+"${dashBoardDTO.devType}"+"  "+"${dashBoardDTO.year}");
    ...
    MoldProject.createPaingGrid("${dashBoardDTO.pjtType2}","${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
