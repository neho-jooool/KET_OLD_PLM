...
<script type="text/javascript" src="/plm/extcore/js/dashboard/typeByTotalProjectTotal2.js"></script>
...
//    alert("${dashBoardDTO.type}"+"  "+"${dashBoardDTO.devType}"+"  "+"${dashBoardDTO.year}");
    ...
    TotalProject.createPaingGrid("${dashBoardDTO.pjtType2}","${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
});
