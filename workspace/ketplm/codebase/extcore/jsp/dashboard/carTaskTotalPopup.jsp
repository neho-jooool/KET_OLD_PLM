...
<script type="text/javascript" src="/plm/extcore/js/dashboard/carTaskTotal.js"></script>
<!-- EJS TreeGrid End -->
...
$(document).ready(function(){
    ...
    carTaskTotal.createPaingGrid("${dashBoardDTO.pjtNo}","${dashBoardDTO.carType}","${dashBoardDTO.customer}");
});
