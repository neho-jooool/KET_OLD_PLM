...
<script type="text/javascript" src="/plm/extcore/js/dashboard/lastYearMoldProject.js"></script>
...
$(document).ready(function(){
    ...
    lastYearMoldProject.createPaingGrid("${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}","${dashBoardDTO.division}");
