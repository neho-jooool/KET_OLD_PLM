...
<script type="text/javascript" src="/plm/extcore/js/dashboard/typeByProcessProjectReview.js"></script>
...
$(document).ready(function(){
   ...
   // alert("${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
    ...
    ProcessReviewProject.createPaingGrid("${dashBoardDTO.pjtType1}","${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
