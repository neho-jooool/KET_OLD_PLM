...
<script type="text/javascript" src="/plm/extcore/js/dashboard/productCompleteTask.js"></script>
<!-- EJS TreeGrid End -->
...
$(document).ready(function(){
    ...
    productCompleteTask.createPaingGrid("${dashBoardDTO.customer}","${dashBoardDTO.carType}","${dashBoardDTO.year}");
});
