...
<script type="text/javascript" src="/plm/extcore/js/dashboard/projectCardQuiltyList.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.customer}"+" "+"${dashBoardDTO.carType}"+"  "+"${dashBoardDTO.year}");
    ...
    projectCardQuiltyList.createPaingGrid("${dashBoardDTO.type}","${dashBoardDTO.pjtNo}");
});
