...
<script type="text/javascript" src="/plm/extcore/js/dashboard/completeProcessTypeProject.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.making}"+" "+"${dashBoardDTO.type}"+"  "+"${dashBoardDTO.moldTypeCheck}");
    ...
    completeProcessTypeProject.createPaingGrid("${dashBoardDTO.making}","${dashBoardDTO.type}","${dashBoardDTO.year}","${dashBoardDTO.moldTypeCheck}","${dashBoardDTO.division}");
