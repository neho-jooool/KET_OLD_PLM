...
<script type="text/javascript" src="/plm/extcore/js/dashboard/teamProjectTeamDelayList.js"></script>
...
$(document).ready(function(){
	teamProjectTeamDelayList.createPaingGrid("${dashBoardDTO.departName}","${dashBoardDTO.displayCode}","${dashBoardDTO.startDate}","${dashBoardDTO.endDate}");
});
</script>