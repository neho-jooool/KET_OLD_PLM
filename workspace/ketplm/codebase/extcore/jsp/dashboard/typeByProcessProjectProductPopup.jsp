...
<script type="text/javascript" src="/plm/extcore/js/dashboard/typeByProcessProjectProduct.js"></script>
...
$(document).ready(function(){
    ...
    ProcessProductProject.createPaingGrid("${dashBoardDTO.pjtType}","${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
