...
<script type="text/javascript" src="/plm/extcore/js/dashboard/teamIssueTeamList.js"></script>
...
$(document).ready(function(){
    ...
    teamIssueTeamList.createPaingGrid("${dashBoardDTO.displayCode}","${dashBoardDTO.startDate}");
});
