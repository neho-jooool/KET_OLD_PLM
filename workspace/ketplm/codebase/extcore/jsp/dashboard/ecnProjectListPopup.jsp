...
<script type="text/javascript" src="/plm/extcore/js/dashboard/ecnProjectList.js"></script>
<jsp:useBean id="messageService" class="e3ps.common.message.KETMessageService" scope="session" />
<!-- EJS TreeGrid End -->
<body class="popup-background popup-space">
<div class="sub-title"><img src="/plm/portal/images/icon_3.png" /><%=messageService.getString("e3ps.message.ket_message", "07303") %></div>
...
$(document).ready(function(){
   ...
   // alert("${dashBoardDTO.type}"+" "+"${dashBoardDTO.devType}"+"  "+"${dashBoardDTO.year}");
    ...
    ecnProjectList.createPaingGrid("${dashBoardDTO.devType}","${dashBoardDTO.year}","${dashBoardDTO.divisionFlag}");
