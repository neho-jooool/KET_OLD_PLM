...
<script type="text/javascript" src="/plm/extcore/js/dashboard/typeByTotalProjectProduct.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.type}"+"  "+"${dashBoardDTO.devType}"+"  "+"${dashBoardDTO.year}");
    ...
    ProductProject.createPaingGrid("${dashBoardDTO.pjtType}","${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
