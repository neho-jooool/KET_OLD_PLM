...
<script type="text/javascript" src="/plm/extcore/js/dashboard/carTaskComplete.js"></script>
<!-- EJS TreeGrid End -->
...
$(document).ready(function(){
    ...
    carTaskComplete.createPaingGrid("${dashBoardDTO.pjtNo}","${dashBoardDTO.carType}","${dashBoardDTO.customer}");
});
