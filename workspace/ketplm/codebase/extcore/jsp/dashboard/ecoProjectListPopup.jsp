...
<script type="text/javascript" src="/plm/extcore/js/dashboard/ecoProjectList.js?ver=1"></script>
<jsp:useBean id="messageService" class="e3ps.common.message.KETMessageService" scope="session" />
<!-- EJS TreeGrid End -->
<body class="popup-background popup-space">
<div class="sub-title"><img src="/plm/portal/images/icon_3.png" /><%=messageService.getString("e3ps.message.ket_message", "07304") %></div>
...
$(document).ready(function(){
   ...
   // alert("${dashBoardDTO.type}"+" "+"${dashBoardDTO.devType}"+"  "+"${dashBoardDTO.year}");
    ...
    ecoProjectList.createPaingGrid("${dashBoardDTO.devType}","${dashBoardDTO.year}","${dashBoardDTO.divisionFlag}","${dashBoardDTO.dataType}");
