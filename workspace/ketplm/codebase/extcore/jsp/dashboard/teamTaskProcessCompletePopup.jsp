...
<script type="text/javascript" src="/plm/extcore/js/dashboard/teamTaskProcessCompleteData.js"></script>
<!-- EJS TreeGrid End -->
...
$(document).ready(function(){
    ...
    teamTaskProcessCompleteData.createPaingGrid("${dashBoardDTO.userName}","${dashBoardDTO.startDate}","${dashBoardDTO.endDate}","${dashBoardDTO.departName}");
});
