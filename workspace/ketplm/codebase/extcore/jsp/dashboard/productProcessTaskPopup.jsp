...
<script type="text/javascript" src="/plm/extcore/js/dashboard/productProcessTask.js"></script>
<!-- EJS TreeGrid End -->
...
$(document).ready(function(){
    ...
    productProcessTask.createPaingGrid("${dashBoardDTO.customer}","${dashBoardDTO.carType}","${dashBoardDTO.year}");
});
