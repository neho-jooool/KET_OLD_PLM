...
<script type="text/javascript" src="/plm/extcore/js/dashboard/itemGoodsListPopup.js"></script>
...
$(document).ready(function(){
    ...
    itemGoodsListPopup.createPaingGrid("${dashBoardDTO.customer}","${dashBoardDTO.carType}","${dashBoardDTO.itemType}");
});
