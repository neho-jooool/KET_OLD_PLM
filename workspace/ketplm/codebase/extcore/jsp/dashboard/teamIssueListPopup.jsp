...
<script type="text/javascript" src="/plm/extcore/js/dashboard/teamIssueList.js"></script>
...
$(document).ready(function(){
    ...
    teamIssueList.createPaingGrid("${dashBoardDTO.userName}","${dashBoardDTO.startDate}");
});
