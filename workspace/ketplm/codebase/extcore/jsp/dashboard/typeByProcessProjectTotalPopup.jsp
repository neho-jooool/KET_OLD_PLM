...
<script type="text/javascript" src="/plm/extcore/js/dashboard/typeByProcessProjectTotal.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
    ...
    ProcessReviewProjectTotal.createPaingGrid("${dashBoardDTO.pjtType1}","${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
});
