...
<script type="text/javascript" src="/plm/extcore/js/dashboard/moldTypeList.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.making}"+" "+"${dashBoardDTO.type}"+"  "+"${dashBoardDTO.moldTypeCheck}");
    ...
    moldTypeList.createPaingGrid("${dashBoardDTO.division}","${dashBoardDTO.programNo}","${dashBoardDTO.itemType}");
});
