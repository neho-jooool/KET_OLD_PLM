...
<script type="text/javascript" src="/plm/extcore/js/dashboard/teamProjectPlanList.js"></script>
...
$(document).ready(function(){
	teamProjectPlanList.createPaingGrid("${dashBoardDTO.departName}","${dashBoardDTO.userName}","${dashBoardDTO.startDate}","${dashBoardDTO.endDate}");
});
</script>