...
<script type="text/javascript" src="/plm/extcore/js/dashboard/projectTaskComplete.js"></script>
<!-- EJS TreeGrid End -->
...
$(document).ready(function(){
    ...
    projectTaskComplete.createPaingGrid("${dashBoardDTO.programNo}","${dashBoardDTO.pjtNo}");
});
