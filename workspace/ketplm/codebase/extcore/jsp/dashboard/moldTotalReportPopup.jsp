...
<script type="text/javascript" src="/plm/extcore/js/dashboard/moldTotalReport.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.customer}"+" "+"${dashBoardDTO.carType}"+"  "+"${dashBoardDTO.year}");
    ...
    moldTotalReport.createPaingGrid("${dashBoardDTO.programNo}", "${dashBoardDTO.itemType}");
});
