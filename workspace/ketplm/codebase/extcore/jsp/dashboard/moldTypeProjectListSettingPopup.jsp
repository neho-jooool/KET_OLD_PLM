...
<script type="text/javascript" src="/plm/extcore/js/dashboard/moldTypeProject.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.making}"+" "+"${dashBoardDTO.type}"+"  "+"${dashBoardDTO.moldTypeCheck}");
    ...
    moldTypeProject.createPaingGrid("${dashBoardDTO.year}","${dashBoardDTO.month}","${dashBoardDTO.outsourcing}","${dashBoardDTO.itemType}","${dashBoardDTO.moldType}","${dashBoardDTO.division}");
});
