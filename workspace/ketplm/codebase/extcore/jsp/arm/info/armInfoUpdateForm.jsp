                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="btn_blue" background="/plm/portal/images/btn_bg1.gif">
                                <a href="javascript:Arm.updateInfo();" class="btn_blue"><%=messageService.getString("e3ps.message.ket_message", "02453") %><!-- 저장 --></a>
                            </td>
    ...
    <div id="tabs-2" style="height:500px"><!-- 해석접수 -->
        ...
        <table id="createTable" width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td class="tdwhiteL"><ket:select id="analysisDivision" name="analysisDivision" className="fm_jmp" style="width: 170px;" codeType="ANALYSISDIVISION" multiple="multiple" value="${analysis.analysisDivision}"/></td>
            </tr>
            <tr>
                ...
                <td class="tdwhiteL">
	                ...
	                <textarea name="webEditor" rows="0" cols="0" style="display: none">${analysisInfo.webEditor}</textarea> <!-- 이 부분은 배경색 또는 배경이미지 버튼을 사용하는 경우에만 해당 : DB에 컨텐츠 내용과는 별도로 저장할 것-->
	                ...
	                <textarea name="webEditorText" rows="0" cols="0" style="display: none"${analysisInfo.webEditorText}></textarea> <!-- Editor Area Container : Start -->
	                <div id="EDITOR_AREA_CONTAINER"></div> <!-- Editor Area Container : End -->
                </td>
            </tr>
            <tr>
                <td class="tdblueL">설계목표</td>
                <td class="tdwhiteL"><textarea name="designSpec" id="designSpec" style="width:100%; height:5em">${analysisInfo.designSpec}</textarea></td>
            </tr>
            <tr>
                <td class="tdblueL">추가사항</td>
                <td class="tdwhiteL"><textarea name="requestedTerm" id="requestedTerm" style="width:100%; height:3em">${analysisInfo.requestedTerm}</textarea></td>
            </tr>
        </table>    
        </form>
    </div>
