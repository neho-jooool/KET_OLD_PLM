	    ...
	    <td valign="top" style="padding: 0px 0px 0px 0px">
	        ...
	        <div id="tabs">
				    ...
				    <table width="100%" border="0" cellspacing="0" cellpadding="0">
				        ...
				        <td align="left">
					        <ul>
			                    <li><a class="tabref" href="#tabs-1" rel="/plm/ext/part/base/modifyPartForm.do?partOid=<%=poid%>">PART</a></li>
				...
				<div id="tabs-1" class="tabMain">
				    <div class="tabIframeWrapper">
                        <iframe class="iframetab" src="/plm/ext/part/base/modifyPartForm.do?partOid=<%=poid%>">Load Failed?</iframe>
				    </div>
				</div>
