...
<title><%=messageService.getString("e3ps.message.ket_message", "00765") %><%--결재대상 BOMECO View--%></title>
...
function search(){
    document.forms[0].action =  '/plm/servlet/WFBomViewServlet';
...
function wfbomeco_open() {
    var url = "/plm/jsp/bom/WFBomEcoView.jsp?oid=260522";
...
<form method="post">
<input type="hidden" name="cmd" value="bomeco_search">
...
<table width="1400" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="top">
        ...
        <tr>
          <td>
              ...
              <tr>
                ...
                <td class="font_01"><%=messageService.getString("e3ps.message.ket_message", "00766") %><%--결재대상 BOMECO 구조--%></td>
...
if(condition != null)
{
    if( PartUtil.isProductType(condition.get("part_type")) )
    {
%>
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
...
%>
        <tr id='<%=trId%>'>
          ...
          <td width="17%" class="tdwhiteL"><%=earlyWarning.get("itemname") %>&nbsp;</td>
          ...
          <td width="12%" class="tdwhiteL" style="text-overflow:ellipsis;overflow:hidden" title='<%=earlyWarning.get("subcode") %>'><%=earlyWarning.get("subcode") %>&nbsp;</td>
          <td width="9%"  class="tdwhiteL"><%=earlyWarning.get("econo") %>&nbsp;</td>
...
%>
    ...
    <td width="15%" class="tdblueM"><%=messageService.getString("e3ps.message.ket_message", "01569") %><%--부품번호--%></td>
      ...
      <td width="7%" class="tdblueM0"><%=messageService.getString("e3ps.message.ket_message", "01865") %><%--설계일자--%></td>
      ...
      <td width="8%" class="tdblueM">ECO No</td>
    </tr>
    </table>
    <div style="width=100%;overflow-x:hidden;overflow-y:auto;">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
...
%>
        <tr id='<%=trId%>'>
          ...
          <td width="7%"  class="tdwhiteL"><%=earlyWarning.get("material") %>&nbsp;</td>
          <td width="6%" class="tdwhiteL"><%=earlyWarning.get("hardnessfrom") %>&nbsp;</td>
          <td width="6%"  class="tdwhiteL"><%=earlyWarning.get("hardnessto") %>&nbsp;</td>
          <td width="7%" class="tdwhiteM0"><%=earlyWarning.get("designdate") %>&nbsp;</td>
          <td width="3%"  class="tdwhiteM"><%=earlyWarning.get("version") %>&nbsp;</td>
          <td width="7%"  class="tdwhiteM"><%=earlyWarning.get("status") %>&nbsp;</td>
          <td width="8%"  class="tdwhiteL" title="<%=earlyWarning.get("econo") %>">
              <div class="ellipsis" style="width:88"><nobr><%=earlyWarning.get("econo") %>&nbsp;</nobr></div></td>
        </tr>
<%
             }
        }else{
