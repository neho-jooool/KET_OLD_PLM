			...
			<table width="695" height="50" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr valign="middle">
					<td height="60" align="center">
						...
						<input name="password" type="text" size="20" maxlength="20" onkeydown="javascript:enterLogin()">&nbsp;&nbsp;&nbsp;
...
<br><br>
<div align="center">
  <span class="mainBottomFont">&nbsp&nbsp <span class="mainBottomColor">문의사항은 <b>경영기획본부 경영정보팀(<img border=0 src="../images/common/icon_phone.gif">1156)</b>으로
  문의 바랍니다.<br>
