...
<html>
<head>
<title><%=messageService.getString("e3ps.message.ket_message", "01866") %><%--설명--%></title>
      ...
      <tr>
        <td background="/plm/portal/images/logo_popupbg.png"><table height="28" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td class="font_01"><%=messageService.getString("e3ps.message.ket_message", "01866") %><%--설명--%></td>
          </tr>
        </table></td>
          ...
          <td valign="top">
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="460">
              ...
              <tr>
                ...
                <td class="tdwhiteL0"><textarea name="reason" style="width:100%" rows="5" class="fm_area" ReadOnly><%=task.getTaskDesc()==null?"":task.getTaskDesc()%></textarea></td>
