...
<%
    ...
    String issueOid = request.getParameter("issueOid");
    ...
    if(issueOid != null){
        issue = (Issue)CommonUtil.getObject(issueOid);
    }
...
<Script>
    ...
    function CreateIssue(){
        ...
        if(cmd.value == ""){
            ...
            if( checkField(document.forms[0].handlingcontents, "처리 내용") ){
                document.forms[0].description.focus();
                return;
            }
...
<title><%=messageService.getString("e3ps.message.ket_message", "02296") %><%--이슈--%></title>
<style type="text/css">
<!--
body {
...
<input type= "hidden" name= "issueOid" value = <%=issueOid%> >
        ...
        <td valign="top" style="padding:0px 0px 0px 0px">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" background="/plm/portal/images/img_default/title_bar_a02.gif" style="margin:0px 0px 15px 0px">
              <tr>
                ...
                <td class="font_01"><%=messageService.getString("e3ps.message.ket_message", "00276") %><%--Issue 처리--%></td>
                <td align="right" style="padding:8px 0px 0px 0px">Home &gt; <%=messageService.getString("e3ps.message.ket_message", "03108") %><%--프로젝트관리--%> &gt; <%=messageService.getString("e3ps.message.ket_message", "00276") %><%--Issue 처리--%> </td>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    <td class="titleD"><%=messageService.getString("e3ps.message.ket_message", "00264") %><%--Issue--%> <%=type%> </td>
                    <td align="right">&nbsp;
                    </td>
                </tr>
            </table>
            ...
            <COL width="15%"><COL width="35%"><COL width="15%"><COL width="35%">
                <tr>
                    ...
                    <td class="tdwhiteL0" colspan = 3>
                        <input name="title" class="txt_field" style="width:100%" value="" engnum="engnum" onKeyUp="common_CheckStrLength(this, 60)" onChange="common_CheckStrLength(this, 60)" style="width:100%"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="tdwhiteL">
                        <input name="planCompleteDate" value="" class="txt_field" size="12" engnum="engnum" maxlength=15 readonly onclick="javascript:openCal('planCompleteDate');"/>
                ...
                <tr>
                    ...
                    <td class="tdwhiteL0" colspan="3">
                        <textarea name="description" cols="108" rows="5" class="fm_area"onKeyUp="common_CheckStrLength(this, 666)" onChange="common_CheckStrLength(this, 666)" style="width:100%"></textarea><br>
                    </td>
                </tr>
                <tr>
                        ...
                        <div style="width=99%;overflow-x:hidden;border:1px;border-style:solid;border-color:#5F9EA0;padding:0px;margin:1px 1px 5px;">
                            <table border="0" cellspacing="0" cellpadding="0" width="100%" id="ecrtable">
                                <tr>
                                    ...
                                    <td class="tdblueM0" width="80"><%=messageService.getString("e3ps.message.ket_message", "02431") %><%--작성자--%></td>
                                    <td class="tdblueM0" width="30"><%=messageService.getString("e3ps.message.ket_message", "01690") %><%--삭제--%></td>
                                </tr>
                            </table>
                        </div>
...
%>
            ...
            <COL width="15%"><COL width="35%"><COL width="15%"><COL width="35%">
                ...
                <tr>
                    <td class="tdblueL"><%=messageService.getString("e3ps.message.ket_message", "02319") %><%--이슈요청자--%> <span class="style1"> *</span></td>
                    <td class="tdwhiteL">
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    <td class="titleD"><%=messageService.getString("e3ps.message.ket_message", "00276") %><%--Issue 처리--%> </td>
                    <td align="right">&nbsp;
                    </td>
                </tr>
            </table>
            ...
            <COL width="15%"><COL width="85%">
                <tr>
                    <td class="tdblueL"><%=messageService.getString("e3ps.message.ket_message", "02777") %><%--처리 내용--%><span class="style1"> *</span></td>
                    <td class="tdwhiteL0">
                        <textarea name="handlingcontents" cols="108" rows="5" class="fm_area"onKeyUp="common_CheckStrLength(this, 666)" onChange="common_CheckStrLength(this, 666)" style="width:100%"></textarea><br>
                    </td>
                </tr>
                <tr>
                    <td class="tdblueL"><%=messageService.getString("e3ps.message.ket_message", "02472") %><%--적용할 ECR--%> </td>
