...
<%
  ...
  %>
    <script>
      ...
      <%}else{%>
      parent.movePaage('/plm/jsp/project/ProjectViewLeftFrm.jsp?oid=<%=copyOid%>', '/plm/jsp/project/WorkProjectView.jsp?oid=<%=copyOid%>&cmd=');
      <%}%>
    </script>
  <%  }
  }
  ...
  %>
    <script>
      ...
      //parent.document.location.href  = "/plm/jsp/project/ProjectViewFrm.jsp?oid=<%=oid%>&popup=<%=popup%>";
      <%}else{%>
      parent.movePaage('/plm/jsp/project/ProjectViewLeftFrm.jsp?oid=<%=oid%>', '/plm/jsp/project/WorkProjectView.jsp?oid=<%=oid%>&cmd=');
      <%}%>
    </script>
  <%  }
  }
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td background="/plm/portal/images/tab_6.png" class="btn_tab">
                                                        <a href="WorkProjectView.jsp?oid=<%=oid%>&popup=<%=popup%>" onclick="showProcessing();" class="btn_tab"><%=messageService.getString("e3ps.message.ket_message", "01120")%><%--기본정보--%></a></td>
                                        ...
                                        <td><table border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td background="/plm/portal/images/tab_3.png" class="btn_tab">
                                                        <%=messageService.getString("e3ps.message.ket_message", "02327")%><%--인원--%></td>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td align="right"><table border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <%
                                                                    if (auth.isPM && auth.isLatest || isAdmin || isbizAdmin || auth.isPMO || auth.isPMOE) {
                                                                %>
                                                    ...
                                                    <td align="right">
                                                        <table border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td>&nbsp;</td>
                                                                <%
                                                                    if (auth.isPM && auth.isLatest || isAdmin || auth.isPMO || auth.isPMOE) {
                                                                %>
                                                                <%-- <td width="10"><img src="../../portal/images/btn_1.gif"></td>
                                                                <td class="btn_blue" background="../../portal/images/btn_bg1.gif"><a
