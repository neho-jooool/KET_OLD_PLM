...
<Grid>
    ...
    <LeftCols>
        ...
        <C Name='PjtNo'     Width='90'  Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:left;vertical-align:middle'/>
        <C Name='PjtName'   Width='120' Align='left'   CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='TaskName'  Width='140' Align='left'   CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
    </LeftCols>

    <Cols>
        <C Name='TaskPlanStartDate' Width='90' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='TaskPlanEndDate'   Width='90' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='TaskStatus'        Width='70' Align='Center' CanSort='0' CanEdit='0' Type='Html' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='PjtStatus'         Width='70' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
    </Cols>

    <Header CanDelete='0' Align='Center'
            RowNum            ='<%=messageService.getString("e3ps.message.ket_message", "00342") %><%--No--%>'
            PjtType           ='<%=messageService.getString("e3ps.message.ket_message", "00969") %><%--구분--%>'
            ...
            TaskName          ='<%=messageService.getString("e3ps.message.ket_message", "00479") %><%--Task--%>'
            TaskPlanStartDate ='<%=messageService.getString("e3ps.message.ket_message", "00817") %><%--계획{0}시작일--%>'
            TaskPlanEndDate   ='<%=messageService.getString("e3ps.message.ket_message", "00820") %><%--계획{0}완료일--%>'
            TaskStatus        ='<%=messageService.getString("e3ps.message.ket_message", "03210") %><%--현황--%>'
            PjtStatus         ='<%=messageService.getString("e3ps.message.ket_message", "02176") %><%--완료여부--%>'
            />
