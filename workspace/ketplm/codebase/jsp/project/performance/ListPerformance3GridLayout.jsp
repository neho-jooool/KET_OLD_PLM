...
<Grid>
    ...
    <LeftCols>
        ...
        <C Name='PjtName'     Width='290' Align='Left'   CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
    ...
    <Header id="HeaderTop" Spanned='1' Align='Center'
            ...
            Quality     ='<%=messageService.getString("e3ps.message.ket_message", "00401") %><%--Project 성과--%>'           QualitySpan='6' QualityType='Text'
            />
