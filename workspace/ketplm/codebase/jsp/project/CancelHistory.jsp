...
<head>
<meta charset="UTF-8">
<title><%=messageService.getString("e3ps.message.ket_message", "02698") %><%--중지 사유--%></title>
<base target="_self">
...
<script>
        ...
        <%}
                ...
                opener.location.href = "/plm/jsp/project/ProjectView.jsp?oid=<%=oid%>&command=stateChange&state=STOPED";
        <%}
...
<script type="text/javascript">
    ...
    function deleteFileLine() {
      ...
      var file_checks = document.frm.secondarySelect;
                    ...
                    <td background="/plm/portal/images/logo_popupbg.png">
                     <table style="height: 28px;">
                         <tr>
                          ...
                          <td class="font_01"><%=messageService.getString("e3ps.message.ket_message", "02890") %><%--취소 사유--%></td>
                                ...
                                <tr>
                                    <td>
                                         ...
                                         <tr>
                                             ...
                                             <td class="btn_blue" background="/plm/portal/images/btn_bg1.gif">
                                                 <a href="#" onclick="javascript:insertFileLine();" class="btn_blue"><%=messageService.getString("e3ps.message.ket_message", "02861") %><%--추가--%></a>
                                             </td>
                                             <td style="width: 10px;"><img src="/plm/portal/images/btn_2.gif"></td>
                                         </tr>
                                         </table>
                                    ...
                                    <td>
                                     ...
                                     <tr>
                                         <td style="width: 10px;"><img src="/plm/portal/images/btn_1.gif"></td>
                                         <td class="btn_blue" background="/plm/portal/images/btn_bg1.gif">
                                             <a href="#" onclick="javascript:deleteFileLine();" class="btn_blue"><%=messageService.getString("e3ps.message.ket_message", "01690") %><%--삭제--%></a>
                                         </td>
                                         <td style="width: 10px;"><img src="/plm/portal/images/btn_2.gif"></td>
                                     </tr>
                                        </table>
