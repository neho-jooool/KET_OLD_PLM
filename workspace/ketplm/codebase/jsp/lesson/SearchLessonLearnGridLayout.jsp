...
<Grid>
    ...
    <LeftCols>
        ...
        <C Name='PartNo'     Width='80'  Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
    </LeftCols>

    <Cols>
    	<C Name='CauseGubun'     RelWidth='50' Width='90' Align='Left'   CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
    	<C Name='ImproveGubun'    RelWidth='50' Width='100' Align='Left'   CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='Gubun'      RelWidth='50' Width='140' Align='Left'   CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='Factory'     Width='70' Align='Left'   CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='Department'      Width='100'  Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='Creator'    Width='70'  Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
    ...
    <Header CanDelete='0' Align='Center'
            ...
            CauseGubun 		='<%=messageService.getString("e3ps.message.ket_message", "03448") %><%--원인구분--%>'
            ImproveGubun 		='<%=messageService.getString("e3ps.message.ket_message", "03447") %><%--개선대책구분--%>'
            Gubun 		='<%=messageService.getString("e3ps.message.ket_message", "00969") %><%--구분--%>'
            Factory    	='<%=messageService.getString("e3ps.message.ket_message", "03432") %><%--공장--%>'
            Department	='<%=messageService.getString("e3ps.message.ket_message", "01538") %><%--부서--%>'
