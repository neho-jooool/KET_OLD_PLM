...
<c:forEach var="items" items="${optList}" varStatus="i">
    document.form01.category2.length = pos + 1;
    document.form01.category2.options[pos].value  = "<c:out value="${items[0]}" />";
    document.form01.category2.options[pos++].text = "<c:out value="${items[1]}" />";
</c:forEach>
