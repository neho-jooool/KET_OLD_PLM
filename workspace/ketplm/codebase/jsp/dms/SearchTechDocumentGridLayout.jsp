...
<Grid>
    ...
    <LeftCols>
        ...
        <C Name='DocNo'   Width='90'  Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='DocName' RelWidth='50' Width='200' Align='Left'   CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
    </LeftCols>

    <Cols>
        <C Name='DocType'    Width='120' Align='Left'   CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='Status'     Width='70'  Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='Ver'        Width='50'  Align='Center' CanSort='1' CanEdit='0' Type='Int'  MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        ...
        <C Name='DeptName'    Width='80'  Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        ...
        <C Name='File'       Width='40'  Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' CanExport='0' CanPrint='0'/>
    </Cols>
    ...
    <Header CanDelete='0' Align='Center'
            ...
            DocType    ='<%=messageService.getString("e3ps.message.ket_message", "01432") %><%--문서유형--%>'
            ...
            DeptName    ='<%=messageService.getString("e3ps.message.ket_message", "02425") %><%--작성부서--%>'
