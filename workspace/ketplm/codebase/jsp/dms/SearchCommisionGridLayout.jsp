...
<Grid>
    ...
    <!-- Cfg MaxHeight='300' MinHeight='300'/>
    ...
    <Cols>
        <C Name='RequestDivision' Width='70' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='RequestNo'       Width='80' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='ReviewPjtNo'  Width='80' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='DevPjtNo'     Width='80' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='DevProdName'  Width='90' RelWidth='50' Align='Left'   CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:left;vertical-align:middle'/>
        <C Name='RequestBuyer' Width='90' Align='Left'   CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
    ...
    <Header CanDelete='0' Align='Center'
            RequestDivision ='<%=messageService.getString("e3ps.message.ket_message", "00969") %><%--구분--%>'
            RequestNo       ='<%=messageService.getString("e3ps.message.ket_message", "02249") %><%--의뢰번호--%>'
            ReviewPjtNo     ='<%=messageService.getString("e3ps.message.ket_message", "00726") %><%--검토PJT No--%>'
            DevPjtNo        ='<%=messageService.getString("e3ps.message.ket_message", "00608") %><%--개발PJT No--%>'
            DevProdName     ='<%=messageService.getString("e3ps.message.ket_message", "00664") %><%--개발제품명--%>'
            RequestBuyer    ='<%=messageService.getString("e3ps.message.ket_message", "02261") %><%--의뢰처--%>'
            ...
            <%if(!"Y".equals(searchPopup)){%>
            Step            ='<%=messageService.getString("e3ps.message.ket_message", "02731") %><%--진행상태--%>'
            <%}%>
            />
