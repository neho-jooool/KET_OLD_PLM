...
<Grid>
    ...
    <LeftCols>
        ...
        <C Name='ProdMoldCls' Width='80' Align='Center' CanEdit='0' CanSort='1' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
    ...
    <Cols>
        ...
        <C Name='Creator'      Width='0'  Align='Center' CanEdit='0' CanSort='1' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
    ...
    <Header CanDelete='0' Align='Center'
            ...
            EcoNo        ='<%=messageService.getString("e3ps.message.ket_message", "01486") %><%--No--%>'
            EcoName      ='<%=messageService.getString("e3ps.message.ket_message", "02524") %><%--제목--%>'
