...
<Grid>
    ...
    <LeftCols>
        ...
        <C Name='EcrNo'       Width='80' Align='Center' CanEdit='0' CanSort='1' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
    </LeftCols>

    <Cols>
        <C Name='EcrName'    Width='120' RelWidth='50' Align='Left'   CanEdit='0' CanSort='1' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
        ...
        <C Name='departManagement' Width='80'  Align='Center' CanEdit='0' CanSort='1' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='departPerson' Width='80'  Align='Center' CanEdit='0' CanSort='1' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
        ...
        <C Name='ReviewDate' Width='80'  Align='Center' CanEdit='0' CanSort='1' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
    </Cols>
    ...
    <Header CanDelete='0' Align='Center'
            ...
            EcrNo      ='<%=messageService.getString("e3ps.message.ket_message", "00201") %><%--ECR No--%>'
            EcrName    ='<%=messageService.getString("e3ps.message.ket_message", "00209") %><%--ECR 제목--%>'
