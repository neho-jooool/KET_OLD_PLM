...
<!--
  function save(){
    ...
    showProcessing();
    disabledAllBtn();
    form01.action = "/plm/servlet/e3ps/ManageManualBoardServlet?command=create&from=<%=from %>";
    form01.submit();
  }
...
<tr>
    <td valign="top">
        ...
        <tr>
            <td>
                ...
                <tr>
                    ...
                    <td class="font_01"><%=messageService.getString("e3ps.message.ket_message", "03466") %><%--PLM 사용가이드 등록--%></td>
                </tr>
                </table>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="tdblueL"   style="width: 70px;"><%=messageService.getString("e3ps.message.ket_message", "01606") %><%--분류--%><span class="red">*</span></td>
            <td class="tdwhiteL0">
                ...
                <select id="classification3" name="classification3" class="fm_jmp" style="width:110px;">
                </select>
            </td>
        </tr>
        <tr>
        ...
        <%-- <tr>
            <td class="tdblueL" style="width: 120px;"><%=messageService.getString("e3ps.message.ket_message", "00543") %>URL</td>
            <td class="tdwhiteL0" colspan="3">
                <input type="text" class="txt_field" name="url" style="width:99.5%;" engnum="engnum" onKeyUp="common_CheckStrLength(this, 1333)"  onChange="common_CheckStrLength(this, 1333)" >
            </td>
        </tr> --%>
        <tr>
