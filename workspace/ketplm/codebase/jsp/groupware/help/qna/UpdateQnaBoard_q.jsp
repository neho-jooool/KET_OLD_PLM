...
<%
  ...
  QnaBoardData data = new QnaBoardData(board,1);
...
<!--
  function modify(){
    ...
    showProcessing();
    disabledAllBtn();
    form01.action = "/plm/servlet/e3ps/ManageQnaBoardServlet?command=update&from=<%=from %>";
    form01.submit();
  }
    ...
    <td valign="top">
        ...
        <tr>
            ...
            <td class="tdwhiteL" style="width: 270px;">
                <input type="text" class="txt_field" name="title" value="<%=data.getTitle() %>" style="width:270px;" engnum="engnum" onKeyUp="common_CheckStrLength(this, 1333)"  onChange="common_CheckStrLength(this, 1333)" >
            </td>
            ...
            <td class="tdwhiteL0" style="width: 270px;">
                ...
                NumberCode numberCode = NumberCodeHelper.manager.getNumberCode("QNATYPE", data.getClassification());
                NumberCode parentNumberCode = numberCode.getParent();
                String parentCode = null;
                if (parentNumberCode != null) {
                  parentCode = parentNumberCode.getCode();
                }
                Kogger.debug("parentCode=" + parentCode);
        ...
        <tr>
            ...
            <td class="tdwhiteL0" colspan="3" style="padding:5px">
                ...
                for(int i=0; vec !=null && i<vec.size(); i++) {
                    ...
                    Kogger.debug("appDataOid=" + appDataOid);
