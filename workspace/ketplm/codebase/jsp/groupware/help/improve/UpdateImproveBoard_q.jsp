...
<tr>
    <td valign="top">
        ...
        <tr>
            <td>
                ...
                <tr>
                    ...
                    <td class="font_01"><%=messageService.getString("e3ps.message.ket_message", "00429") %><%--Q&amp;A 질문 수정--%></td>
                    <td align="right">
                        <img src="/plm/portal/images/icon_navi.gif">Home
                        <img src="/plm/portal/images/icon_navi.gif">Help Desk
                        <img src="/plm/portal/images/icon_navi.gif"><%=messageService.getString("e3ps.message.ket_message", "02006") %><%--시스템 개선 요청--%>
                    </td>
                </tr>
                </table>
            </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <tr>
                            <td style="width: 10px;"><img src="/plm/portal/images/btn_1.gif"></td>
                            <td class="btn_blue" background="/plm/portal/images/btn_bg1.gif">
                                <a href="javascript:history.back();" class="btn_blue"><%=messageService.getString("e3ps.message.ket_message", "02887") %><%--취소--%></a>
                            </td>
                            <td style="width: 10px;"><img src="/plm/portal/images/btn_2.gif"></td>
                        </tr>
                        </table>
        ...
        <table style="width: 780px;">
        <tr>
            <td class="tdblueL"   style="width: 140px;"><%=messageService.getString("e3ps.message.ket_message", "02524") %><%--제목--%><span class="red">*</span></td>
            <td class="tdwhiteL">
                <input type="text" class="txt_field" name="title" value="<%=data.getTitle() %>" style="width:99.5%;" engnum="engnum" onKeyUp="common_CheckStrLength(this, 1333)"  onChange="common_CheckStrLength(this, 1333)" >
            </td>
            <td class="tdblueL"   style="width: 120px;"><%=messageService.getString("e3ps.message.ket_message", "01606") %><%--분류--%><span class="red">*</span></td>
            <td class="tdwhiteL0" style="width: 290px;">
                ...
                NumberCode numberCode = NumberCodeHelper.manager.getNumberCode("IMPROVETYPE", data.getClassification());
        ...
        <tr>
            ...
            <td class="tdwhiteL">
                <input type="text" class="txt_fieldRO" name="stateStr" value="<%=data.getStateStr() %>" style="width:270px;" engnum="engnum" readonly>
            </td>
        ...
        <tr>
            ...
            <td class="tdwhiteL0">
                <input type="text" class="txt_fieldRO" name="department" value="<%=data.getDepartment() %>" style="width:270px;" engnum="engnum" readonly>
            </td>
        </tr>
        -->
        <tr>
            <td class="tdblueL"><%=messageService.getString("e3ps.message.ket_message", "02796") %><%--첨부파일--%></td>
            <td class="tdwhiteL0" colspan="4" style="padding:5px">
    ...
    <td style="height: 30px" valign="bottom">
        ...
        <tr>
            ...
            <td style="height: 30px">
                <iframe src="/plm/portal/common/copyright.html" name="copyright" style="width: 780px; height: 24px;" frameborder="0" marginstyle="width:0px;" marginheight="0" scrolling="no"></iframe>
            </td>
        </tr>
        </table>
    </td>
