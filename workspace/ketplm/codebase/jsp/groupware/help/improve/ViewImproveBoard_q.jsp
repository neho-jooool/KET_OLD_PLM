        ...
        <tr>
            ...
            <td align="right">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <tr>
                            ...
                            <td class="btn_blue" background="/plm/portal/images/btn_bg1.gif">
                                <a href="javascript:go_to('/plm/jsp/groupware/help/improve/UpdateImproveBoard_q.jsp?oid=<%=data.getOid() %>&from=<%=from %>');" class="btn_blue"><%=messageService.getString("e3ps.message.ket_message", "01936") %><%--수정--%></a>
                            </td>
                    ...
                    <td style="width: 5px;">&nbsp;</td>
                    <%} %>
                    <%if ( isAdmin == true && data.isRegisteredState() == true ){%>
                    <td>
                        <table>
                        <tr>
                            <td style="width: 10px;"><img src="/plm/portal/images/btn_1.gif"></td>
                            <td class="btn_blue" background="/plm/portal/images/btn_bg1.gif">
                                <a href="javascript:go_to('/plm/jsp/groupware/help/improve/CreateImproveBoard_a.jsp?poid=<%=data.getOid() %>&from=<%=from %>');" class="btn_blue"><%=messageService.getString("e3ps.message.ket_message", "02778") %><%--처리 등록--%></a>
                            </td>
                            <td style="width: 10px;"><img src="/plm/portal/images/btn_2.gif"></td>
                        </tr>
                        </table>
