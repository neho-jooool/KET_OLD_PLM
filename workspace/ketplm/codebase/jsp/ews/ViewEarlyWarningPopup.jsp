...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td valign="top">
        <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td><iframe src='/plm/jsp/ews/ViewEarlyWarning.jsp?oid=<%=oid%>&isPopup=Y' id="list" name="list" frameborder="0" width="100%" height="100%" style="margin:0;" scrolling="auto"></iframe></td>
        </tr>
      </table>
    </td>
  </tr>
