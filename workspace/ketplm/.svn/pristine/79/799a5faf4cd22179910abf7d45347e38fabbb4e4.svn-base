package e3ps.bom.command.pprojectdetails;
...
public class PProjectDetailsCmd extends AbstractAIFCommand {
	...
	public PProjectDetailsCmd(JFrame frame, AbstractAIFUIApplication app)
    {
        this.app = app;
        parent = frame;
	...
	public PProjectDetailsCmd(JFrame frame, AbstractAIFUIApplication app, SearchBOMPanel searchPnl)
    {
        this.app = app;
	...
	private void init() 
	{
        ...
        try 
		{
			...
			urlStr = BOMBasicInfoPool.getServerCodebase().trim() + "jsp/bom/ViewRelatedList.jsp?type=ppjt&poid=" + itemOid.trim();
