...
class CoworkerTableData extends AbstractTableModel
{
    static final public CoworkerColumnData clmWorkerData[] =
    {
        ...
        new CoworkerColumnData("E-Mail", 191, JLabel.LEFT),
        new CoworkerColumnData(KETMessageService.service.getString("e3ps.bom.bom_editor_message", "00171")/*부서*/, 150, JLabel.LEFT)
    };
