...
<script type="text/javascript" src="/plm/extcore/js/dashboard/currentSetting1.js"></script>
...
$(document).ready(function(){
    ...
    //alert("${dashBoardDTO.type}"+" "+"${dashBoardDTO.devType}"+"  "+"${dashBoardDTO.month}");
    
    currentSetting1.createPaingGrid("${dashBoardDTO.pjtType}","${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}","${dashBoardDTO.month}");
