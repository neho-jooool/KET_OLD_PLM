package e3ps.bom.command.mprojectdetails;
...
public class MProjectDetailsCmd extends AbstractAIFCommand {
	...
	public MProjectDetailsCmd(JFrame frame, AbstractAIFUIApplication app)
    {
        this.app = app;
        parent = frame;
	...
	public MProjectDetailsCmd(JFrame frame, AbstractAIFUIApplication app, SearchBOMPanel searchPnl)
    {
        this.app = app;
	...
	private void init() 
	{
        ...
        try 
		{
			...
			urlStr = BOMBasicInfoPool.getServerCodebase().trim() + "jsp/bom/ViewRelatedList.jsp?type=mpjt&poid=" + itemOid.trim();
