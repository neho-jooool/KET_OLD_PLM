...
//     alert(date); //본문페이지 이동
    ...
    location.href="/plm/jsp/project/trySchdule/CalendarSub.jsp?tagetDay=" + date + "<%=tmpPopUp %>";
<%--     parent.mainCal.location.href= "/plm/jsp/project/trySchdule/TryDaily.jsp?tagetDay=" + date + "<%=tmpPopUp %>"; --%>
}
