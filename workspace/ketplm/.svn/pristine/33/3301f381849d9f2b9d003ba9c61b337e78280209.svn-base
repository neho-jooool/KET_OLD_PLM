...
<script type="text/javascript" src="/plm/extcore/js/dashboard/teamTaskTeamProcessData.js"></script>
<!-- EJS TreeGrid End -->
...
$(document).ready(function(){
    ...
    teamTaskTeamProcessData.createPaingGrid("${dashBoardDTO.displayCode}","${dashBoardDTO.startDate}","${dashBoardDTO.endDate}","${dashBoardDTO.departName}");
});
