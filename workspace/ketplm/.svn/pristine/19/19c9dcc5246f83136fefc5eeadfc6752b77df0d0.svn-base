...
<script type="text/javascript" src="/plm/extcore/js/dashboard/typeByCompleteProjectReview.js"></script>
...
$(document).ready(function(){
    ...
    CompleteReviewProject.createPaingGrid("${dashBoardDTO.pjtType1}","${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
