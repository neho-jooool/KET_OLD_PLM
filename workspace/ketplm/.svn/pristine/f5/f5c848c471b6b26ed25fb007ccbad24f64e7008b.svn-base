...
public class ItemMigrationCmd3 {
    ...
    public static void main(String[] args) throws SQLException, IOException
    {
        ...
        {
            // 사용법 설명
            Kogger.debug(ItemMigrationCmd3.class, ">>> Usage  : windchill e3ps.load.bom.ItemMigrationCmd3 userID passwd");
            return;
        }
    	...
    	Kogger.debug(ItemMigrationCmd3.class, "@@@@@@@@@ strFilePath : " + strDirPath + "\\" + strFileName);
    	...
    	try {
	    		...
	    		vec = ItemMasterInterface.getItemMigration("", "20080101", "20111231");

	            Kogger.debug(ItemMigrationCmd3.class,  "@@@@@@@@@@  SAP Part Interface [ vec size ] : " + vec.size() + "@@@@@@@@@@\n" );
	            fw.write(":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::\n" );
...
//	    		for( int i = 0; i < 1000; i++ ){			// 테스트로 1000개 먼저 시간 측정해봄
    	        	...
    	        	Kogger.debug(ItemMigrationCmd3.class, "@@@@@@@@@@ " + i + "  번째 부품 생성 : " + strArry[0] +" @@@@@@@@@@");
	    			...
	    			if (partOid != null && !partOid.equals("") && !partOid.equals("null")){
	    				Kogger.debug(ItemMigrationCmd3.class, "@@@@@@@@@@ 저장 성공!");
	    	    		fw.write(":::::::::::::: 저장 완료 :: + "  + partOid + " \n");
	    	    		fw.flush();
	    				ItemMasterInterface.setItemMasterResultInfo(hash, true);
	    			}else{
	    				Kogger.debug(ItemMigrationCmd3.class, "@@@@@@@@@@ 저장 실패!");
	    	    		fw.write(":::::::::::::: 저장 실패 \n");
	    	    		fw.flush();
	    				ItemMasterInterface.setItemMasterResultInfo(hash, false);
	    			}
    		...
    		Kogger.error(ItemMigrationCmd3.class, e);
    	}finally{
