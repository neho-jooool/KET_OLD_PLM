...
.style17 {font-size: 22px;font-weight:bold;text-align:center; color:#FF0000; font-family:"돋움"}
    ...
    <tr>
        <td >
            <table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td width="860" height="80" class="style20">제품별 원가계산 내역 </td>
                    <td width="100">
...
%>
                            <tr>
                                ...
                                <td bgcolor="#F2F5F9" class="style1">&nbsp;</td>
                                <td height="18" valign="bottom" bgcolor="#F2F5F9" class="style9">&nbsp;&nbsp;&nbsp;&nbsp;조립</td>
                                <td height="18" valign="bottom" bgcolor="#F2F5F9" class="style1">&nbsp;</td>
                                <td height="18" valign="bottom" bgcolor="#F2F5F9" class="style1"><%if("Insert".equals(pro_type[j][p][q]) || "복합금형".equals(part_type[j][p][q])){out.print(String.format("%.2f", StringUtil.nullDouble((m_total_cost[j][p][q]))));}%></td>
                                ...
                                <td height="18" valign="bottom" bgcolor="#F2F5F9" class="style1"><%if("Insert".equals(pro_type[j][p][q]) || "복합금형".equals(part_type[j][p][q])){out.print(String.format("%.1f", StringUtil.nullDouble((sum_meterial[j][p][q]))));}else{out.print(String.format("%.1f", (StringUtil.nullDouble(sum_meterial[j][p][q]) - StringUtil.nullDouble(m_total_cost[j][p][q]))));}%></td>
...
%>
                            <tr>
                                ...
                                <td height="18" valign="bottom" bgcolor="#F2F5F9" class="style1"><%if(!"assy".equals(pro_type[j][fk][q]) && !"외주".equals(make_type[j][fk][q])){if(!"".equals(m_total_cost[j][fk][q])){out.print(String.format("%.1f", StringUtil.nullDouble(labor_cost[j][fk][q])));}}%></td>
...
%></td>
                                ...
                                <td height="18" valign="bottom" bgcolor="#F2F5F9" class="style11"></td>
                                <td height="18" valign="bottom" bgcolor="#F2F5F9" class="style1"></td>
                                <td width="60" height="18" valign="bottom" bgcolor="#F2F5F9" class="style1"><%if("외주".equals(make_type[j][fk][q])){out.print("외주");}else if("유상".equals(pro_1[j][fk][q]) || "무상".equals(pro_1[j][fk][q])){out.print("구매");}else{out.print(pro_1[j][fk][q]);}%></td>
                            </tr>
<%
...
%>
                            <tr>
                                ...
                                <td width="60" height="18" valign="bottom" bgcolor="#FCFDFE" class="style1"><%if("외주".equals(make_type[j][fk][r])){out.print("외주");}else if("유상".equals(pro_1[j][fk][r]) || "무상".equals(pro_1[j][fk][r])){out.print("구매");}else{out.print(pro_1[j][fk][r]);}%></td>
                            </tr>
<%
                    } // r for end
                }  // case_count_2 if end
...
%>
                        ...
                        <table width="906" border="0" cellpadding="0" cellspacing="1">
                            <tr>
                                <td height="22" valign="bottom" bgcolor="#FFFFFF" class="style3">2. 검토조건 및 검토의견		  </td>
                            </tr>
                        </table>
                        <table width="955" border="0" cellpadding="0" cellspacing="1" bgcolor="#333333">
                            <tr>
                        ...
                        <table width="955" height="21" border="0" cellpadding="0" cellspacing="1" bgcolor="#333333">
                            <tr>
                                ...
                                if("1".equals(team)){
                                	...
                                	out.print("전장모듈개발1팀"+f_name);
                                }else if("23".equals(team)){
                                	out.print("전장모듈개발2팀"+f_name);
                                }else if("24".equals(team)){
                                	out.print("전장모듈개발3팀"+f_name);
                                ...
                                <td width="204" bgcolor="#FFFFFF" class="style9">&nbsp;<%="자동차영업팀 "+a_name%></td>
                            </tr>
                        </table>
                    </td>
                </tr>
