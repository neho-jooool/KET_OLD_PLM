create or replace
FUNCTION FN_GET_DEPENDENCY_ELECTRON_WBS(v_task_oid IN VARCHAR2, v_task_plan_start_date IN VARCHAR2, v_pjt_oid IN VARCHAR2)
/*******************************************************************************
*  [PLM System 1차개선] 전자 제품 WBS Task의 선행 Task List를 가져옴
********************************************************************************
*  FUNCTION NAME
*      FN_GET_DEPENDENCY_ELECTRON_WBS
********************************************************************************
*  2013-07-16       BoLee     initial creation
*******************************************************************************/
RETURN VARCHAR2 IS
...
END FN_GET_DEPENDENCY_ELECTRON_WBS;