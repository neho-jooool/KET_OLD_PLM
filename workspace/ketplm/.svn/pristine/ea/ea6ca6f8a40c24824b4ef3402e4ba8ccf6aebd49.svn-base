...
<!-- EJS TreeGrid End -->
<script src="/plm/extcore/js/wfm/workflow/listReceiptWorkItem.js"></script>
<script type="text/javascript">
    $(document).ready(function(e) {
        ...
        WorkItem.createGrid();
        treeGridResize("#listReceiptWorkItemGrid","#listReceiptWorkItemGridDiv");//크롬에서 그리드 리사이즈 하기 위한 코드 param1 : grid Id, param2 : divId
        // Enter
      ...
      <td valign="top">
            ...
            <td>
              <table style="width: 100%; height: 28px;" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td class="font_01"><%=messageService.getString("e3ps.message.ket_message", "05159")%><%--수신함--%></td>
                  <td align="right"><img src="/plm/portal/images/icon_navi.gif">Home<img src="/plm/portal/images/icon_navi.gif"><%=messageService.getString("e3ps.message.ket_message", "00788")%><%--결재함--%>
                    <img src="/plm/portal/images/icon_navi.gif"><%=messageService.getString("e3ps.message.ket_message", "05159")%><%--수신함--%></td>
                </tr>
              </table>
            </td>
          </tr>
            ...
            <td>
              <table border="0" align="right" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td class="btn_blue" background="/plm/portal/images/btn_bg1.gif"><a href="javascript:WorkItem.doDistribute()" class="btn_blue"><%=messageService.getString("e3ps.message.ket_message", "05110")%><!-- 추가배포 --></a></td>
        ...
        <table border="0" cellspacing="0" cellpadding="0" style="width: 100%;">
          ...
          <tr>
            ...
            <td style="width: 150px;" class="tdblueM"><%=messageService.getString("e3ps.message.ket_message", "05141")%><!-- 수신일 --></td>
        ...
        <div class="container-fluid">
          <div class="row-fluid">
            <div id="listReceiptWorkItemGridDiv" style="WIDTH: 100%; HEIGHT: 100%"></div>
          </div>
