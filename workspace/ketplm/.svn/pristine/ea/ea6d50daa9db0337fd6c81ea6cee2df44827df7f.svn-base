...
$(document).ready(function(){
    HistoryProgram.createCompareNotifyHistoryGrid({
    	Cols : ${Cols},
    	Header : ${Header},
    	data : ${compareJson}
    });
                    ...
                    <td background="/plm/portal/images/logo_popupbg.png">
                        <table style="height: 28px;">
                          <tr>
                            ...
                            <td class="font_01"><%=messageService.getString("e3ps.message.ket_message", "09234") %><!-- 공지내용 비교 조회 --></td>
                          </tr>
                        </table>
                    </td>
        ...
        <td valign="top">    
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td align="left"><%=messageService.getString("e3ps.message.ket_message", "01120") %><!-- 기본정보 --></td>
                    <td align="right">
    ...
    <tr>
        <td align="right">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="20"><img src="/plm/portal/images/icon_4.png"></td>
                    <td align="left"><%=messageService.getString("e3ps.message.ket_message", "02348") %><!-- 일정 --></td>
                </tr>
            </table>
        </td>
    </tr>
