 ...
 *
 * <p>
 * Use the <code>newPlanTaskWork</code> static factory method(s), not the
 * <code>PlanTaskWork</code> constructor, to construct instances of this
...
@GenAsPersistable(
   ...
   properties={
   @GeneratedProperty(name="planWorkStart", type=Timestamp.class),
   @GeneratedProperty(name="planWorkEnd", type=Timestamp.class)
   })
public class PlanTaskWork extends _PlanTaskWork {
    ...
    **/
   public static PlanTaskWork newPlanTaskWork()
            throws WTException {

      PlanTaskWork instance = new PlanTaskWork();
      instance.initialize();
      return instance;
   }
