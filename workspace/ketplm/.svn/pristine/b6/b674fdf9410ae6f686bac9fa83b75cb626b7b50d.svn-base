 ...
 *
 * <p>
 * Use the <code>newProjectMaster</code> static factory method(s), not the
 * <code>ProjectMaster</code> constructor, to construct instances of this
...
@GenAsPersistable(
   ...
   @GeneratedProperty(name="pjtName", type=String.class,
      javaDoc="프로젝트 명"),
   @GeneratedProperty(name="pjtTypeName", type=String.class),
   @GeneratedProperty(name="linkProjectNo", type=String.class,constraints=@PropertyConstraints(upperLimit=4000)),
   })
public class ProjectMaster extends _ProjectMaster {
    ...
    **/
   public static ProjectMaster newProjectMaster()
            throws WTException {
