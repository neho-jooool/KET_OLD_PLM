...
<!--
  ...
  //해제신청서 저장
    function save(){
      ...
      document.forms[0].action = '/plm/servlet/e3ps/EarlyWarningEndReqServlet?cmd=create';
        ...
        <tr>
          <td>
              ...
              <tr>
                ...
                <td class="font_01"><%=messageService.getString("e3ps.message.ket_message", "03189") %><%--해제신청서 등록--%></td>
              </tr>
            </table>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
              ...
              <tr>
                ...
                <td background="../../portal/images/tab_3.png" class="btn_tab"><%=messageService.getString("e3ps.message.ket_message", "03192") %><%--해제신청--%></td>
                                ...
                                <tr>
                                  ...
                                  <td class="btn_blue" background="../../portal/images/btn_bg1.gif">
                                      <% if( isTodo != null && isTodo.equals("Y")){ %>
                                                  <a href="javascript:goTodoList('create');" class="btn_blue"><%=messageService.getString("e3ps.message.ket_message", "02887") %><%--취소--%></a>
                                                <% }else{ %>
                  ...
                  <table border="0" cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <tr>
                      ...
                      <td colspan="3" class="tdwhiteM0" style="height:100">
                          <textarea name="requestDesc" class="txt_field" style="width:100%; height:96%"></textarea>
                      </td>
                    </tr>
                    <tr>
