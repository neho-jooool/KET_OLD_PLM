...
<%
  ...
  ImproveBoard qboard = (ImproveBoard) CommonUtil.getObject(poid);
  ...
  String state = ImproveBoardData.STATE_COMPLETED;
    ...
    <td valign="top">
        ...
        <tr>
            ...
            <td class="tdwhiteL0" style="width: 270px;">
              <select name="state" id="state" class="fm_jmp" style="width:98%">
                ...
                %>
                    <option value="<%=code %>" <%=("ACEPT".equals(code))?"selected":"" %>><%=value%></option>
                <%
                  }
                }
                %>
        ...
        <tr>
            ...
            <td class="tdwhiteL" colspan="3">
                <input id="managerName" type="text" name="managerName" value="<%=writer %>" class="txt_fieldRO" readonly style="width: 30%">
            ...
            <td class="tdblueL"  style="width: 120px;"><%=messageService.getString("e3ps.message.ket_message", "02425") %>작성부서</td>
            <td class="tdwhiteL0"  style="width: 270px;">
                <%=department %>
        ...
        <tr>
        	<td class="tdblueL"   style="width: 120px;"><%=messageService.getString("e3ps.message.ket_message", "02179") %><%--처리일--%></td>
            <td class="tdwhiteL" style="width: 270px;">
                <%=writeDate %>
                <input type="hidden" name="writeDate" value="<%=writeDate %>" />
            </td>

            <td class="tdblueL" style="width: 120px;"><%=messageService.getString("e3ps.message.ket_message", "01755") %><%--상위 게시 여부--%></td>
            <td class="tdwhiteL0" style="width: 270px;">
        ...
        <tr id="causeTR" style="display:none;">
            ...
            <td colspan="3"  style="width: 270px;" class="tdwhiteL0"><textarea name="cause" style='overflow: auto; width:98%; height:50px; padding: 10;' class="fm_area" ></textarea></td>
        </tr>
        ...
        <tr id="handleResultTR" style="display:none;">
            ...
            <td colspan="3"  style="width: 270px;" class="tdwhiteL0"><textarea name="handleResult" style='overflow: auto; width:98%; height:50px; padding: 10;' class="fm_area" ></textarea></td>
        </tr>
