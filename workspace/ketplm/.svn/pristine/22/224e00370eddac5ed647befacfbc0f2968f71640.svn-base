...
<script type="text/javascript" src="/plm/extcore/js/dashboard/currentSetting.js"></script>
...
$(document).ready(function(){
    ...
    //alert("${dashBoardDTO.month}"+"  "+"${dashBoardDTO.year}");
    
    currentSetting.createPaingGrid("${dashBoardDTO.pjtType}","${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}","${dashBoardDTO.month}");
