...
<Grid>
    ...
    <Cfg id='ProjectSearchReviewGrid' />
    ...
    <Cols>
        <C Name='ReqNo'       Width='90'  Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='PjtNo'       Width='95'  Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:left;vertical-align:middle'/>
        <C Name='PjtName'     Width='90' RelWidth='50'  Align='Left'   CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:left;vertical-align:middle'/>
        ...
        <C Name='Buyer'         Width='90' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='CostMember'     Width='75' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='SalesName'     Width='75' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <%if(!"Y".equals(searchPopup)){%>
        ...
        <C Name='CostBomTask'       Width='80'  Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:left;vertical-align:middle'/>
        <C Name='CostReqTask'       Width='80'  Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:left;vertical-align:middle'/>
        <C Name='CostSalesTask'       Width='80'  Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:left;vertical-align:middle'/>
        <C Name='CostCalcTask'       Width='80'  Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:left;vertical-align:middle'/>
        <C Name='CostReportTask'       Width='80'  Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:left;vertical-align:middle'/>
        <C Name='reviewResult'       Visible="0" Width='0'  Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:left;vertical-align:middle'/>
    </Cols>

    <Header CanDelete='0' Align='Center'
            ReqNo        ='<%=messageService.getString("e3ps.message.ket_message", "02192") %><%--요청번호--%>'
            ...
            PlanStartDate='<%=messageService.getString("e3ps.message.ket_message", "02019") %><%--시작일자--%>'
            Buyer        ='<%=messageService.getString("e3ps.message.ket_message", "00828") %><%--고객--%>'
            CostMember   = '<%=messageService.getString("e3ps.message.ket_message", "09490") %><%--원가담당--%>'
            SalesName    ='<%=messageService.getString("e3ps.message.ket_message", "02136") %><%--영업담당--%>'
            <%if(!"Y".equals(searchPopup)){%>
            ...
            CostBomTask        ='PartList'
            CostReqTask        ='<%=messageService.getString("e3ps.message.ket_message", "09491") %><%--원가요청서--%>'
            CostSalesTask        ='<%=messageService.getString("e3ps.message.ket_message", "09492") %><%--판매목표가--%>'
            CostCalcTask        ='<%=messageService.getString("e3ps.message.ket_message", "02204") %><%--원가산출--%>'
            CostReportTask        ='<%=messageService.getString("e3ps.message.ket_message", "09493") %><%--원가보고--%>'
            />
