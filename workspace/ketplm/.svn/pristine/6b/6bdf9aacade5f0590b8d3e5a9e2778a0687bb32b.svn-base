 ...
 *
 * <p>
 * Use the <code>newKETEcnWeightHistory</code> static factory method(s),
 * not the <code>KETEcnWeightHistory</code> constructor, to construct instances
...
@GenAsPersistable(
   ...
   properties={
   @GeneratedProperty(name="spTotalWeight", type=String.class,
      javaDoc="총중량"),
   @GeneratedProperty(name="spNetWeight", type=String.class,
      javaDoc="부품중량"),
   @GeneratedProperty(name="spScrabWeight", type=String.class,
      javaDoc="스크랩중량")
   },
   foreignKeys={
   @GeneratedForeignKey(
      foreignKeyRole=@ForeignKeyRole(name="eco", type=wt.change2.WTChangeOrder2.class),
      myRole=@MyRole(name="theKETEcnWeightHistory", cardinality=Cardinality.ONE)),
   @GeneratedForeignKey(
      foreignKeyRole=@ForeignKeyRole(name="part", type=wt.part.WTPart.class),
      myRole=@MyRole(name="theKETEcnWeightHistory", cardinality=Cardinality.ONE))
   })
public class KETEcnWeightHistory extends _KETEcnWeightHistory {
    ...
    *
    * @return    KETEcnWeightHistory
    * @exception wt.util.WTException
    **/
   public static KETEcnWeightHistory newKETEcnWeightHistory()
            throws WTException {

      KETEcnWeightHistory instance = new KETEcnWeightHistory();
      instance.initialize();
      return instance;
   }
