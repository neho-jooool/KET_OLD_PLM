...
<script type="text/javascript" src="/plm/extcore/js/dashboard/carTaskProcess.js"></script>
<!-- EJS TreeGrid End -->
...
$(document).ready(function(){
    ...
    carTaskProcess.createPaingGrid("${dashBoardDTO.pjtNo}","${dashBoardDTO.carType}","${dashBoardDTO.customer}");
});
