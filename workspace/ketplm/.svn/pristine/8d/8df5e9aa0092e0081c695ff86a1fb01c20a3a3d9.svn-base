...
<script type="text/javascript" src="/plm/extcore/js/dashboard/teamProjectProcessTeamCompleteList.js"></script>
...
$(document).ready(function(){
	teamProjectProcessTeamCompleteList.createPaingGrid("${dashBoardDTO.departName}","${dashBoardDTO.displayCode}","${dashBoardDTO.startDate}","${dashBoardDTO.endDate}");
});
</script>