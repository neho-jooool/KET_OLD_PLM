...
<script type="text/javascript" src="/plm/extcore/js/dashboard/typeByCompleteProjectTotal.js"></script>
...
$(document).ready(function(){
   ...
   // alert("${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
    ...
    CompleteReviewProjectTotal.createPaingGrid("${dashBoardDTO.pjtType1}","${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
});
