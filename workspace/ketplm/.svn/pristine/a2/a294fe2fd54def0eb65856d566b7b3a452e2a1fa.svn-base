var teamProjectTeamProcessList = {
	...
	createPaingGrid : function(departName,displayCode,startDate,endDate){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			id : 'SampleSearchGrid',
			Sort : '-pjtName',
			perPageOnChange : 'javascript:teamProjectTeamProcessList.search(Value);',
			Data : {
				Url : '/plm/ext/dashboard/teamProjectTeamProcessListSetting?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
			...
			Head :[
					...
					Toolbar : {
						...
						perPageOnChange:'javascript:teamProjectProcessList.search(Value);',
		...
		//row click event
		Grids.OnClick = teamProjectTeamProcessList.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/teamProjectTeamProcessListSetting?sortName=*Sort0';
