...
<script type="text/javascript" src="/plm/extcore/js/dashboard/moldProjectTotalStep.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.making}"+" "+"${dashBoardDTO.type}"+"  "+"${dashBoardDTO.moldTypeCheck}");
    ...
    moldProjectTotalStep.createPaingGrid("${dashBoardDTO.itemType}","${dashBoardDTO.outsourcing}","${dashBoardDTO.year}","${dashBoardDTO.month}","${dashBoardDTO.division}");
});
