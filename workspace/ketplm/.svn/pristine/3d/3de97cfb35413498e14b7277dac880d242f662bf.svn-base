...
<script type="text/javascript" src="/plm/extcore/js/dashboard/projectTaskReport.js"></script>
<!-- EJS TreeGrid End -->
...
$(document).ready(function(){
   ...
   // alert("${dashBoardDTO.type}"+"  "+"${dashBoardDTO.state}"+" "+"${dashBoardDTO.step}"+" "+"${dashBoardDTO.year}"+" "+"{dashBoardDTO.month}");
    ...
    Task.createPaingGrid("${dashBoardDTO.type}","${dashBoardDTO.state}","${dashBoardDTO.step}","${dashBoardDTO.year}","${dashBoardDTO.month}","${dashBoardDTO.moldType}","${dashBoardDTO.useCompleteType}","${dashBoardDTO.division}");
});
