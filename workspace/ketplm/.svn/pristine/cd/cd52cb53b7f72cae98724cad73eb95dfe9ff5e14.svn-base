...
<script type="text/javascript" src="/plm/extcore/js/dashboard/issueProject.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.customer}"+" "+"${dashBoardDTO.carType}"+"  "+"${dashBoardDTO.year}");
    ...
    issueProject.createPaingGrid("${dashBoardDTO.customer}","${dashBoardDTO.carType}","${dashBoardDTO.year}");
