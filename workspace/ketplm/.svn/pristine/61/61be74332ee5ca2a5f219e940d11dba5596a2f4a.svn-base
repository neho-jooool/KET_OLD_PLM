...
<script type="text/javascript" src="/plm/extcore/js/dashboard/typeByTotalProjectReview.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.type}"+"  "+"${dashBoardDTO.devType}"+"  "+"${dashBoardDTO.year}");
    ...
    ReviewProject.createPaingGrid("${dashBoardDTO.pjtType1}","${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
