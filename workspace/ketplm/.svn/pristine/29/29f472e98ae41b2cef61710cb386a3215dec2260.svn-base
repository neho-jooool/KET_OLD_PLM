...
$(document).ready(function(){
    ...
    var mft2_column = { Name : "mft2", Width : "100", Align : "left", Type : "Enum", Related : "mft1",  CanEmpty: 1, Range : 1, Spanned : '1', CanSort : '0' };
    var mft4_column = { Name : "mft4", Width : "100", Align : "left", Type : "Enum", Related : "mft3",  CanEmpty: 1, Range : 1, Spanned : '1', CanSort : '0' };
    ...
    for(var i = 0; i < mftFactoryList.length; i++){
        ...
        if(pCode != null){
            ...
            var childEnum = mft2_column["Enum" + pCode];
            var childEnumKeys = mft2_column["EnumKeys" + pCode];
            
            var childEnum_4 = mft4_column["Enum" + pCode];
            var childEnumKeys_4 = mft4_column["EnumKeys" + pCode];
            
            if(childEnum != null){
                mft2_column["Enum" + pCode] = childEnum + "|" + mftFactory.name;
                mft2_column["EnumKeys" + pCode] = childEnumKeys + "|" + mftFactory.code;
                
                mft4_column["Enum" + pCode] = childEnum_4 + "|" + mftFactory.name;
                mft4_column["EnumKeys" + pCode] = childEnumKeys_4 + "|" + mftFactory.code;
            }else{
                mft2_column["Enum" + pCode] = "|" + mftFactory.name;
                mft2_column["EnumKeys" + pCode] = "|" + mftFactory.code;
                
                mft4_column["Enum" + pCode] = "|" + mftFactory.name;
                mft4_column["EnumKeys" + pCode] = "|" + mftFactory.code;
            }
        ...
        Layout : {
            Data : {
                ...
                Cols : [    
                            ...
                            {Name : 'tempCol1', CanSort : '0', Visible : '0', CanHide : '0', CanExport : '0'}, //구분
                            {Name : 'tempCol2', CanSort : '0', Visible : '0', CanHide : '0', CanExport : '0'}, //부품
                            {Name : 'mft1', Width:70, Align : 'center', Type : "Enum", Enum : eNum, EnumKeys : eNumKeys, CanEmpty : 1, Range : 0,  Clear : "mft2", Spanned : '1', CanSort : '0'}, //부품 생산국
                            mft2_column, //부품-생산지
                            {Name : 'tempCol3', CanSort : '0', Visible : '0', CanHide : '0', CanExport : '0'}, //상위부품
                            {Name : 'mft3', Width:70, Align : 'center', Type : "Enum", Enum : eNum, EnumKeys : eNumKeys, CanEmpty : 1, Range : 0,  Clear : "mft4", Spanned : '1', CanSort : '0'}, //상위부품 생산국
                            mft4_column, //상위부품-생산지
                            
                            {Name : 'tempCol4', CanSort : '0', Visible : '0', CanHide : '0', CanExport : '0'},
                            {Name : 'tempCol5', CanSort : '0', Visible : '0', CanHide : '0', CanExport : '0'},
                            {Name : 'inLandCost', Width:70, Align : 'right', CanSort : '0', CanEdit : '1', Type : "Int", Format : "###,##0", Spanned : '1' , CanSort : '0' },
                            ...
                            {Name : 'inHarborCost', Width:70, Align : 'right', CanSort : '0', CanEdit : '1', Type : "Int", Format : "###,##0", Spanned : '1' , CanSort : '0'},
                            ...
                            {Name : 'seaCost', Width:70, Align : 'right', CanSort : '0', CanEdit : '1', Type : "Int", Format : "###,##0", Spanned : '1', CanSort : '0' },
                            ...
                            {Name : 'outLandCost', Width:70, Align : 'right', CanSort : '0', CanEdit : '1', Type : "Int", Format : "###,##0", Spanned : '1' , CanSort : '0'},
            ...
            for ( var r = G.GetFirst(); r; r = G.GetNext(r) ) {
                ...
                if ( r.deleteFlag != delFlag ) {//삭제되지 않은 행에 대해 필수입력 값 체크
                    ...
                    if ( r.mft3 == null || (r.mft3 + "").trim() == "" ) {
                        alert("상위부품의 생산국을 입력하십시오.");
                        setTimeout( function() { G.Focus(r, "mft3", null, true); }, 10);
                        return true;
                    }
                    
                    if ( r.mft4 == null || (r.mft4 + "").trim() == "" ) {
                        alert("상위부품의 생산지를 입력하십시오.");
                        setTimeout( function() { G.Focus(r, "mft4", null, true); }, 10);
                        return true;
                    }
                    ...
                    for ( var j = G.GetFirst(); j; j = G.GetNext(j) ) {//삭제되지 않은 행에 대해 1단계,2단계,3단계 체크
                        ...
                        if(j.deleteFlag != delFlag && r.r0.rowIndex != j.r0.rowIndex){
                        	rTemp = r.mft1+"|"+r.mft2+"|"+r.mft3+"|"+r.mft4;
                            jTemp = j.mft1+"|"+j.mft2+"|"+j.mft3+"|"+j.mft4;
                            if(rTemp == jTemp){
                        ...
                        <td background="/plm/portal/images/logo_popupbg.png">
                            <table style="height: 28px;">
                                <tr>
                                    ...
                                    <td class="font_01">공정 관세/물류비 관리</td>
                                </tr>
                            </table>
                        </td>
