 ...
 *
 * <p>
 * Use the <code>newCancelCostHistory</code> static factory method(s), not
 * the <code>CancelCostHistory</code> constructor, to construct instances
...
@GenAsPersistable(
   ...
   properties={
   @GeneratedProperty(name="rev", type=String.class,
      javaDoc="리비전"),
   @GeneratedProperty(name="targetCollectCost", type=String.class,
      javaDoc="목표회수비용"),
   @GeneratedProperty(name="realCollectCost", type=String.class,
      javaDoc="실제회수비용"),
   @GeneratedProperty(name="projectCost", type=String.class,
      javaDoc="프로젝트 총비용"),
   @GeneratedProperty(name="expectedLossCost", type=String.class,
      javaDoc="예상손실비"),
   @GeneratedProperty(name="endLostCost", type=String.class,
      javaDoc="최종손실비"),
   @GeneratedProperty(name="collectCompleteYn", type=String.class,
      javaDoc="회수완료여부")
   })
public class CancelCostHistory extends _CancelCostHistory {
    ...
    *
    * @return    CancelCostHistory
    * @exception wt.util.WTException
    **/
   public static CancelCostHistory newCancelCostHistory()
            throws WTException {

      CancelCostHistory instance = new CancelCostHistory();
      instance.initialize();
      return instance;
   }
