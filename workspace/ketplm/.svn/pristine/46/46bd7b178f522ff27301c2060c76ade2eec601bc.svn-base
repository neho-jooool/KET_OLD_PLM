 ...
 *
 * <p>
 * Use the <code>newKETDqmRaiseCustomer</code> static factory method(s),
 * not the <code>KETDqmRaiseCustomer</code> constructor, to construct instances
...
public class KETDqmRaiseCustomer extends _KETDqmRaiseCustomer {
    ...
    *
    * @return    KETDqmRaiseCustomer
    * @exception wt.util.WTException
    **/
   public static KETDqmRaiseCustomer newKETDqmRaiseCustomer()
            throws WTException {

      KETDqmRaiseCustomer instance = new KETDqmRaiseCustomer();
      instance.initialize();
      return instance;
   }
