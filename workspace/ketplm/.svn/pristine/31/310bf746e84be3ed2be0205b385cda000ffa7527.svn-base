...
public class ReplaceBOMAction extends AbstractAIFAction
{
    private AbstractAIFUIApplication app;

    public ReplaceBOMAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public ReplaceBOMAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
