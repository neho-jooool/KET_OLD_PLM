var startMassProject = {
	
	/**
	 * server paging grid
	 */
	createPaingGrid : function(making,type,year,moldType,division){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			id : 'SampleSearchGrid',
			Sort : '-pjtNo',
			perPageOnChange : 'javascript:startMassProject.search(Value);',
			Data : {
				Url : '/plm/ext/dashboard/startMassTypeProjectList?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
			...
			Cols : [
				...
				{Name : 'pjtName', RelWidth:'30',	Width:120,  Align : 'Left', CanSort : '1', CanEdit : '0' ,Spanned:'1'},
				{Name : 'planStartDate',	Width:100, Align : 'Center', CanSort : '1', CanEdit : '0', Type:'Date', Format:"yyyy-MM-dd" , Spanned:'1'}, //RelWidth:50
				{Name : 'planEndDate', Width:100, Align : 'Center', CanSort : '0', CanEdit : '0',Type:'Date', Format:"yyyy-MM-dd", Spanned:'1'},
				{Name : 'execEndDate', Width:100, Align : 'Center', CanSort : '1', CanEdit : '0',Type:'Date', Format:"yyyy-MM-dd", Spanned:'1'},
				{Name : 'term', Width:50, Align : 'Center', CanSort : '1', CanEdit : '0',Spanned:'1'},
				{Name : 'outsourcing', Width:100, Align : 'Center', CanSort : '1', CanEdit : '0',Spanned:'1'},
				{Name : 'budgetCost', Width:60, Align : 'Right', CanSort : '0', CanEdit : '0', Type:'Int', Format:",0", Spanned:'1'},
				{Name : 'resultCost', Width:60, Align : 'Right', CanSort : '0', CanEdit : '0', Type:'Int', Format:",0", Spanned:'1'},
			...
			Cols : [
					...
					{Name : 'pjtNo', 	Width:60,  Align : 'Center', CanSort : '1', CanEdit : '0' ,Spanned:'1'},
					{Name : 'pjtName', RelWidth:'30', Width:120,  Align : 'Left', CanSort : '1', CanEdit : '0' ,Spanned:'1'},
					{Name : 'displayPlanStartDate',	Width:100, Align : 'Center', CanSort : '1', CanEdit : '0', Type:'Date', Format:"yyyy-MM-dd" , Spanned:'1'}, //RelWidth:50
					{Name : 'displayPlanEndDate', Width:100, Align : 'Center', CanSort : '0', CanEdit : '0',Type:'Date', Format:"yyyy-MM-dd", Spanned:'1'},
					{Name : 'displayExecEndDate', Width:100, Align : 'Center', CanSort : '1', CanEdit : '0',Type:'Date', Format:"yyyy-MM-dd", Spanned:'1'},
					{Name : 'term', Width:50, Align : 'Center', CanSort : '1', CanEdit : '0',Spanned:'1'},
					{Name : 'outsourcing', Width:100, Align : 'Center', CanSort : '1', CanEdit : '0',Spanned:'1'},
					{Name : 'budgetCost', Width:60, Align : 'Center', CanSort : '0', CanEdit : '0', Type:'Int', Format:",0", Spanned:'1'},
					{Name : 'resultCost', Width:60, Align : 'Center', CanSort : '0', CanEdit : '0', Type:'Int', Format:",0", Spanned:'1'},
					{Name : 'stateState', Width:50, Align : 'Center', CanSort : '1', CanEdit : '0',Spanned:'1'},
				...
				Head :[
						{
							...
							outsourcing : LocaleUtil.getMessage('02672'), outsourcingRowSpan:'2',//'수정일'
						...
						},
						{
							...
							term : LocaleUtil.getMessage('02733'), termRowSpan:'2',//'수정일'
							outsourcing : LocaleUtil.getMessage('02672'), outsourcingRowSpan:'2',//'수정일'
							budgetCost : LocaleUtil.getMessage('02143'), budgetCostType:'Text',//'수정일'
							resultCost : LocaleUtil.getMessage('02032'), resultCostType:'Text',//'수정일'
							stateState : LocaleUtil.getMessage('01760'), stateStateRowSpan : '2'
						}
						],
		...
		//row click event
		Grids.OnClick = startMassProject.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/startMassTypeProjectList?sortName=*Sort0';
