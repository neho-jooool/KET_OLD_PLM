...
<!--
  function deleteNotice() {
    ...
    if ( confirm("<%=messageService.getString("e3ps.message.ket_message", "01707") %><%--삭제하시겠습니까?--%>") ) {
      ...
      $.ajax({
          type       : "POST",
          url        : "/plm/jsp/groupware/help/faq/ActionBoard.jsp",
          data       : $("#frm").serialize(),
        ...
        <tr>
            <td>
                ...
                <tr>
                    ...
                    <td class="font_01"><%=messageService.getString("e3ps.message.ket_message", "00241") %><%--FAQ 상세조회--%></td>
                    ...
                    <td>
                        ...
                        <tr>
                            ...
                            <td class="btn_blue" background="/plm/portal/images/btn_bg1.gif">
                                <a href="javascript:go_to('/plm/jsp/groupware/help/faq/ModifyBoard.jsp?oid=<%=data.oid %>&from=<%=from %>');" class="btn_blue"><%=messageService.getString("e3ps.message.ket_message", "01936") %><%--수정--%></a>
                            </td>
