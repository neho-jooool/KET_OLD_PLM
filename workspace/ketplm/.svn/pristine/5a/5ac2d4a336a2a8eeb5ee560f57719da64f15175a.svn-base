...
<script type="text/javascript" src="/plm/extcore/js/dashboard/teamProjectProcessCompleteList.js"></script>
...
$(document).ready(function(){
	teamProjectProcessCompleteList.createPaingGrid("${dashBoardDTO.departName}","${dashBoardDTO.userName}","${dashBoardDTO.startDate}","${dashBoardDTO.endDate}");
});
</script>