...
<script type="text/javascript" src="/plm/extcore/js/dashboard/productDelayTask.js"></script>
<!-- EJS TreeGrid End -->
...
$(document).ready(function(){
    ...
    productDelayTask.createPaingGrid("${dashBoardDTO.customer}","${dashBoardDTO.carType}","${dashBoardDTO.year}");
});
