...
<Grid>
    ...
    <Cfg id='SearchDocumentPopupGrid' />
    ...
    <Cfg MaxTagHeight='295' MinTagHeight='295'/> <!-- Minimal height of the main tag to not shrink it too much -->
    ...
    <Cols>
        ...
        <C Name='DocNo'       Width='90'  Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='DocName'     Width='195' RelWidth='50' Align='left'   CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='DocVer'      Width='40'  Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='Status'      Width='70'  Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='IDocuOid'    Width='0'   Align='Center' CanSort='0' CanEdit='0' Type='Text' Visible='0'/>
        <C Name='DeptName'    Width='0'   Align='Center' CanSort='0' CanEdit='0' Type='Text' Visible='0'/>
        <C Name='CreatorName' Width='0'   Align='Center' CanSort='0' CanEdit='0' Type='Text' Visible='0'/>
        <C Name='PjtNo'       Width='0'   Align='Center' CanSort='0' CanEdit='0' Type='Text' Visible='0'/>
    </Cols>
    ...
    <Header CanDelete='0'   Align='Center'
            ...
            DocVer  ='<%=messageService.getString("e3ps.message.ket_message", "01481") %><%--버전--%>'
