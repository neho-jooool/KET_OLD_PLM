...
public class PProjectDetailsAction extends AbstractAIFAction {
	
    private AbstractAIFUIApplication app;

    public PProjectDetailsAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public PProjectDetailsAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
