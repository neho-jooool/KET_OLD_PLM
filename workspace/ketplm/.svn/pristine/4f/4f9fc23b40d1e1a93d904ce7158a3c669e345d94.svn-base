 ...
 *
 * <p>
 * Use the <code>newBomEditorACL</code> static factory method(s), not the
 * <code>BomEditorACL</code> constructor, to construct instances of this
...
@GenAsPersistable(
   ...
   properties={
   @GeneratedProperty(name="columnKey", type=String.class),
   @GeneratedProperty(name="displayName", type=String.class),
   @GeneratedProperty(name="description", type=String.class),
   @GeneratedProperty(name="taskCode", type=String.class),
   @GeneratedProperty(name="viewable", type=boolean.class),
   @GeneratedProperty(name="editor", type=boolean.class)
   })
public class BomEditorACL extends _BomEditorACL {
    ...
    **/
   public static BomEditorACL newBomEditorACL()
            throws WTException {

      BomEditorACL instance = new BomEditorACL();
      instance.initialize();
      return instance;
   }
