...
<script type="text/javascript" src="/plm/extcore/js/dashboard/projectTaskTotal.js"></script>
<!-- EJS TreeGrid End -->
...
$(document).ready(function(){
    ...
    projectTaskTotal.createPaingGrid("${dashBoardDTO.programNo}", "${dashBoardDTO.pjtNo}");
});
