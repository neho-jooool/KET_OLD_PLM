...
<tr>
    <td valign="top">
        ...
        <tr>
            ...
            <td class="tdwhiteL" style="width: 160px;">
                <input type="text" id="searchPart" name="searchPart" value="<%=searchCondition.getString("searchPart") %>" class="txt_fieldRO"  style="width:100px;">
                ...
                <div class="row-fluid">
                    <div style="WIDTH:100%;HEIGHT:100%">
						...
						<bdo Debug="1" AlertError="0" 
						    Layout_Url="/plm/jsp/project/performance/ListPerformance1GridLayout.jsp" 
