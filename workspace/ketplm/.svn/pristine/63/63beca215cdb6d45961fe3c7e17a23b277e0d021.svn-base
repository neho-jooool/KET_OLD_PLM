...
//				}
			...
			Cols : [
			    {Name:'rowNum', Width:'30', RelWidth:'30', Align:'Center', CanSort:'0', CanEdit:'0', Visible:'0'},
			    {Name:'division', Width:'60', RelWidth:'60', Align:'Center', CanSort:'1', CanEdit:'0', Type:'Enum', EnumKeys:$('[name=divisionEnumKey]').val(),  Enum:$('[name=divisionEnum]').val()},
			    {Name:'devType', Width:'60', RelWidth:'60', Align:'Center', CanSort:'1', CanEdit:'0', Type:'Enum', EnumKeys:$('[name=devTypeEnumKey]').val(),  Enum:$('[name=devTypeEnum]').val()},
			    {Name:'devDiv', Width:'60', RelWidth:'60', Align:'Center', CanSort:'1', CanEdit:'0', Type:'Enum', EnumKeys:$('[name=devDivEnumKey]').val(),  Enum:$('[name=devDivEnum]').val()},
//			    {Name:'prodCategory', Width:120, Align:'Center', CanSort:'1', CanEdit:'0', Type:'Enum', EnumKeys:$('[name=prodCategoryEnumKey]').val(),  Enum:$('[name=prodCategoryEnum]').val()},
			    ...
			    {Name:'sheetName', Width:'280', RelWidth:'280', Align:'left', CanSort:'1', CanEdit:'0'},
...
//		getOpenWindow2('/plm/ext/project/gate/createTemplateAssessForm.do','TemplateAssessSheetCreatePopup',860,600);
	...
	goView : function(grid, row, col, x, y) {
		if(col != 'Panel' && row.oid) {
	        ...
	        var url='/plm/ext/project/gate/viewTemplateAssessForm.do?oid='+row.oid + '&isModify=N';
