 ...
 *
 * <p>
 * Use the <code>newProjectOutPutType</code> static factory method(s), not
 * the <code>ProjectOutPutType</code> constructor, to construct instances
...
public class ProjectOutPutType extends _ProjectOutPutType {
    ...
    **/
   public static ProjectOutPutType newProjectOutPutType()
            throws WTException {

      ProjectOutPutType instance = new ProjectOutPutType();
      instance.initialize();
      return instance;
   }
