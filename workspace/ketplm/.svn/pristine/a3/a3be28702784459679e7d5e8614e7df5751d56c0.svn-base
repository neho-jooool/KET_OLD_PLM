...
<script type="text/javascript" src="/plm/extcore/js/dashboard/productTotalTask.js"></script>
<!-- EJS TreeGrid End -->
...
$(document).ready(function(){
    ...
    productTotalTask.createPaingGrid("${dashBoardDTO.customer}","${dashBoardDTO.carType}","${dashBoardDTO.year}");
});
