...
<script type="text/javascript" src="/plm/extcore/js/dashboard/teamTaskProcessPlanData.js"></script>
<!-- EJS TreeGrid End -->
...
$(document).ready(function(){
    ...
    teamTaskProcessPlanData.createPaingGrid("${dashBoardDTO.userName}","${dashBoardDTO.startDate}","${dashBoardDTO.endDate}","${dashBoardDTO.departName}");
});
