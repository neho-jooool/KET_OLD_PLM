    ...
    createPaingGrid : function() {
        this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
            ...
            Data : {
                ...
                Format : 'Form',
                Param : {
                    formPage : (Grids['myTaskGrid']) ? Grids['myTaskGrid'].PageLength : CommonGrid.pageSize,
                    command : 'listMyTask'
                },
                Params : decodeURIComponent($('[name=myTask]').serialize())
            },
        ...
        Grids.OnDownloadPage = function(grid, row) {
            ...
            grid.Data.Page.Url = '/plm/ext/wfm/workspace/listMyTaskData.do';
