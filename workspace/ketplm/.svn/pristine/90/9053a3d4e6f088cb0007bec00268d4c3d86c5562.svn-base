...
<script type="text/javascript" src="/plm/extcore/js/dashboard/teamProjectDelayList.js"></script>
...
$(document).ready(function(){
	teamProjectDelayList.createPaingGrid("${dashBoardDTO.departName}","${dashBoardDTO.userName}","${dashBoardDTO.startDate}","${dashBoardDTO.endDate}");
});
</script>