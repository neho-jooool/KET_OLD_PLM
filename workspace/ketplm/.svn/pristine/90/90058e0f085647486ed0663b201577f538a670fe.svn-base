...
<script type="text/javascript" src="/plm/extcore/js/dashboard/moldProcessProject.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.customer}"+" "+"${dashBoardDTO.carType}"+"  "+"${dashBoardDTO.year}");
    ...
    moldProcessProject.createPaingGrid("${dashBoardDTO.customer}","${dashBoardDTO.carType}","${dashBoardDTO.year}");
