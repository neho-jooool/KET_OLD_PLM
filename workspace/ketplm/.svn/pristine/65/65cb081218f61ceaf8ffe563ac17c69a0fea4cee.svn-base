...
<script type="text/javascript" src="/plm/extcore/js/dashboard/moldPressTypeProject.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.making}"+" "+"${dashBoardDTO.type}"+"  "+"${dashBoardDTO.moldTypeCheck}");
    ...
    moldPressTypeProject.createPaingGrid("${dashBoardDTO.making}","${dashBoardDTO.type}","${dashBoardDTO.year}","${dashBoardDTO.moldTypeCheck}","${dashBoardDTO.division}");
