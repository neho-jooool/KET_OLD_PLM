...
import e3ps.edm.EDMDocumentService;
...
public class EDMDocumentHelper implements Externalizable {


   private static final String RESOURCE = "e3ps.edm.edmResource";
   private static final String CLASSNAME = EDMDocumentHelper.class.getName();

   /**
    * <BR><BR><B>Supported API: </B>true
    **/
   public static final EDMDocumentService service = wt.services.ServiceFactory.getService(EDMDocumentService.class);
