package e3ps.bom.command.documentdetails;
...
public class DocumentDetailsCmd extends AbstractAIFCommand
{
	...
	public DocumentDetailsCmd(JFrame frame, AbstractAIFUIApplication app)
    {
        this.app = app;
        parent = frame;
	...
	public DocumentDetailsCmd(JFrame frame, AbstractAIFUIApplication app, SearchBOMPanel searchPnl)
    {
		this.app = app;
	...
	private void init() 
	{
        ...
        try 
		{
			...
			urlStr = BOMBasicInfoPool.getServerCodebase().trim() + "jsp/bom/ViewRelatedList.jsp?type=dms&poid=" + itemOid.trim();
