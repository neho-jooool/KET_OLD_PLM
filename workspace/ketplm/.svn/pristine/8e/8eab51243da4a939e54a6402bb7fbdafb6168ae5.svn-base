...
public class MigProjectDocument_TEMP2 implements RemoteAccess, Serializable {
    ...
    public static MigProjectDocument_TEMP2 manager = new MigProjectDocument_TEMP2();

    public MigProjectDocument_TEMP2() {
	...
	try {
	    ...
	    Kogger.debug(MigProjectDocument_TEMP2.class, "@start");
	    MigProjectDocument_TEMP2.manager.saveFromExcel(fileName);
	    Kogger.debug(MigProjectDocument_TEMP2.class, "@end");

	} catch (Exception e) {
	    Kogger.debug(MigProjectDocument_TEMP2.class, e);
	}
    }
