...
<script type="text/javascript" src="/plm/extcore/js/dashboard/typeByCompleteProjectProduct.js"></script>
...
$(document).ready(function(){
    ...
    CompleteProductProject.createPaingGrid("${dashBoardDTO.pjtType}","${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
