var completeProcessTypeProject = {
	...
	createPaingGrid : function(making,type,year,moldType,division){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			id : 'SampleSearchGrid',
			Sort : '-pjtNo',
			perPageOnChange : 'javascript:completeProcessTypeProject.search(Value);',
			Data : {
				Url : '/plm/ext/dashboard/completeProcessTypeProjectList?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
		...
		//row click event
		Grids.OnClick = completeProcessTypeProject.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/completeProcessTypeProjectList?sortName=*Sort0';
