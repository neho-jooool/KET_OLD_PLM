...
<script type="text/javascript" src="/plm/extcore/js/dashboard/teamProjectTeamPlanList.js"></script>
...
$(document).ready(function(){
	teamProjectTeamPlanList.createPaingGrid("${dashBoardDTO.departName}","${dashBoardDTO.displayCode}","${dashBoardDTO.startDate}","${dashBoardDTO.endDate}");
});
</script>