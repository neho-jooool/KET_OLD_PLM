...
public class TransAction extends AbstractAIFAction
{
    private AbstractAIFUIApplication app;

    public TransAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public TransAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
