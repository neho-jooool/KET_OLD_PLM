 ...
 *
 * <p>
 * Use the <code>newKETDqmActionDesignReflect</code> static factory method(s),
 * not the <code>KETDqmActionDesignReflect</code> constructor, to construct
...
public class KETDqmActionDesignReflect extends _KETDqmActionDesignReflect {
    ...
    *
    * @return    KETDqmActionDesignReflect
    * @exception wt.util.WTException
    **/
   public static KETDqmActionDesignReflect newKETDqmActionDesignReflect()
            throws WTException {

      KETDqmActionDesignReflect instance = new KETDqmActionDesignReflect();
      instance.initialize();
      return instance;
   }
