...
<Grid>
    ...
    <Cfg id='SearchTypeEcoReportFormCProdGrid' />
    ...
    <LeftCols>
        ...
        <C Name='PartNo'   Width='80'  Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
        <C Name='PartName' Width='110' Align='Left'   CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
        <C Name='EcoCount' Width='60'  Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
        <C Name='Oid'      Width='0'   Align='Center' CanSort='0' CanEdit='0' Type='Text' Visible='0'/>
    </LeftCols>
    <Cols>
        <C Name='DevCnt'   Width='60' Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='ProdCnt'  Width='60' Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
        <C Name='Reason01' Width='60' Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
        <C Name='Reason02' Width='50' Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
        <C Name='Reason03' Width='60' Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
        <C Name='Reason04' Width='60' Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        ...
        <C Name='Reason06' Width='60' Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
    </Cols>
    ...
    <Header id="HeaderTop" Spanned='1' Align='Center'
            ...
            Reason02 ='<%=messageService.getString("e3ps.message.ket_message", "01784") %><%--생산성{0} 향상--%>'    Reason02RowSpan='2' Reason02Wrap='1'
            Reason03 ='<%=messageService.getString("e3ps.message.ket_message", "03027") %><%--품질문제--%>'       Reason03RowSpan='2' Reason03Wrap='1'
            Reason04 ='<%=messageService.getString("e3ps.message.ket_message", "02099") %><%--양산이관--%>'       Reason04Span='2'
            Reason06 ='<%=messageService.getString("e3ps.message.ket_message", "01136") %><%--기타--%>'           Reason06RowSpan='2'
            />
    <Header id="Header" CanDelete='0' Align='Center'
            ...
            Reason02 ='<%=messageService.getString("e3ps.message.ket_message", "01784") %><%--생산성{0} 향상--%>'
            Reason03 ='<%=messageService.getString("e3ps.message.ket_message", "03027") %><%--품질문제--%>'
            Reason04 ='<%=messageService.getString("e3ps.message.ket_message", "01253") %><%--도면--%>'
            Reason05 ='<%=messageService.getString("e3ps.message.ket_message", "00083") %><%--BOM--%>'
            Reason06 ='<%=messageService.getString("e3ps.message.ket_message", "01136") %><%--기타--%>'
            />
    </Head>
