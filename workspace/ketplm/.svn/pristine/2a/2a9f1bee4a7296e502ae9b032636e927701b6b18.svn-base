create or replace
FUNCTION FN_GET_DEPENDENCY_REVIEW_PJT(v_task_oid IN VARCHAR2, v_task_plan_start_date IN VARCHAR2, v_pjt_oid IN VARCHAR2)
/*******************************************************************************
*  [PLM System 1차개선] 검토 Project Task의 선행 Task List를 가져옴
********************************************************************************
*  FUNCTION NAME
*      FN_GET_DEPENDENCY_REVIEW_PJT
********************************************************************************
...
END FN_GET_DEPENDENCY_REVIEW_PJT;