...
<!-- EJS TreeGrid End -->
<script src="/plm/extcore/js/wfm/workflow/listCompletedWorkItem.js"></script>
<script type="text/javascript">
    $(document).ready(function(e) {
        ...
        WorkItem.createGrid();
        treeGridResize("#listCompletedWorkItemGrid","#listCompletedWorkItemGridDiv");//크롬에서 그리드 리사이즈 하기 위한 코드 param1 : grid Id, param2 : divId
        // Enter
      ...
      <td valign="top">
            ...
            <td>
              <table style="width: 100%; height: 28px;" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td class="font_01"><%=messageService.getString("e3ps.message.ket_message", "00777")%><%--결재완료함--%></td>
                  <td align="right"><img src="/plm/portal/images/icon_navi.gif">Home<img src="/plm/portal/images/icon_navi.gif"><%=messageService.getString("e3ps.message.ket_message", "00788")%><%--결재함--%>
                    <img src="/plm/portal/images/icon_navi.gif"><%=messageService.getString("e3ps.message.ket_message", "00777")%><%--결재완료함--%></td>
                </tr>
              </table>
            </td>
          </tr>
        ...
        <table border="0" cellspacing="0" cellpadding="0" style="width: 100%;">
          ...
          <tr>
            ...
            <td class="tdblueM"><%=messageService.getString("e3ps.message.ket_message", "01998")%><!-- 승인일자 --></td>
        ...
        <div class="container-fluid">
          <div class="row-fluid">
            <div id="listCompletedWorkItemGridDiv" style="WIDTH: 100%; HEIGHT: 100%"></div>
          </div>
