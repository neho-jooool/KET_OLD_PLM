...
<script type="text/javascript" src="/plm/extcore/js/dashboard/assemblyNormal.js"></script>
<!-- EJS TreeGrid End -->
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.customer}"+" "+"${dashBoardDTO.carType}"+"  "+"${dashBoardDTO.year}");
    ...
    assemblyNormal.createPaingGrid("${dashBoardDTO.type}","${dashBoardDTO.programNo}");
});
