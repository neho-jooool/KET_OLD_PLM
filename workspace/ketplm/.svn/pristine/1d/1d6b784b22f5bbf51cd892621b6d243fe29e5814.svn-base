...
<Grid>
    ...
    <LeftCols>
        ...
        <C Name='ReqName'  Width='450' Align='Left'   CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='UserName' Width='90'  Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
    </LeftCols>

    <Cols>
        <C Name='ReqDate'   Width='90' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='AppStatus' Width='90' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
    </Cols>
    ...
    <Header CanDelete='0' Align='Center'
            ...
            UserName   ='<%=messageService.getString("e3ps.message.ket_message", "02196") %><%--요청자--%>'
            ReqDate    ='<%=messageService.getString("e3ps.message.ket_message", "02195") %><%--요청일자--%>'
            AppStatus  ='<%=messageService.getString("e3ps.message.ket_message", "00771") %><%--결재상태--%>'
            />
