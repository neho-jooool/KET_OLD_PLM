...
<script type="text/javascript" src="/plm/extcore/js/dashboard/teamQulityList.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.customer}"+" "+"${dashBoardDTO.carType}"+"  "+"${dashBoardDTO.year}");
    ...
    teamQulityList.createPaingGrid("${dashBoardDTO.userName}","${dashBoardDTO.departName}","${dashBoardDTO.startDate}","${dashBoardDTO.endDate}");
});
