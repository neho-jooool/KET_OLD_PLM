var currentSetting = {
	 ...
	 * server paging grid
	 */
	createPaingGrid : function(pjtType,type,devType,year,month){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			id : 'SampleSearchGrid',
			Sort : '-pjtNo',
			perPageOnChange : 'javascript:currentSetting.search(Value);',
			Data : {
				Url : '/plm/ext/dashboard/currentSettingList?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
			...
			Cols : [
					...
					{Name : 'displayPlanStartDate', 	Width:80,  Align : 'Center', Type:'Date', Format:"yyyy-MM-dd" ,CanSort : '1', CanEdit : '0' ,Spanned:'1'},
					{Name : 'displayPlanEndDate', 	Width:80,  Align : 'Center', Type:'Date', Format:"yyyy-MM-dd" ,CanSort : '1', CanEdit : '0' ,Spanned:'1'},
					{Name : 'displayExecEndDate', 	Width:80,  Align : 'Center', Type:'Date', Format:"yyyy-MM-dd" ,CanSort : '1', CanEdit : '0' ,Spanned:'1'},
			...
			Head :[
					{
						...
						budgetCost : LocaleUtil.getMessage('02032'), budgetCostRowSpan:'2',//'수정일'
						resultCost : LocaleUtil.getMessage('02143'),resultCostRowSpan:'2',//'수정일'
					...
					},
					{
						...
						budgetCount : LocaleUtil.getMessage('02032'),//
						resultCount : LocaleUtil.getMessage('02143'),//
		...
		//row click event
		Grids.OnClick = currentSetting.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/currentSettingList?sortName=*Sort0';
