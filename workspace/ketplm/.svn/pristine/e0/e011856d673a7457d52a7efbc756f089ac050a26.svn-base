...
public class CostInterfaceErp implements RemoteAccess, Serializable {
    ...
    public static CostInterfaceErp manager = new CostInterfaceErp();

    public CostInterfaceErp() {
	...
	try {
	    ...
	    Kogger.debug(CostInterfaceErp.class, "@start:" + toDayTime);
	    CostInterfaceErp.manager.saveFromExcel("");
	    ...
	    Kogger.debug(CostInterfaceErp.class, "@end:" + toDayTime);

	} catch (Exception e) {
	    Kogger.debug(CostInterfaceErp.class, e);
	}
    }
