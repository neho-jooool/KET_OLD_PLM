// Generated SalesDeptTheReviewProject%4C9FE11A039E: ? 09/27/10 10:00:19
/* bcwti
 *
...
//##begin SalesDeptTheReviewProject%4C9FE11A039E.doc preserve=no
/**
 *
 * <p>
 * Use the <code>newSalesDeptTheReviewProject</code> static factory method(s),
 * not the <code>SalesDeptTheReviewProject</code> constructor, to construct
 ...
 * @version   1.0
 **/
//##end SalesDeptTheReviewProject%4C9FE11A039E.doc

public class SalesDeptTheReviewProject extends ForeignKeyLink implements Externalizable {
   ...
   private static final String CLASSNAME = SalesDeptTheReviewProject.class.getName();

   //##begin SALES_DEPT_ROLE%SALES_DEPT_ROLE.doc preserve=no
   /**
    * Label for the attribute.
    **/
   //##end SALES_DEPT_ROLE%SALES_DEPT_ROLE.doc
   public static final String SALES_DEPT_ROLE = "salesDept";


   //##begin REVIEW_PROJECT_ROLE%REVIEW_PROJECT_ROLE.doc preserve=no
   /**
    * Label for the attribute.
    **/
   //##end REVIEW_PROJECT_ROLE%REVIEW_PROJECT_ROLE.doc
   public static final String REVIEW_PROJECT_ROLE = "theReviewProject";

   static final long serialVersionUID = 1;
   public static final long EXTERNALIZATION_VERSION_UID = 2454203546147727912L;
   protected static final long OLD_FORMAT_VERSION_UID = 8677235652099887833L;
   ...
   protected boolean readVersion( SalesDeptTheReviewProject thisObject, ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone )
            throws IOException, ClassNotFoundException {
   ...
   //##begin getSalesDept%4C9FE11B02C3g.doc preserve=no
   /**
    * Gets the object for the association that plays role: SALES_DEPT_ROLE.
    *
    * @return    Department
    **/
   //##end getSalesDept%4C9FE11B02C3g.doc

   public Department getSalesDept() {
      //##begin getSalesDept%4C9FE11B02C3g.body preserve=no

      return (Department)getRoleAObject();
      //##end getSalesDept%4C9FE11B02C3g.body
   }

   //##begin setSalesDept%4C9FE11B02C3s.doc preserve=no
   /**
    * Sets the object for the association that plays role: SALES_DEPT_ROLE.
    *
    * @param     salesDept
    * @exception wt.util.WTPropertyVetoException
    **/
   //##end setSalesDept%4C9FE11B02C3s.doc

   public void setSalesDept( Department salesDept )
            throws WTPropertyVetoException {
      //##begin setSalesDept%4C9FE11B02C3s.body preserve=no

      setRoleAObject( (Department) salesDept );
      //##end setSalesDept%4C9FE11B02C3s.body
   }

   //##begin getReviewProject%4C9FE11B02E2g.doc preserve=no
   /**
    * Gets the object for the association that plays role: REVIEW_PROJECT_ROLE.
    *
    * @return    ReviewProject
    **/
   //##end getReviewProject%4C9FE11B02E2g.doc

   public ReviewProject getReviewProject() {
      //##begin getReviewProject%4C9FE11B02E2g.body preserve=no

      return (ReviewProject)getRoleBObject();
      //##end getReviewProject%4C9FE11B02E2g.body
   }

   //##begin setReviewProject%4C9FE11B02E2s.doc preserve=no
   /**
    * Sets the object for the association that plays role: REVIEW_PROJECT_ROLE.
    *
    * @param     theReviewProject
    * @exception wt.util.WTPropertyVetoException
    **/
   //##end setReviewProject%4C9FE11B02E2s.doc

   public void setReviewProject( ReviewProject theReviewProject )
            throws WTPropertyVetoException {
      //##begin setReviewProject%4C9FE11B02E2s.body preserve=no

      setRoleBObject( (ReviewProject) theReviewProject );
      //##end setReviewProject%4C9FE11B02E2s.body
   }
   ...
   //##begin newSalesDeptTheReviewProject%newSalesDeptTheReviewProjectf.doc preserve=no
   /**
    * Default factory for the class.
    *
    * @param     salesDept
    * @param     theReviewProject
    * @return    SalesDeptTheReviewProject
    * @exception wt.util.WTException
    **/
   //##end newSalesDeptTheReviewProject%newSalesDeptTheReviewProjectf.doc

   public static SalesDeptTheReviewProject newSalesDeptTheReviewProject( Department salesDept, ReviewProject theReviewProject )
            throws WTException {
      //##begin newSalesDeptTheReviewProject%newSalesDeptTheReviewProjectf.body preserve=no

      SalesDeptTheReviewProject instance = new SalesDeptTheReviewProject();
      instance.initialize( salesDept, theReviewProject );
      return instance;
      //##end newSalesDeptTheReviewProject%newSalesDeptTheReviewProjectf.body
   }
