...
<script type="text/javascript" src="/plm/extcore/js/dashboard/startMassTypeProject.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.making}"+" "+"${dashBoardDTO.type}"+"  "+"${dashBoardDTO.moldTypeCheck}");
    ...
    startMassProject.createPaingGrid("${dashBoardDTO.making}","${dashBoardDTO.type}","${dashBoardDTO.year}","${dashBoardDTO.moldCategoryCheck}","${dashBoardDTO.division}");
