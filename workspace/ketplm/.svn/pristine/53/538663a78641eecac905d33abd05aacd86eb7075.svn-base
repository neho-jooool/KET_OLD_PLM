...
<Grid>
    ...
    <!-- Panel 설정 -->
    <Panel Width="20" CanHide="0" />
    
    <LeftCols>
        <C Name='RowNum'          Width='0'   Align='Center' CanEdit='0' CanSort='0' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='EcnNo'           Width='80'  Align='Center' CanEdit='0' CanSort='1' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='EcnOid'          Width='0'   Align='Center' CanEdit='0' CanSort='1' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='CustomName'           Width='80'  Align='Center' CanEdit='0' CanSort='1' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='StateAppro'      Width='80'  Align='Center' CanEdit='0' CanSort='1' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='ReceiveConfirm'  Width='80'  Align='Center' CanEdit='0' CanSort='1' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='JobComplete'     Width='80'  Align='Center' CanEdit='0' CanSort='1' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='RequestDate' Width='80'  Align='Center' CanEdit='0' CanSort='1' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='JobCompleteDate' Width='80'  Align='Center' CanEdit='0' CanSort='1' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='WorkerName' Width='90'  Align='Center' CanEdit='0' CanSort='1' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='DeptName' Width='110'  Align='Center' CanEdit='0' CanSort='1' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
    </LeftCols>

    <Cols>
        <C Name='EcoNo'           Width='80'  Align='Center' CanEdit='0' CanSort='1' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='EcoName'         Width='120' RelWidth='50' Align='Left' CanEdit='0' CanSort='1' Type='Text' ExportStyle='text-align:center;vertical-align:middle'/>
    ...
    <Header CanDelete='0' Align='Center'
            ...
            EcnNo           ='<%=messageService.getString("e3ps.message.ket_message", "ECN No") %><%--ECN No--%>'
            EcnOid          ='EcnOid'
            CustomName      ='<%=messageService.getString("e3ps.message.ket_message", "04115") %><%--후속업무--%>'
            StateAppro      ='<%=messageService.getString("e3ps.message.ket_message", "진행상태") %><%--진행상태--%>'
            ReceiveConfirm  ='<%=messageService.getString("e3ps.message.ket_message", "수신확인") %><%--수신확인--%>'
            JobComplete     ='<%=messageService.getString("e3ps.message.ket_message", "업무완료") %><%--업무완료--%>'
            RequestDate ='<%=messageService.getString("e3ps.message.ket_message", "02178") %><%--완료요청일--%>'
            JobCompleteDate ='<%=messageService.getString("e3ps.message.ket_message", "완료일") %><%--완료일--%>'
            WorkerName ='ECN <%=messageService.getString("e3ps.message.ket_message", "01205") %><%--담당자--%>'
            DeptName ='ECN <%=messageService.getString("e3ps.message.ket_message", "01206") %><%--담당자부서--%>'
    ...
    <Toolbar Cells="Reload,Export,Print,Columns,Link,Empty1,excelDown,perPage,Formula"
             ...
             Empty2Width="10" Empty2Type="Html"
             Stop="<img src='/plm/portal/icon/delete_x.gif'>" StopTooltip="Stop"
             StopType="Html" StopOnClick="javascript:doStopEcn();"
