...
<script type="text/javascript" src="/plm/extcore/js/dashboard/projectCardIssue.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.customer}"+" "+"${dashBoardDTO.carType}"+"  "+"${dashBoardDTO.year}");
    ...
    projectCardIssue.createPaingGrid("${dashBoardDTO.type}","${dashBoardDTO.pjtNo}");
});
