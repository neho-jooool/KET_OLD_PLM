                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td class="tdwhiteL" colspan="3">
                                    <input type="text" name="programNamePrefix" class="txt_fieldRO" style="width: 200px" readonly value="${program.subContractor.name} ${program.carType.name}">
                            ...
                            <tr>
                                ...
                                <td class="tdwhiteL">
                                    ...
                                    <input type="hidden" name="lastUsingBuyer" value="${program.lastUsingBuyerReference}"><a href="javascript:SearchUtil.selectOneLastUsingBuyer('lastUsingBuyer','lastUsingBuyerTxt');">
                                    <img src="/plm/portal/images/icon_5.png" border="0"></a> 
                            ...
                            <tr>
                                ...
                                <td class="tdwhiteL" colspan="3">
                                    ...
                                    <a href="javascript:SearchUtil.selectOneUser('programAdmin','programAdminName');">
