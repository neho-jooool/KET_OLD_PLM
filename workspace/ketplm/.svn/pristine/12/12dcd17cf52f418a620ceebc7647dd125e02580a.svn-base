...
public class EndWorkingAction extends AbstractAIFAction
{
    private AbstractAIFUIApplication app;

    public EndWorkingAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public EndWorkingAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
