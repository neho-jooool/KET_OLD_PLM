...
<%
    ...
    String makerOid = CommonUtil.getOIDString(material.getMaterialMaker());
    String typeOid = CommonUtil.getOIDString(material.getMaterialType());
...
<head>
<title><%=messageService.getString("e3ps.message.ket_message", "02218") %><%--원재료 수정--%></title>
...
function view(){
    document.forms[0].action="/plm/jsp/project/material/MaterialView.jsp";
    document.forms[0].submit();
...
<input type="hidden" name="mType" value="<%=mType %>"></input>
      ...
      <tr>
        <td background="/plm/portal/images/logo_popupbg.png"><table height="28" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td class="font_01"><%=messageService.getString("e3ps.message.ket_message", "02218") %><%--원재료 수정--%></td>
          </tr>
        </table></td>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="460">
              <tr>
                ...
                <td width="120" class="tdwhiteL">
                  <select name="material" class="fm_jmp" style="width:90" onchange="javascript:select();">
                    <option value=""><%=messageService.getString("e3ps.message.ket_message", "01802") %><%--선택--%></option>
                    <option value="수지" <%="수지".equals(mType) ? "selected" : ""%>><%=messageService.getString("e3ps.message.ket_message", "01968") %><%--수지--%></option>
                    <option value="비철" <%="비철".equals(mType) ? "selected" : ""%>><%=messageService.getString("e3ps.message.ket_message", "01653") %><%--비철--%></option>
                  </select>
                </td>
                <td width="100" class="tdblueL">Maker</td>
                <td width="130" class="tdwhiteL0"><select name="maker" class="fm_jmp" style="width:120">
                    <option value=""><%=messageService.getString("e3ps.message.ket_message", "01802") %><%--선택--%></option>
                    <%
              ...
              <tr>
                ...
                <td width="130" class="tdwhiteL0"><input type="text" name="grade"class="txt_field"  style="width:100" id="grade" value="<%=grade %>"></input></td>
              </tr>
            </table>
            <table border="0" cellspacing="0" cellpadding="0" width="460">
              <tr>
