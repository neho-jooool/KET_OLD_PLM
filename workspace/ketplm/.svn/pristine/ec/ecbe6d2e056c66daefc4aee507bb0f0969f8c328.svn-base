 ...
 *
 * <p>
 * Use the <code>newKETATFTSheetTemplate</code> static factory method(s),
 * not the <code>KETATFTSheetTemplate</code> constructor, to construct instances
...
@GenAsPersistable(
   ...
   @GeneratedForeignKey(myRoleIsRoleA=false,
      foreignKeyRole=@ForeignKeyRole(name="atftCode", type=e3ps.common.code.NumberCode.class,
         constraints=@PropertyConstraints(required=true)),
      myRole=@MyRole(name="theKETATFTSheetTemplate", cardinality=Cardinality.ONE))
   })
public class KETATFTSheetTemplate extends _KETATFTSheetTemplate {
    ...
    *
    * @return    KETATFTSheetTemplate
    * @exception wt.util.WTException
    **/
   public static KETATFTSheetTemplate newKETATFTSheetTemplate()
            throws WTException {

      KETATFTSheetTemplate instance = new KETATFTSheetTemplate();
      instance.initialize();
      return instance;
   }
