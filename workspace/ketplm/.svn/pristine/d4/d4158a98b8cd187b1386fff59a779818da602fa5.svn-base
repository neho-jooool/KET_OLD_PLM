...
<script type="text/javascript" src="/plm/extcore/js/dashboard/teamTaskProcessTeamPlanData.js"></script>
<!-- EJS TreeGrid End -->
...
$(document).ready(function(){
    ...
    teamTaskProcessTeamPlanData.createPaingGrid("${dashBoardDTO.displayCode}","${dashBoardDTO.startDate}","${dashBoardDTO.endDate}","${dashBoardDTO.departName}");
});
