...
<title><%=messageService.getString("e3ps.message.ket_message", "01572") %><%--부품 상세조회--%></title>
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td valign="top"><table width="710" height="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="10">&nbsp;</td>
          <td valign="top"><table width="700" height=20" border="0" cellspacing="0" cellpadding="0">
              <tr>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="700">
              <tr>
                <td width="490" valign="top"><table border="0" cellspacing="0" cellpadding="0" width="490">
                    <tr>
            ...
            <%
                    ...
                    if (wt != null) {
                        ...
                        //part_ver = ObjectUtil.getLatestVersion((RevisionControlled)wt);

                        RevisionControlled rc = ObjectUtil.getLatestVersion((RevisionControlled)wt);
                        part_ver = rc.getVersionIdentifier().getValue();
            ...
            %>
                    <tr>
                      ...
                      <td width="80" class="tdblueL"><%=messageService.getString("e3ps.message.ket_message", "01119") %><%--기본단위--%></td><!-- 기본단위 -->
            ...
            <div style="width=700;height=45;overflow-x:hidden;overflow-y:auto;">
            <table border="0" cellspacing="0" cellpadding="0" width="700">
...
<%
            if ( PartUtil.isProductType(type) )    // 제품일때는 안보여줌
            {
%>
