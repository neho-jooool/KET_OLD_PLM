...
public class MigPartSendToErpSample implements RemoteAccess, Serializable {
    ...
    public static MigPartSendToErpSample manager = new MigPartSendToErpSample();

    public MigPartSendToErpSample() {
	...
	try {
	    ...
	    Kogger.debug(MigPartSendToErpSample.class, "@start");
	    MigPartSendToErpSample.manager.saveFromExcel();
	    Kogger.debug(MigPartSendToErpSample.class, "@end");

	} catch (Exception e) {
	    Kogger.debug(MigPartSendToErpSample.class, e);
	}
    }
	...
	try {
	    ...
	    String [] partTypes = new String[]{"F","H","R","K","S","D","W"}; // ,"M"
