...
<script type="text/javascript" src="/plm/extcore/js/dashboard/makingTypeProject.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.making}"+" "+"${dashBoardDTO.type}"+"  "+"${dashBoardDTO.moldTypeCheck}");
    ...
    makingTypeProject.createPaingGrid("${dashBoardDTO.making}","${dashBoardDTO.type}","${dashBoardDTO.year}","${dashBoardDTO.moldTypeCheck}","${dashBoardDTO.division}");
