...
<!--
  function deleteNotice() {
    ...
    if ( confirm("<%=messageService.getString("e3ps.message.ket_message", "01707") %><%--삭제하시겠습니까?--%>") ) {
      ...
      $.ajax({
          type       : "POST",
          url        : "/plm/servlet/e3ps/ManageQnaBoardServlet?command=delete",
          data       : $("#frm").serialize(),
    ...
    <td valign="top">
        ...
        <tr>
            <td>
                ...
                <tr>
                    ...
                    <td class="font_01"><%=messageService.getString("e3ps.message.ket_message", "00428") %><%--Q&amp;A 질문 상세조회--%></td>
                 </tr>
                </table>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td align="right">
                <table>
                <tr>
                    <%if ( isOwner == true && data.isRegisteredState() == true ){%>
                    <td>
                        <table>
                        <tr>
                            <td style="width: 10px;"><img src="/plm/portal/images/btn_1.gif"></td>
                            <td class="btn_blue" background="/plm/portal/images/btn_bg1.gif">
                                <a href="javascript:go_to('/plm/jsp/groupware/help/qna/UpdateQnaBoard_q.jsp?oid=<%=data.getOid() %>&from=<%=from %>');" class="btn_blue"><%=messageService.getString("e3ps.message.ket_message", "01936") %><%--수정--%></a>
                            </td>
                    ...
                    <%} %>
                    <%if ( (isOwner == true || isAdmin == true) && data.isRegisteredState() == true ){%>
                    <td>
                        <table>
                        <tr>
                            <td style="width: 10px;"><img src="/plm/portal/images/btn_1.gif"></td>
                    ...
                    <td style="width: 5px;">&nbsp;</td>
                    <%} %>
                    <%if ( (isAdmin == true || isBizAdmin == true) && data.isRegisteredState() == true ) {%>
                    <td>
                        <table>
                        <tr>
                            <td style="width: 10px;"><img src="/plm/portal/images/btn_1.gif"></td>
                            <td class="btn_blue" background="/plm/portal/images/btn_bg1.gif">
                                <a href="javascript:go_to('/plm/jsp/groupware/help/qna/CreateQnaBoard_a.jsp?poid=<%=data.getOid() %>&from=<%=from %>');" class="btn_blue"><%=messageService.getString("e3ps.message.ket_message", "01214") %><%--답변등록--%></a>
                            </td>
                            <td style="width: 10px;"><img src="/plm/portal/images/btn_2.gif"></td>
                        </tr>
                        </table>
