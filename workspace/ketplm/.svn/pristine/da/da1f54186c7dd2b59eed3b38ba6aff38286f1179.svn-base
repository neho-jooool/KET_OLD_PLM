...
public class BOMValidationResultTableModel extends DefaultTableModel
{
    protected JPanel bpanel;
	int number = 0;
	int startnumber = 0;
	
	public BOMValidationResultTableModel()
	{
	}
	
	public BOMValidationResultTableModel(String [] names, Object [][] data)
	{
		this();
		setData(names, data);
	}
	
	public BOMValidationResultTableModel(Vector names, Vector data)
	{
		this();
		setData(names, data);
	}
