 ...
 *
 * <p>
 * Use the <code>newKETIssueMeetingHeader</code> static factory method(s),
 * not the <code>KETIssueMeetingHeader</code> constructor, to construct
...
@GenAsPersistable(interfaces={OwnPersistable.class}, 
   ...
   properties={
   @GeneratedProperty(name="chasu", type=Integer.class,
      javaDoc="차수"),
   @GeneratedProperty(name="year", type=String.class,
      javaDoc="년도"),
   @GeneratedProperty(name="month", type=String.class,
      javaDoc="월"),
   @GeneratedProperty(name="isClose", type=boolean.class, initialValue="false",
      javaDoc="마감여부"),
...
public class KETIssueMeetingHeader extends _KETIssueMeetingHeader {
    ...
    *
    * @return    KETIssueMeetingHeader
    * @exception wt.util.WTException
    **/
   public static KETIssueMeetingHeader newKETIssueMeetingHeader()
            throws WTException {

      KETIssueMeetingHeader instance = new KETIssueMeetingHeader();
      instance.initialize();
      return instance;
   }
