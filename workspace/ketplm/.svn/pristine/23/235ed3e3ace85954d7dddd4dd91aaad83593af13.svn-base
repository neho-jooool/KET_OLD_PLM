...
function Tree(tid, rootName, dir, rootDesc)
{
    ...
    */
	this.leftSideForIE = function(node) {
		...
		renderString = renderString + "<SPAN style='color:" + fg + ";letter-spacing:-1px; background-color:" + bg + ";font-size:" + this.fontSize + ";font-family:" + this.fontName + ";cursor:hand'" + " onClick='nodes[" + node.index + "].tree.treeSelectionListener(nodes[" + node.index + "])'>" + node.name + "</SPAN>";
		if ( node.desc != null ) {
