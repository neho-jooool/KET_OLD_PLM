...
<Grid>
    ...
    <Cfg id='SelectPartPopupSearchGrid' />
    ...
    <Cols>
        <C Name='proTeam'     Width='1'   Align='Center' CanSort='1' CanEdit='0' Type='Text'  Visible='0' Hidden='1' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='oid'         Width='1'   Align='Center' CanSort='1' CanEdit='0' Type='Text'  Visible='0' Hidden='1' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        ...
        <C Name='type'        Width='50'  Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='partNo'      Width='80'  Align='Left'   CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='partName'    Width='180' Align='Left'   CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        ...
        <C Name='proTeamName' Width='160' Align='Left'   CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='dieProTeam'  Width='160' Align='Left'   CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
    </Cols>
    </Cols>

    <Header CanDelete='0' Align='Center'
            RowNum      ='<%=messageService.getString("e3ps.message.ket_message", "00342") %><%--No--%>'
            type        ='<%=messageService.getString("e3ps.message.ket_message", "00969") %><%--구분--%>'
            ...
            proTeamName ='<%=messageService.getString("e3ps.message.ket_message", "01791") %><%--생산처--%>'
            dieProTeam  ='<%=messageService.getString("e3ps.message.ket_message", "02533") %><%--제작처--%>'
            />
    <Def>
