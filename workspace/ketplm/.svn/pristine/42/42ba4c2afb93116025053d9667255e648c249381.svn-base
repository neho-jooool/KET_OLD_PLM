...
<script type="text/javascript" src="/plm/extcore/js/dashboard/typeByCompleteProjectMold.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
    ...
    CompleteMoldProject.createPaingGrid("${dashBoardDTO.pjtType2}","${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
