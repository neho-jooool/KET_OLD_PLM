...
<%
  ...
  w[5] = 80; // Creator
  w[6] = 80; // ArriveDate
  w[3] = 760 - (w[0]+w[1]+w[2]+w[4]+w[5]+w[6]); // Title
%>
    <Cols>
        ...
        <C Name='TaskName'    Width='<%=w[2] %>' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='Title'       Width='<%=w[3] %>' Align='Left'   CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:left;vertical-align:middle'/>
    ...
    <Header CanDelete='0' Align='Center'
            ...
            TaskName   ='<%=messageService.getString("e3ps.message.ket_message", "02436") %><%--작업명--%>'
