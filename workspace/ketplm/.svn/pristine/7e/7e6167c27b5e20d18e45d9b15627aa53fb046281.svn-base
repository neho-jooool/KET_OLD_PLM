...
public class E3PSContentHelper implements Externalizable {


   private static final String RESOURCE = "e3ps.common.content.contentResource";
   private static final String CLASSNAME = E3PSContentHelper.class.getName();

   /**
    **/
   public static final E3PSContentService service = wt.services.ServiceFactory.getService(E3PSContentService.class);
   static final long serialVersionUID = 1;
   public static final long EXTERNALIZATION_VERSION_UID = 957977401221134810L;
   protected static final long OLD_FORMAT_VERSION_UID = 4586654839583725336L;
    ...
    * @exception java.lang.ClassNotFoundException
    **/
   protected boolean readVersion( E3PSContentHelper thisObject, ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone )
            throws IOException, ClassNotFoundException {
