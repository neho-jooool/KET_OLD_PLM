...
document.write('<link rel="stylesheet" type="text/css" href="./css/' + strLangPath + '/uploadstyle.css" type="text/css">');
document.write('<script language="javascript" type="text/javascript" src="./js/res/' + strLangPath + '/res_upload_img.js"></scrip' +'t>');
