...
public class EjsTg9FrameWork {
    ...
    org.w3c.dom.Element[] getChanges(String XML) {
	...
	for (int i = 0; i < len; i++)
	    E[i] = (org.w3c.dom.Element) Ch.item(i);
	return E;
    }
    ...
    String toSQL(org.w3c.dom.Element I, String name) {
    ...
    String toSQLUpdateString(String name, org.w3c.dom.Element I, String attname) {
    ...
    String toSQLUpdateNumber(String name, org.w3c.dom.Element I, String attname) {
	...
	for (int i = 0; i < names.length; i++) {
		...
		if (value.equals("") && (t == java.sql.Types.DATE || t == java.sql.Types.TIME))
		    return "NULL";
		if (t == java.sql.Types.VARCHAR || t == java.sql.Types.CHAR || t == java.sql.Types.LONGVARCHAR || t == java.sql.Types.DATE
    ...
    boolean saveTree(String XML, java.sql.Statement Cmd, String table, String idCol, String parentCol, String bodyParent)
	...
	for (int i = 0; i < Ch.length; i++) {
		...
		for (int a = 0; a < A.getLength(); a++) {
		    ...
		    if (!name.equals("Added") && !name.equals("Changed") && !name.equals("Moved") && !name.equals("Next")
    ...
    String toXML(String name, java.sql.ResultSet R, String colName) throws java.sql.SQLException {
	return toXML(name, R.getString(colName));
    }

    void toXML(StringBuffer S, String name, java.sql.ResultSet R, String colName) throws java.sql.SQLException {
    ...
    String getRowXML(java.sql.ResultSet R, String[] names, String[] colNames) throws java.sql.SQLException {
    ...
    // end is the string appended after row, for rows with children use ">", without children "/>", or you can set own attributes
    // Does not move cursor in ResultSet
    String getRowXML(java.sql.ResultSet R, String[] names, int[] colIndexes) throws java.sql.SQLException {
    ...
    // end is the string appended after row, for rows with children use ">", without children "/>", or you can set own attributes
    // Does not move cursor in ResultSet
    String getRowXML(java.sql.ResultSet R, String[] names) throws java.sql.SQLException {
    ...
    // ------------------------------------------------------------------------------------------------------------------
    // Returns complete XML representation of all rows with given attribute names and their values from ResultSet in columns indexed as
    // attribute names
    ...
    String getTableXML(java.sql.ResultSet R) throws java.sql.SQLException {
    ...
    String getTreeXML(java.sql.Statement Cmd, String table, String[] names, String[] colNames, String bodyParent)
	    throws java.sql.SQLException {
	return getTreeXML(Cmd, table, orderNames(Cmd, table, names, colNames), bodyParent);
    }

    String getTreeXML(java.sql.Statement Cmd, String table, String[] names, String[] colNames, String bodyParent, String headParent,
	    String footParent, boolean deep) throws java.sql.SQLException {
	return getTreeXML(Cmd, table, orderNames(Cmd, table, names, colNames), bodyParent, headParent, footParent, deep);
    }

    String getTreeXML(java.sql.Statement Cmd, String table, String[] names, String bodyParent) throws java.sql.SQLException {
	return getTreeXML(Cmd, table, names, bodyParent, null, null, true);
    }

    String getTreeXML(java.sql.Statement Cmd, String table, String[] names, String bodyParent, String headParent, String footParent,
	    boolean deep) throws java.sql.SQLException {
	StringBuffer S = new StringBuffer();
	S.append("<Grid>");
	if (headParent != null)
    ...
    String getTreeXML(java.sql.Statement Cmd, String table, String[] names, String[] colNames, String parentVal, boolean deep)
	    throws java.sql.SQLException {
	...
	java.sql.ResultSet R = Cmd.executeQuery("SELECT * FROM " + table
	        + (parent > 0 ? " WHERE " + names[parent - 1] + "='" + parentVal + "'" : ""));
	if (R == null)
	    return "";
	while (R.next()) {
	    S.append("<I");
    ...
    java.sql.Statement getHsqlStatement(HttpServletRequest request, JspWriter out, String dbPath, String user, String pass)
	    throws Exception {
	return getHsqlStatement(request, out, dbPath, user, pass, false);
    }

    java.sql.Statement getHsqlStatement(HttpServletRequest request, JspWriter out, String dbPath, String user, String pass, boolean fromHTML)
	    throws Exception {
	...
	try {
	    ...
	    // +request.getRealPath(Path+dbPath)
	    Conn = java.sql.DriverManager.getConnection("jdbc:hsqldb:MyDB", "sa", "");
	    // Conn = java.sql.DriverManager.getConnection("jdbc:hsqldb:file:"+request.getRealPath(Path+dbPath), "sa", "");
	    // Conn = java.sql.DriverManager.getConnection("jdbc:hsqldb:file:"+request.getRealPath(Path), "sa", "");
	    // Conn = java.sql.DriverManager.getConnection("jdbc:hsqldb:file:/plm/jsp/edm/hsqldb", "sa", "");
	    return Conn.createStatement();
	} catch (Exception e) {
	    Kogger.error(getClass(), e);
	    // String Err =
	    // "! Failed to load HSQLDB JDBC driver.<br>You need to copy <b>hsqldb.jar</b> file to your shared lib directory and <b>restart</b> your http server.";
