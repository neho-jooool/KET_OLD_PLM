...
_html2canvas.Parse = function (images, options) {
  ...
  function renderImage(ctx, element, image, bounds, borders) {
    ...
    var paddingLeft = getCSSFloat(element, 'paddingLeft'),
    paddingTop = getCSSFloat(element, 'paddingTop'),
    paddingRight = getCSSFloat(element, 'paddingRight'),
    paddingBottom = getCSSFloat(element, 'paddingBottom');
