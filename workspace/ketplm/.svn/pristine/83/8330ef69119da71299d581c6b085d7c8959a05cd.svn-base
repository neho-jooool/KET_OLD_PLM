...
//	Beta 20061228
//	http://cafe.daum.net/easyeditor (변경전)
//  http://blog.uix.kr/1 (변경후)
//변수설정
var easyConfig = {
	//----------------------------------------------------
	//style
	...
	width : "100%",				//기본 width
	height : "500px",			//기본 height
	//----------------------------------------------------
	filepath : "/plm/portal/editor",	
	imgpath : "/plm/portal/editor/img/easy",		//버튼 이미지경로
...
function (self){ 
	window.open(easyConfig.filepath+"/table.html","table","width=400,height=250,status=1");
} ];
...
function (self){ 
    window.open(easyConfig.filepath+"/upload_image.jsp","image","width=300,height=390,status=1,scrollbars=1,resizable=1"); 
}]; 
/*
function (self){
	var order = "image";
