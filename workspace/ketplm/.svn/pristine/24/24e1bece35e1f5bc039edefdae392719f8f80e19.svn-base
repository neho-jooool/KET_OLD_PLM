...
<!--
  ...
  */
  ...
  function excelUpload(){
      ...
      var param = $("[name=frm]").serializefiles();
      
      if(confirm("일괄업로드를 진행하시겠습니까?") ){
          ajaxCallServer( "/plm/ext/project/issue/issueExcelUpload", param, function(data){
              location.reload();
          } );
      }
  }
        ...
        <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td valign="top">
                                        ...
                                        <td><table border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td background="/plm/portal/images/tab_3.png" class="btn_tab">
                                                        <%=messageService.getString("e3ps.message.ket_message", "00278")%><%--Issue--%></td>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="c">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td align="right"><table border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <%if(auth.isLatest && !auth.isCheckOutOrg && (auth.isProjectUser || auth.isPMO || isAdmin) ){ %>
                                                    
                                                    <td>
                                                        <img src="/plm/portal/images/iocn_excel.png" onclick="location.href='/plm/ext/download?path=/ketIssueTemplate/issueTemplate.xlsx'" style="cursor:pointer;"/>
                                                        <input type="file" name="uploadFile" />
                                                    </td>
                                                    <td width="5">&nbsp;</td>
                                                    <td width="10"><img src="../../portal/images/btn_1.gif"></td>
                                                    <td class="btn_blue" background="../../portal/images/btn_bg1.gif"><a href="#"
                                                        onClick="javascript:excelUpload();" class="btn_blue">Excel Upload</a></td>
                                ...
                                <div
                                    style="height: 220px; overflow-x: hidden; overflow-y: auto; border: 0px; border-style: solid; border-color: #5F9EA0; padding: 0px; margin: 1px;">
                                    <%
                                    ...
                                    while ( qr.hasMoreElements() ) {
                                      ...
                                      String isDone = "";
                                        ...
                                        if ( (data.isQuestionUser) && !data.isCheck || isAdmin ) {
                                            deleteIcon = " IssueDel=&quot;" + "<img src='/plm/portal/images/icon_delete.gif' border='0'>" + "&quot; IssueDelType=&quot;Html&quot;"
                                                       + " IssueDelOnClick=&quot;javascript:deleteIssue(&apos;" + data.oid + "&apos;);&quot;";
                                        }
                                        else {
                                                deleteIcon = " IssueDel=&quot;&nbsp;&quot;";
                                            }
                                      ...
                                      for ( int i = 0 ; i < answerVec.size() ; i++ ) {
                                          ...
                                          if ( (answerData.isAnswerUser) && !data.isCheck || isAdmin ) {
                                              deleteIcon = " IssueDel=&quot;" + "<img src='/plm/portal/images/icon_delete.gif' border='0'>" + "&quot; IssueDelType=&quot;Html&quot;"
                                                         + " IssueDelOnClick=&quot;javascript:deleteIssue(&apos;" + answerData.oid + "&apos;);&quot;";
                                          }
                                          else {
                                              deleteIcon = " IssueDel=&quot;&nbsp;&quot;";
                                          }
                                        ...
                                        <div class="container-fluid">
                                            <div class="row-fluid">
                                                <div style="WIDTH: 100%; HEIGHT: 100%">
                                                    <bdo Debug="0" AlertError="0"
                                                        Layout_Url="/plm/jsp/project/ProjectViewIssueGridLayout.jsp"
                                                        Data_Url="/plm/jsp/common/searchGridData.jsp" Data_Method="POST"
                                                        Data_Param_Result="<%=strBuffer.toString() %>"
                                ...
                                <table width="780" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="20"><img src="/plm/portal/images/icon_4.png"></td>
                                        <td class="font_03"><%=messageService.getString("e3ps.message.ket_message", "00718")%><%--검토 결과--%></td>
                                        <td align="right"><table border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <%
                                                        if (rd != null) {
                                                    ...
                                                    <td width="10"><img src="/plm/portal/images/btn_1.gif"></td>
                                                    <td class="btn_blue" background="/plm/portal/images/btn_bg1.gif"><a
                                                        href="javascript:viewReview('<%=oid%>', 'true');" class="btn_blue"><%=messageService.getString("e3ps.message.ket_message", "00719")%><%--검토 결과 수정--%></a></td>
                                                    <td width="10"><img src="/plm/portal/images/btn_2.gif"></td>
                                                    <%
                                                        }
                                                    %>
                                ...
                                <table border="0" cellspacing="0" cellpadding="0" width="780">
                                    ...
                                    <COL width="35%">
                                    <tr>
                                        <td class="tdblueL"><%=messageService.getString("e3ps.message.ket_message", "00898")%><%--과거차문제점--%></td>
                                        <td class="tdwhiteL"><%=rd.getPastType().getDisplay(messageService.getLocale())%></td>
                                        <td class="tdblueL"><%=messageService.getString("e3ps.message.ket_message", "01440")%><%--문제점 개선안--%></td>
                                        <td class="tdwhiteL0"><%=rd.getDeveloptype().getDisplay(messageService.getLocale())%></td>
                                    </tr>
                                    <tr>
                                        <td class="tdblueL"><%=messageService.getString("e3ps.message.ket_message", "00896")%><%--과거차 문제점 세부--%></td>
                                        <td colspan="5" class="tdwhiteL0"><textarea name="pastDesc" style="width: 100%" rows="5"
                                                class="fm_area" onKeyUp="common_CheckStrLength(this, 666)"
                                                onChange="common_CheckStrLength(this, 666)" ReadOnly><%=(rd.getPastDesc()==null)?"":rd.getPastDesc()%></textarea></td>
                                    </tr>
                                    <tr>
                                        <td class="tdblueL"><%=messageService.getString("e3ps.message.ket_message", "01441") %><%--문제점 개선안 세부--%></td>
                                        <td colspan="5" class="tdwhiteL0"><textarea name="improveDesc" style="width: 100%" rows="5"
                                                class="fm_area" onKeyUp="common_CheckStrLength(this, 666)"
                                                onChange="common_CheckStrLength(this, 666)" ReadOnly><%=(rd.getImproveDesc()==null)?"":rd.getImproveDesc() %></textarea></td>
                                    </tr>
                                    <tr>
                                        <td class="tdblueL"><%=messageService.getString("e3ps.message.ket_message", "00720") %><%--검토 내용--%>
                                        </td>
                                        <td colspan="5" class="tdwhiteL0"><textarea name="reviewDesc" style="width: 100%" rows="5"
                                                class="fm_area" onKeyUp="common_CheckStrLength(this, 666)"
                                                onChange="common_CheckStrLength(this, 666)" ReadOnly><%=(rd.getReviewDesc()==null)?"":rd.getReviewDesc() %></textarea></td>
                                    </tr>
                                </table> <%}else{ %>
                                <table border="0" cellspacing="0" cellpadding="0" width="780">
                                    <tr>
                                        <td><%=messageService.getString("e3ps.message.ket_message", "01325") %><%--등록된 검토 결과가 없습니다.--%>
                                        </td>
                                    </tr>
                                </table> <%} %>
                            </td>
