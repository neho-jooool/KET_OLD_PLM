// Generated MoldItemMaterialsLink%4CA43794032C: ? 10/12/10 16:40:45
/* bcwti
 *
...
//##begin MoldItemMaterialsLink%4CA43794032C.doc preserve=no
/**
 *
 * <p>
 * Use the <code>newMoldItemMaterialsLink</code> static factory method(s),
 * not the <code>MoldItemMaterialsLink</code> constructor, to construct
 ...
 * @version   1.0
 **/
//##end MoldItemMaterialsLink%4CA43794032C.doc

public class MoldItemMaterialsLink extends ForeignKeyLink implements Externalizable {
   ...
   private static final String CLASSNAME = MoldItemMaterialsLink.class.getName();

   //##begin MATERIALS_ROLE%MATERIALS_ROLE.doc preserve=no
   /**
    * Label for the attribute.
    **/
   //##end MATERIALS_ROLE%MATERIALS_ROLE.doc
   public static final String MATERIALS_ROLE = "materials";
   ...
   protected static final long OLD_FORMAT_VERSION_UID = -8073856171227858477L;
   ...
   protected boolean readVersion( MoldItemMaterialsLink thisObject, ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone )
            throws IOException, ClassNotFoundException {
   ...
   //##begin getMaterials%4CA437950167g.doc preserve=no
   /**
    * Gets the object for the association that plays role: MATERIALS_ROLE.
    *
    * @return    NumberCode
    **/
   //##end getMaterials%4CA437950167g.doc

   public NumberCode getMaterials() {
      //##begin getMaterials%4CA437950167g.body preserve=no

      return (NumberCode)getRoleAObject();
      //##end getMaterials%4CA437950167g.body
   }

   //##begin setMaterials%4CA437950167s.doc preserve=no
   /**
    * Sets the object for the association that plays role: MATERIALS_ROLE.
    *
    * @param     materials
    * @exception wt.util.WTPropertyVetoException
    **/
   //##end setMaterials%4CA437950167s.doc

   public void setMaterials( NumberCode materials )
            throws WTPropertyVetoException {
      //##begin setMaterials%4CA437950167s.body preserve=no

      setRoleAObject( (NumberCode) materials );
      //##end setMaterials%4CA437950167s.body
   }

   //##begin getMoldItem%4CA437950251g.doc preserve=no
   /**
    * Gets the object for the association that plays role: MOLD_ITEM_ROLE.
    *
    * @return    MoldItemInfo
    **/
   //##end getMoldItem%4CA437950251g.doc

   public MoldItemInfo getMoldItem() {
      //##begin getMoldItem%4CA437950251g.body preserve=no

      return (MoldItemInfo)getRoleBObject();
      //##end getMoldItem%4CA437950251g.body
   }

   //##begin setMoldItem%4CA437950251s.doc preserve=no
   /**
    ...
    * @exception wt.util.WTPropertyVetoException
    **/
   //##end setMoldItem%4CA437950251s.doc

   public void setMoldItem( MoldItemInfo moldItem )
            throws WTPropertyVetoException {
      //##begin setMoldItem%4CA437950251s.body preserve=no

      setRoleBObject( (MoldItemInfo) moldItem );
      //##end setMoldItem%4CA437950251s.body
   }
   ...
   //##begin newMoldItemMaterialsLink%newMoldItemMaterialsLinkf.doc preserve=no
   /**
    * Default factory for the class.
    *
    * @param     materials
    * @param     moldItem
    * @return    MoldItemMaterialsLink
    * @exception wt.util.WTException
    **/
   //##end newMoldItemMaterialsLink%newMoldItemMaterialsLinkf.doc

   public static MoldItemMaterialsLink newMoldItemMaterialsLink( NumberCode materials, MoldItemInfo moldItem )
            throws WTException {
      //##begin newMoldItemMaterialsLink%newMoldItemMaterialsLinkf.body preserve=no

      MoldItemMaterialsLink instance = new MoldItemMaterialsLink();
      instance.initialize( materials, moldItem );
      return instance;
      //##end newMoldItemMaterialsLink%newMoldItemMaterialsLinkf.body
   }
