...
public class KETNewPartListHelper implements Externalizable {


   private static final String RESOURCE = "e3ps.part.service.serviceResource";
   private static final String CLASSNAME = KETNewPartListHelper.class.getName();

   /**
    * <BR><BR><B>Supported API: </B>true
    **/
   public static final KETNewPartListService service = wt.services.ServiceFactory.getService(KETNewPartListService.class);
