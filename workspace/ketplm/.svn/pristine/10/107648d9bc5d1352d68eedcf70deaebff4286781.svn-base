...
<script type="text/javascript" src="/plm/extcore/js/dashboard/typeByProcessProjectMold.js"></script>
...
$(document).ready(function(){
   ...
   // alert("${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
    ...
    ProcessMoldProject.createPaingGrid("${dashBoardDTO.pjtType2}","${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
