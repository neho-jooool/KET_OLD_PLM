...
public class BOMDivideAction extends AbstractAIFAction 
{
	private AbstractAIFUIApplication app;

    public BOMDivideAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public BOMDivideAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
