...
public class LoadExcelBOMCmd extends AbstractAIFCommand
{
	private static Registry messageRegistry = Registry.getRegistry("e3ps.bom.message");
    private JFrame parent;
    AbstractAIFUIApplication app;

    public LoadExcelBOMCmd(JFrame frame, AbstractAIFUIApplication app)
    {
        this.app = app;
...
/*
        ...
        */
        ...
        setRunnable(new LoadExcelBOMDialog(parent, app));
    }
}
