var moldTypeProject = {
	...
	createPaingGrid : function(year,month,outsourcing,itemType,moldType,division){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			id : 'SampleSearchGrid',
			//Sort : '-planStartDate',
			perPageOnChange : 'javascript:moldTypeProject.search(Value);',
			Data : {
				Url : '/plm/ext/dashboard/moldTypeProjectList?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
			...
			Cols : [
					...
					{Name : 'departName', 	Width:70,  Align : 'Center', CanSort : '1', CanEdit : '0' ,Spanned:'1'},
		...
		//row click event
		Grids.OnClick = moldTypeProject.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/moldTypeProjectList?sortName=*Sort0';
