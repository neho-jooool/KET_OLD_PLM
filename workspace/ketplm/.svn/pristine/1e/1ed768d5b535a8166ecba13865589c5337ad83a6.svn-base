 ...
 *
 * <p>
 * Use the <code>newKETDqmRaiseSeries</code> static factory method(s), not
 * the <code>KETDqmRaiseSeries</code> constructor, to construct instances
...
public class KETDqmRaiseSeries extends _KETDqmRaiseSeries {
    ...
    *
    * @return    KETDqmRaiseSeries
    * @exception wt.util.WTException
    **/
   public static KETDqmRaiseSeries newKETDqmRaiseSeries()
            throws WTException {

      KETDqmRaiseSeries instance = new KETDqmRaiseSeries();
      instance.initialize();
      return instance;
   }
