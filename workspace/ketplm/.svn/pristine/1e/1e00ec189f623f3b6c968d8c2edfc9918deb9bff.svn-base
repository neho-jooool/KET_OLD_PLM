...
<script type="text/javascript" src="/plm/extcore/js/dashboard/teamTaskProcessTeamCompleteData.js"></script>
<!-- EJS TreeGrid End -->
...
$(document).ready(function(){
    ...
    //alert("${dashBoardDTO.type}"+"  "+"${dashBoardDTO.state}"+" "+"${dashBoardDTO.step}");
    
    teamTaskProcessTeamCompleteData.createPaingGrid("${dashBoardDTO.displayCode}","${dashBoardDTO.startDate}","${dashBoardDTO.endDate}","${dashBoardDTO.departName}");
});
