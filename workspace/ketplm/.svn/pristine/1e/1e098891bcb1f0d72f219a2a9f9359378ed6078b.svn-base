var moldReportChina = {
	...
	createPaingGrid : function(programNo,  itemType){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			id : 'SampleSearchGrid',
			Sort : '-pjtNo',
			perPageOnChange : 'javascript:moldReportChina.search(Value);',
			Data : {
				Url : '/plm/ext/dashboard/moldReportChinaProjectList?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
			...
			Cols : [
				...
				{Name : 'partName', Width:100, Align : 'Center', CanSort : '1', CanEdit : '0',Spanned:'1'},
				{Name : 'shrinkage', Width:100, Align : 'Center', CanSort : '1', CanEdit : '0',Spanned:'1'},
				{Name : 'itemType', Width:100, Align : 'Center', CanSort : '1', CanEdit : '0',Spanned:'1'},
		...
		//row click event
		Grids.OnClick = moldReportChina.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/moldReportChinaProjectList?sortName=*Sort0';
