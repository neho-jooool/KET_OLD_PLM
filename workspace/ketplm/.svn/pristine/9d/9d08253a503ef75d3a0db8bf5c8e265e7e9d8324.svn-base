...
.headerLock6 {
  ...
  z-index:99;
            ...
            <tr>
                ...
                <col width='40'><col width='60'><col width='200'><col width='*'><col width='50'><col width='50'><col width='55'><col width='55'><col width='50'><col width='50'><col width='80'><col width='90'>
                    ...
                    if( ketMoldECALinkVOList != null && ketMoldECALinkVOList.size() > 0  )
                    {
                        ...
                        for(int i=0; i< ketMoldECALinkVOList.size(); i++)
                        {
                            ...
                            if( bomHeaderLink.getActivityType().equals("2") )
                            {
                        	    ...
                        	    String beforePartOid = ketMoldECALinkVO.getBeforePartOid();
                                WTPart beforePart = (WTPart) CommonUtil.getObject(beforePartOid);
                                String beforePartNo = beforePart.getNumber();
                                String beforePartName = beforePart.getName();
                                String beforePartRev = beforePart.getVersionIdentifier().getValue();
                        	    ...
                        	    if(bomHeaderItemNo.indexOf("-") > -1) bomHeaderItemNo = bomHeaderItemNo.substring(0, bomHeaderItemNo.indexOf("-"));
                        	    
                        	    if(!bomHeaderItemNo.equalsIgnoreCase(PRE_P_NO)) {
                                    
                                    String strType = PartSpecGetter.getPartSpec(beforePart, PartSpecEnum.SpPartType);
                ...
                %>
	                                ...
	                                <tr>
	                                  ...
	                                  %>
	                                    <td class="tdblueL02" colspan="12"><%=messageService.getString("e3ps.message.ket_message", "01364") %><%--모 부품번호--%> : <%=bomHeaderItemNo %> / <%=messageService.getString("e3ps.message.ket_message", "01481") %><%--버전--%> : <a href="javascript:viewPart('<%=EcmUtil.getPartOid(bomHeaderItemNo,headerItemVer )%>');"><%=headerItemVer %></a> &nbsp;</td>
	                                  <%
	                                  }
	                                  else { 
	                                  %>
	                                    <td class="tdblueL02" colspan="12"><%=messageService.getString("e3ps.message.ket_message", "01364") %><%--모 부품번호--%> : <font color="gray"><%=messageService.getString("e3ps.message.ket_message", "04090") %><%--모 부품이 ECO에 추가되지 않았습니다.--%></font></td>
	                                  <%
	                                  } 
	                                  %>
	                                </tr>
	                                <tr>
	                                  ...
	                                  <td class="tdblueM" rowspan="2"><%=messageService.getString("e3ps.message.ket_message", "04022") %><%--자 부품명--%></td>
                ...
                <%                    
                                ...
                                PRE_P_NO = bomHeaderItemNo;
                                
                                
                                String dieNo = ketMoldECALinkVO.getDieNo();
                                if((dieNo.equals("") || dieNo.indexOf("-") > -1)) {
                                    if(dieNo.equals("")) {
                                	   dieNo = beforePartNo;
                                    }
                ...
                %>
	                                <tr>
	                                  ...
	                                  <td width='' class='tdwhiteM'>&nbsp;<%=StringUtil.checkReplaceStr(ketMoldECALinkVO.getBomChgFlag(),"Part")%>&nbsp;</td>
	                                  <td width='' class='tdwhiteM'>&nbsp;<%=dieNo %></td>
	                                  <td width='' class='tdwhiteL'><div class="ellipsis" style="width:200px;"><nobr><%=beforePartName %></nobr></div></td>
                                      <td width='' class='tdwhiteM'>&nbsp;<%=ketMoldECALinkVO.getBeforeQty()%>&nbsp;</td>
	                                  <td width='' class='tdwhiteM'>&nbsp;<%=ketMoldECALinkVO.getAfterQty()%>&nbsp;</td>
	                                  <td width='' class='tdwhiteM'>&nbsp;<ket:codeValueByCode codeType="SPECMATERIALMOLD" code="<%=StringUtils.stripToEmpty(ketMoldECALinkVO.getBeforeMaterial())%>"/>&nbsp;</td>
	                                  <td width='' class='tdwhiteM'>&nbsp;<ket:codeValueByCode codeType="SPECMATERIALMOLD" code="<%=StringUtils.stripToEmpty(ketMoldECALinkVO.getAfterMaterial()) %>"/>&nbsp;</td>
                ...
                %>
                  ...
                  <td width='' class='tdwhiteL' title='<%=org.apache.commons.lang.StringEscapeUtils.escapeHtml(ketMoldECALinkVO.getRelEcaObjectName()) %>'><div class="ellipsis" style="width:145;"><nobr><%=ketMoldECALinkVO.getRelEcaObjectName()%>&nbsp;</nobr></div></td>
