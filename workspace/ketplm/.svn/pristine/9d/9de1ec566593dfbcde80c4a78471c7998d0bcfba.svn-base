var carTypeSingle = {
	 ...
	 * server paging grid
	 */
	createPaingGrid : function(customer, carType, devType, itemType){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			id : 'SampleSearchGrid',
			Sort : '-pjtNo',
			perPageOnChange : 'javascript:carTypeSingle.search(Value);',
			Data : {
				Url : '/plm/ext/dashboard/carTypeSingleProjectList?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
			...
			Cols : [
					...
					{Name : 'level2', 	Width:100,  Align : 'Center', CanSort : '1', CanEdit : '0' ,Spanned:'1'},
					...
					{Name : 'moldType', 	Width:70,  Align : 'Center', CanSort : '0', CanEdit : '0' ,Spanned:'1'}
			],
			Header :
						{
		...
		//row click event
		Grids.OnClick = carTypeSingle.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/carTypeSingleProjectList?sortName=*Sort0';
