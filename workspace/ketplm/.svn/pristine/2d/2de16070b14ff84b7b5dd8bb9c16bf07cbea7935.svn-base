...
<script type="text/javascript" src="/plm/extcore/js/dashboard/teamQulityTeamList.js"></script>
<jsp:useBean id="messageService" class="e3ps.common.message.KETMessageService" scope="session" />
<!-- EJS TreeGrid End -->
<body class="popup-background popup-space">
<div class="sub-title"><img src="/plm/portal/images/icon_3.png" /><%=messageService.getString("e3ps.message.ket_message", "07301") %></div>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.customer}"+" "+"${dashBoardDTO.carType}"+"  "+"${dashBoardDTO.year}");
    ...
    teamQulityTeamList.createPaingGrid("${dashBoardDTO.displayCode}","${dashBoardDTO.departName}","${dashBoardDTO.startDate}","${dashBoardDTO.endDate}");
});
