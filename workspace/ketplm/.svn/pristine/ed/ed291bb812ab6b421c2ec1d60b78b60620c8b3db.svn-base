...
public class NewProjectAction extends AbstractAIFAction
{
	private AbstractAIFUIApplication app;

    public NewProjectAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public NewProjectAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
