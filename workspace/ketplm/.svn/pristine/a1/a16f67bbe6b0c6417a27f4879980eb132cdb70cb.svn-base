...
<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0">
   <tr>
		...
		<td width="100%" height="100%">
			...
			<iframe frameborder=0 width="100%" height="100%" src="/plm/jsp/common/code/AdminNumberCodeMgtFrame.jsp?expandedDepth=1&selectedDepth=-1&codetype=CUSTOMEREVENT&tname=CUSTOMEREVENT" name=iframe scrolling=auto></iframe>
		</td>
	</tr>
</table>
