...
<%
  ...
  WorkProject rproject =(WorkProject)CommonUtil.getObject(oid);
...
%>
    <script language="JavaScript">
      ...
      //parent.movePaage('/plm/jsp/project/ProjectViewLeftFrm.jsp?oid=<%=oid%>', '/plm/jsp/project/WorkProjectView.jsp?oid=<%=oid%>');
...
<%
  ...
  if(cmd.equals("out")){
    ...
    <script>
      ...
      document.location.href = "/plm/jsp/project/WorkprojectView.jsp?oid=<%=oid%>&popup=<%=popup%>";
    </script>
  <%
    }else{
...
%>
  <script language="javascript">
    ...
    document.location.href = "/plm/jsp/project/WorkprojectView.jsp?oid=<%=oid%>";
  </script>
<%
  }
...
<!--
  ...
  function updatePLMProject(){
	 ...
	 getOpenWindow2("/plm/ext/project/work/createWorkProjectForm.do?oid=<%=oid%>", '<%=oid%>', 800, 400);
  ...
  /*
    if ( confirm("프로젝트를 " + message + "상태로 변경합니다.\n변경하시겠습니까?") ) {
        document.forms[0].action = "/plm/jsp/project/WorkprojectView.jsp";
  ...
  */
  ...
  function deleteIssue(v) {
    if ( confirm("<%=messageService.getString("e3ps.message.ket_message", "03323") %><%--이슈를 삭제 합니다.\n삭제하시겠습니까?--%>") ) {
      document.forms[0].action = "/plm/jsp/project/WorkprojectView.jsp?deleteIssue="+ v;
  ...
  function projectStart(v) {
    if ( v == '<%=ProjectStateFlag.PROJECT_STATE_READY%>' ) {
      if ( confirm("<%=messageService.getString("e3ps.message.ket_message", "03345") %><%--프로젝트를 시작하려고 합니다..\n시작하시겠습니까?--%>") ) {
        document.forms[0].action = "/plm/jsp/project/WorkprojectView.jsp?isReady="+v;
        document.forms[0].method = "post";
        document.forms[0].submit();
        return;
      }
                                    ...
                                    <tr>
                                        ...
                                        <td><table border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td background="/plm/portal/images/tab_6.png" class="btn_tab">
                                                        <a href="WorkProjectView3.jsp?oid=<%=oid%>&popup=<%=popup%>" onclick="showProcessing();" class="btn_tab"><%=messageService.getString("e3ps.message.ket_message", "02327")%><%--인원--%></a></td>
                                        ...
                                        <td><table border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td><img src="/plm/portal/images/tab_4.png"></td>
                                                    <td background="/plm/portal/images/tab_6.png" class="btn_tab">
                                                        <a href="WorkProjectView5.jsp?oid=<%=oid%>&popup=<%=popup%>" onclick="showProcessing();" class="btn_tab"><%=messageService.getString("e3ps.message.ket_message", "00264")%><%--Issue--%></a></td>
                                                    <td><img src="/plm/portal/images/tab_5.png""></td>
                                                </tr>
                                            </table>
                                        </td>
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                ...
                                                                <td><table border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td width="10"><img src="/plm/portal/images/btn_1.gif"></td>
                                                                            <td class="btn_blue" background="/plm/portal/images/btn_bg1.gif"><a href="#" onClick="javascript:deleteProject('<%=oid%>');"class="btn_blue">
                                                                            <%=messageService.getString("e3ps.message.ket_message", "01690")%><%--삭제(지우기)--%></a></td>
                                                                            <td width="10"><img src="/plm/portal/images/btn_2.gif"></td>
                                                                    </tr>
                                                                    </table>
                                                                </td>
                                                                ...
                                                                %>
                                                                <%
                                                                    if (!auth.isCheckOut && auth.isLatest && (auth.isPM || auth.isPMO || isAdmin) && !auth.isCompleted) {
                                                                %>
                                                                <td width="5">&nbsp;</td>
                                                                <td>
                                                                    <table border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <td><table border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                      <td width="10"><img src="/plm/portal/images/btn_1.gif"></td>
                                                                      <td class="btn_blue" background="/plm/portal/images/btn_bg1.gif"><a href="javascript:stateChange('COMPLETED', '완료 ');" class="btn_blue"><%=messageService.getString("e3ps.message.ket_message", "02171") %><%--완료--%></a></td>
                                                                      <td width="10"><img src="/plm/portal/images/btn_2.gif"></td>
                                                                    </tr>
                                                                  </table></td>
                                                                <%}%>
...
<%--                                                                 <td width="5">&nbsp;</td>
                                                                ...
                                                                %>
                                                                <%
                                                                    if ((auth.isWorkingCopy && auth.isLatest && (auth.isPM) && auth.isPlanChange) || CommonUtil.isAdmin()) {
                                                                %>
                                                                ...
                                                                <!-- 삭제 -->
                                                                <%
                                                                    if (!auth.isCheckOut && ((isAdmin || auth.isPM) && auth.isFirst && auth.isPlanChange && auth.isElectronBuse) || (auth.isFirst && auth.isPMOInWork && (isAdmin || auth.isPMO))) {
                                                                %>
                                                                <td>&nbsp;</td>
                                                                <td>
                                                                    <table border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%" style="table-layout: fixed;">
                                                ...
                                                <tr>
                                                    <td class="tdblueL"><%=messageService.getString("e3ps.message.ket_message", "03060")%><%--구분--%></td>
                                                    <td class="tdwhiteL"><%=projectData.workType%></td>
