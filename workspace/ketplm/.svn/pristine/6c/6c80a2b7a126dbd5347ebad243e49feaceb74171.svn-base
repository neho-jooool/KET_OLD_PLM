...
<Grid>
    ...
    <Cols>
        ...
        <C Name='Making'        Width='80' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <%}%>
        <C Name='Eco'           Width='50' Align='Center' CanSort='1' CanEdit='0' Type='Int'  MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
    </Cols>
    ...
    <Header CanDelete='0' Align='Center'
            ...
            <%}%>
            Eco     ='<%=messageService.getString("e3ps.message.ket_message", "01871") %><%--설변--%>'
            />
