...
<script type="text/javascript" src="/plm/extcore/js/dashboard/typeByCompleteProjectTotal2.js"></script>
...
$(document).ready(function(){
    ...
    CompleteMoldProjectTotal.createPaingGrid("${dashBoardDTO.pjtType2}","${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
});
