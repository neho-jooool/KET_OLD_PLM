...
<script type="text/javascript" src="/plm/extcore/js/dashboard/moldReportChina.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.customer}"+" "+"${dashBoardDTO.carType}"+"  "+"${dashBoardDTO.year}");
    ...
    moldReportChina.createPaingGrid("${dashBoardDTO.programNo}","${dashBoardDTO.itemType}");
});
