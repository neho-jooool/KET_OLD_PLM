 ...
 *
 * <p>
 * Use the <code>newKETPartChangeLog</code> static factory method(s), not
 * the <code>KETPartChangeLog</code> constructor, to construct instances
...
public class KETPartChangeLog extends _KETPartChangeLog {
    ...
    *
    * @return    KETPartChangeLog
    * @exception wt.util.WTException
    **/
   public static KETPartChangeLog newKETPartChangeLog()
            throws WTException {

      KETPartChangeLog instance = new KETPartChangeLog();
      instance.initialize();
      return instance;
   }
