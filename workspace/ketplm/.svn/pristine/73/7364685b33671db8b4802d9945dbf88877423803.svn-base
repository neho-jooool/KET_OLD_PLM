...
<script type="text/javascript" src="/plm/extcore/js/dashboard/moldDebugTypeProject.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.making}"+" "+"${dashBoardDTO.type}"+"  "+"${dashBoardDTO.moldTypeCheck}");
    ...
    moldDebugTypeProject.createPaingGrid("${dashBoardDTO.year}","${dashBoardDTO.month}","${dashBoardDTO.outsourcing}","${dashBoardDTO.itemType}","${dashBoardDTO.moldType}","${dashBoardDTO.division}");
});
