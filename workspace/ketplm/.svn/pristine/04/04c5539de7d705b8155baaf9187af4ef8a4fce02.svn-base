...
<script type="text/javascript" src="/plm/extcore/js/dashboard/itemMoldListPopup.js"></script>
...
$(document).ready(function(){
    ...
    itemMoldListPopup.createPaingGrid("${dashBoardDTO.customer}","${dashBoardDTO.carType}","${dashBoardDTO.itemType}");
});
