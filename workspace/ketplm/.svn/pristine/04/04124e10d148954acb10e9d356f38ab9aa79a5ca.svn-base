...
<Grid>
    ...
    <LeftCols>
        ...
        <C Name='PjtName'   Width='140' Align='left'   CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='Buyer'     Width='110' Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
    </LeftCols>

    <Cols>
        <C Name='PjtPlanStartDate' Width='90' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='PjtPlanEndDate'   Width='90' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='PjtStatus'        Width='80' Align='Center' CanSort='0' CanEdit='0' Type='Html' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='PjtState'         Width='70' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
    </Cols>
<!-- 고객,개발완료일 -->
    <Header CanDelete='0' Align='Center'
            ...
            PjtPlanStartDate ='<%=messageService.getString("e3ps.message.ket_message", "00643") %><%--개발시작일--%>'
            PjtPlanEndDate   ='<%=messageService.getString("e3ps.message.ket_message", "00647") %><%--개발완료일--%>'
            PjtStatus        ='<%=messageService.getString("e3ps.message.ket_message", "03124") %><%--프로젝트현황--%>'
