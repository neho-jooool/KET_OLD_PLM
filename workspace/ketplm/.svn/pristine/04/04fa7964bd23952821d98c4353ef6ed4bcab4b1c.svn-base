 ...
 *
 * <p>
 * Use the <code>newCustomerSopHistory</code> static factory method(s),
 * not the <code>CustomerSopHistory</code> constructor, to construct instances
...
@GenAsPersistable(
   ...
   @GeneratedProperty(name="rev", type=String.class,
      javaDoc="버전"),
   @GeneratedProperty(name="sopDate", type=Timestamp.class,
      javaDoc="(목표)고객sop"),
   @GeneratedProperty(name="changeReason", type=String.class,
      javaDoc="변경사유",
      constraints=@PropertyConstraints(upperLimit=4000))
   })
public class CustomerSopHistory extends _CustomerSopHistory {
    ...
    *
    * @return    CustomerSopHistory
    * @exception wt.util.WTException
    **/
   public static CustomerSopHistory newCustomerSopHistory()
            throws WTException {

      CustomerSopHistory instance = new CustomerSopHistory();
      instance.initialize();
      return instance;
   }
