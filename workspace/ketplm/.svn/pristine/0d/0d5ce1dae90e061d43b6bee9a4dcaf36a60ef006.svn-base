...
<script type="text/javascript" src="/plm/extcore/js/dashboard/projectTaskProcess.js"></script>
<!-- EJS TreeGrid End -->
...
$(document).ready(function(){
    ...
    projectTaskProcess.createPaingGrid("${dashBoardDTO.programNo}", "${dashBoardDTO.pjtNo}");
});
