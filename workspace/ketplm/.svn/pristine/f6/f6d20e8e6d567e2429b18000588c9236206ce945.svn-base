 ...
 *
 * <p>
 * Use the <code>newKETDqmActionCause</code> static factory method(s), not
 * the <code>KETDqmActionCause</code> constructor, to construct instances
...
public class KETDqmActionCause extends _KETDqmActionCause {
    ...
    *
    * @return    KETDqmActionCause
    * @exception wt.util.WTException
    **/
   public static KETDqmActionCause newKETDqmActionCause()
            throws WTException {

      KETDqmActionCause instance = new KETDqmActionCause();
      instance.initialize();
      return instance;
   }
