...
<script type="text/javascript" src="/plm/extcore/js/dashboard/typeByProcessProjectTotal1.js"></script>
...
$(document).ready(function(){
   ...
   // alert("${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
    ...
    ProcessReviewProjectTotal.createPaingGrid("${dashBoardDTO.pjtType}","${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
});
