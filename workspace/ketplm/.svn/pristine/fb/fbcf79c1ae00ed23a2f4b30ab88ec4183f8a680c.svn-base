...
<title><%=messageService.getString("e3ps.message.ket_message", "02375") %><%--임시저장함--%></title>
...
function search(){
  ...
  form01.method="post";
  form01.action = "/plm/servlet/e3ps/WorkspaceServlet?cmd=searchTempAppr";
  form01.submit();
}
        ...
        <tr>
          <td><table style="width:780px; height:28px;" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td align="right"><img src="/plm/portal/images/icon_navi.gif">Home<img src="/plm/portal/images/icon_navi.gif"><%=messageService.getString("e3ps.message.ket_message", "02435") %><%--작업공간--%><img src="/plm/portal/images/icon_navi.gif"><%=messageService.getString("e3ps.message.ket_message", "02375") %><%--임시저장함--%></td>
              </tr>
            </table></td>
        </tr>
        <tr>
                        ...
                        <div class="row-fluid">
                            <div style="WIDTH:100%;HEIGHT:100%">
                                <bdo Debug="1" AlertError="0"
                                    Layout_Url="/plm/jsp/wfm/TempApprovalListGridLayout.jsp"
                                    ...
                                    Export_Data="TGData"
                                    Export_Param_File="Temp_Approval_List"
                                ></bdo>
                            </div>
                        </div>
                    </div>
