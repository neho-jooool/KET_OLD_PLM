...
<script type="text/javascript" src="/plm/extcore/js/dashboard/teamProjectProcessList.js"></script>
...
$(document).ready(function(){
	teamProjectProcessList.createPaingGrid("${dashBoardDTO.departName}","${dashBoardDTO.userName}","${dashBoardDTO.startDate}","${dashBoardDTO.endDate}");
});
</script>