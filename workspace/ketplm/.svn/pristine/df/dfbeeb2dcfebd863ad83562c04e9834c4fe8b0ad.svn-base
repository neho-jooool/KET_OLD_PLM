 ...
 *
 * <p>
 * Use the <code>newBoardCategory</code> static factory method(s), not the
 * <code>BoardCategory</code> constructor, to construct instances of this
...
@GenAsPersistable(interfaces={Tree.class}, versions={-1445045905555831280L},
   properties={
   @GeneratedProperty(name="name", type=String.class),
   @GeneratedProperty(name="description", type=String.class,
      constraints=@PropertyConstraints(upperLimit=2000)),
   @GeneratedProperty(name="treeType", type=int.class)
   })
public class BoardCategory extends _BoardCategory {
    ...
    **/
   public static BoardCategory newBoardCategory()
            throws WTException {

      BoardCategory instance = new BoardCategory();
      instance.initialize();
      return instance;
   }
    ...
    **/
   boolean readVersion_1445045905555831280L( ObjectInput input, long readSerialVersionUID, boolean superDone )
