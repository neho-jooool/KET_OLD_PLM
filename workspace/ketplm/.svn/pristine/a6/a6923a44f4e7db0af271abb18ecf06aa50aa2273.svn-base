var PartList = {
                    ...
                    {Name : 'spPartRevision', Align : 'Center', CanSort : '1', CanEdit : '0'}
                        ...
                        Cols : [
                            ...
                            {Name : 'primaryEpmNo', Align : 'Center', CanSort : '1', CanEdit : '0', Type : 'Html'},
                				...
                				{Name : 'spMTerminal', Align : 'Left', CanSort : '1', CanEdit : '0'},
                				{Name : 'spMConnector', Align : 'Left', CanSort : '1', CanEdit : '0'},
                				{Name : 'spMatchBulb', Align : 'Left', CanSort : '1', CanEdit : '0'},
                				{Name : 'spMClip', Align : 'Left', CanSort : '1', CanEdit : '0'},
                				{Name : 'spMRH', Align : 'Left', CanSort : '1', CanEdit : '0'},
                				{Name : 'spMCover', Align : 'Left', CanSort : '1', CanEdit : '0'},
                				...
                				{Name : 'spMWireSeal', Align : 'Left', CanSort : '1', CanEdit : '0'},
        ...
        search : function(perPage){
                ...
                Grids[0].Source.Data.Url = '/plm/ext/part/base/findPagingList.do?sortName=*Sort0&pageTotalSize=-1';
                Grids[0].Source.Data.Params = decodeURIComponent($('[name=PartSearchForm]').serialize());
