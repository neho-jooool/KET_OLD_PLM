...
<Grid>
    ...
    <LeftCols>
        ...
        <C Name='DieNo'       Width='100' Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
        <C Name='PartNo'      Width='70'  Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
        <C Name='PartName'    Width='120' Align='left'   CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
        <C Name='RankMold'    Width='40'  Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
    </LeftCols>

    <Cols>
        <C Name='MoldPm'         Width='50'  Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='ProductPm'      Width='50'  Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
        <C Name='MakingType'     Width='70'  Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
        <C Name='OutsorcingType' Width='100' Align='left'   CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
    ...
    <Header id="HeaderTop" Spanned='1' Align='Center'
            ...
            PartNo         ='<%=messageService.getString("e3ps.message.ket_message", "00348") %><%--Part No--%>'                PartNoRowSpan='2'
            PartName       ='<%=messageService.getString("e3ps.message.ket_message", "00347") %><%--Part Name--%>'              PartNameRowSpan='2'
            RankMold       ='<%=messageService.getString("e3ps.message.ket_message", "00436") %><%--Rank--%>'                   RankMoldRowSpan='2'
            MoldPm         ='<%=messageService.getString("e3ps.message.ket_message", "01205") %><%--담당자--%>'                 MoldPmSpan='2'
            MakingType     ='<%=messageService.getString("e3ps.message.ket_message", "02532") %><%--제작구분--%>'               MakingTypeRowSpan='2'
            OutsorcingType ='<%=messageService.getString("e3ps.message.ket_message", "02533") %><%--제작처--%>'                 OutsorcingTypeRowSpan='2'
            Delivery       ='<%=messageService.getString("e3ps.message.ket_message", "00401") %><%--Project 성과--%>'           DeliverySpan='5' DeliveryType='Text'
            />
    <Header id="Header" CanDelete='0' Align='Center'
            ...
            RankMold       ='<%=messageService.getString("e3ps.message.ket_message", "00436") %><%--Rank--%>'
            MoldPm         ='<%=messageService.getString("e3ps.message.ket_message", "00997") %><%--금형--%>'
            ProductPm      ='<%=messageService.getString("e3ps.message.ket_message", "00582") %><%--개발--%>'
            MakingType     ='<%=messageService.getString("e3ps.message.ket_message", "02532") %><%--제작구분--%>'
            OutsorcingType ='<%=messageService.getString("e3ps.message.ket_message", "02533") %><%--제작처--%>'
