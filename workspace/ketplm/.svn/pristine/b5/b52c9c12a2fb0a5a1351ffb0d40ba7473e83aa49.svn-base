...
<script type="text/javascript" src="/plm/extcore/js/dashboard/completeAndnotcompleteProject1.js"></script>
...
$(document).ready(function(){
   ...
   // alert("${dashBoardDTO.type}"+" "+"${dashBoardDTO.devType}"+"  "+"${dashBoardDTO.year}");
    ...
    completeAndnotcompleteProject.createPaingGrid("${dashBoardDTO.pjtType}","${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
