...
<Grid>
    ...
    <LeftCols>
        ...
        <C Name='MpCustomer'  Width='50'  Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
        <C Name='MpCarType'   Width='50'  Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
        <C Name='MpFormType'  Width='50'  Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
        <C Name='MpModelName' Width='130' RelWidth='50' Align='Left'   CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:left;vertical-align:middle'   Spanned='1'/>
    </LeftCols>

    <Cols>
        <C Name='MpTotal'     Width='70' Align='Right'  CanSort='1' CanEdit='0' Type='Int' Format='#,000' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:right;vertical-align:middle' Spanned='1'/>
        <C Name='Op1Date'     Width='70' Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='Op2Date'     Width='60' Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='Op3Date'     Width='60' Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='Op4Date'     Width='60' Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='Op5Date'     Width='60' Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='Op6Date'     Width='60' Align='Center' CanSort='0' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle' Spanned='1'/>
    </Cols>
    ...
    <Header id="HeaderTop" Spanned='1' Align='Center'
            ...
            MpCustomer ='<%=messageService.getString("e3ps.message.ket_message", "02847") %><%--최종사용처--%>'       MpCustomerRowSpan='2'
            MpCarType  ='<%=messageService.getString("e3ps.message.ket_message", "02745") %><%--차종--%>'       MpCarTypeRowSpan='2'
            MpFormType ='<%=messageService.getString("e3ps.message.ket_message", "03223") %><%--형태--%>'       MpFormTypeRowSpan='2'
            MpModelName='<%=messageService.getString("e3ps.message.ket_message", "01750") %><%--상세차종--%>'   MpModelNameRowSpan='2'
            MpTotal    ='<%=messageService.getString("e3ps.message.ket_message", "01779") %><%--생산대수--%>'   MpTotalRowSpan='2'
            Op1Date    ='Event' Op1DateSpan='6' Op1DateType='Text'
            />
    <Header id="Header" CanDelete='0' Align='Center'
            ...
            MpModelName='<%=messageService.getString("e3ps.message.ket_message", "01750") %><%--상세차종--%>'   MpModelNameRowSpan='2'
            MpTotal    ='<%=messageService.getString("e3ps.message.ket_message", "01779") %><%--생산대수--%>'   MpTotalRowSpan='2'
            Op1Date    ='<%=messageService.getString("e3ps.message.ket_message", "00328") %><%--Model 고정--%>'
            Op2Date    ='PROTO'
            Op3Date    ='PILOT1'
            Op4Date    ='PILOT2'
            Op5Date    ='M'
