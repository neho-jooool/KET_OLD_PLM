...
<script type="text/javascript" src="/plm/extcore/js/dashboard/thisYearMoldProject.js"></script>
...
$(document).ready(function(){
   ...
   // alert("${dashBoardDTO.type}"+" "+"${dashBoardDTO.devType}"+"  "+"${dashBoardDTO.year}");
    ...
    thisYearMoldProject.createPaingGrid("${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}","${dashBoardDTO.division}");
