...
public class CellCopyAction extends AbstractAIFAction
{
    private AbstractAIFUIApplication app;

    public CellCopyAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public CellCopyAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
