...
public class WFHistoryDetailsAction extends AbstractAIFAction {
    private AbstractAIFUIApplication app;

    public WFHistoryDetailsAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public WFHistoryDetailsAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
