       ...
       <tr>
        ...
        <tr>
            ...
            <td align="right">
                <table>
                <tr>
                    <%if ( (isBizAdmin == true && data.isProcessingState()) || isAdmin == true ){%>
                    <td>
                        <table>
                        <tr>
                            <td style="width: 10px;"><img src="/plm/portal/images/btn_1.gif"></td>
                            <td class="btn_blue" background="/plm/portal/images/btn_bg1.gif">
                                <a href="javascript:go_to('/plm/jsp/groupware/help/qna/UpdateQnaBoard_a.jsp?oid=<%=data.getOid() %>&from=<%=from %>');" class="btn_blue"><%=messageService.getString("e3ps.message.ket_message", "01215") %><%--답변수정--%></a>
                            </td>
