...
<script type="text/javascript" src="/plm/extcore/js/dashboard/typeByTotalProjectTotal.js"></script>
...
$(document).ready(function(){
 ...
 //   alert("${dashBoardDTO.type}"+"  "+"${dashBoardDTO.devType}"+"  "+"${dashBoardDTO.year}");
    ...
    TotalProject.createPaingGrid("${dashBoardDTO.pjtType1}","${dashBoardDTO.type}","${dashBoardDTO.devType}","${dashBoardDTO.year}");
});
