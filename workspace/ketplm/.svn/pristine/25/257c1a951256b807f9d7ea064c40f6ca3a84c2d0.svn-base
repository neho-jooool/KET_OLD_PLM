...
<script type="text/javascript" src="/plm/extcore/js/dashboard/devQuiltyProblemList.js"></script>
...
$(document).ready(function(){
   ...
   // alert("${dashBoardDTO.pjtType}");
    
    devQuiltyProblemList.createPaingGrid("${dashBoardDTO.type}","${dashBoardDTO.level2}","${dashBoardDTO.pjtType}");
