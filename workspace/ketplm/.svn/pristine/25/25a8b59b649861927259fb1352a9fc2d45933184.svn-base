...
%>
    ...
    rArr[5] = "<%=StringUtil.checkNull(ketSearchEcoDetailVO.getApproveDate())%>";<%//approveDate%>
    rArr[6] = "<%=StringUtil.checkNull(ketSearchEcoDetailVO.getCreateDeptName())%>";<%//CreateDeptName%>
    rArr[7] ="<%=StringUtil.checkNull(ketSearchEcoDetailVO.getSecureBudgetYn())%>";<%//SecureBudgetYn%>
