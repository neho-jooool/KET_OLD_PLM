...
<script type="text/javascript" src="/plm/extcore/js/dashboard/moldIssueProject.js"></script>
...
$(document).ready(function(){
  ...
  //  alert("${dashBoardDTO.making}"+" "+"${dashBoardDTO.type}"+"  "+"${dashBoardDTO.moldTypeCheck}");
    ...
    moldIssueProject.createPaingGrid("${dashBoardDTO.year}","${dashBoardDTO.month}","${dashBoardDTO.outsourcing}","${dashBoardDTO.itemType}","${dashBoardDTO.moldType}","${dashBoardDTO.division}");
});
