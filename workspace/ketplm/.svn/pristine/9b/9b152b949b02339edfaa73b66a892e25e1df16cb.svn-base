...
%>
    <Cols>
        ...
        <C Name='Status'      Width='<%=w[3] %>' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        ...
        <C Name='CreateDate'  Width='<%=w[5] %>' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
        <C Name='ArriveDate'  Width='<%=w[6] %>' Align='Center' CanSort='1' CanEdit='0' Type='Text' MinWidth='<%=colMinWidth%>' ExportStyle='text-align:center;vertical-align:middle'/>
    </Cols>
    ...
    <Header CanDelete='0' Align='Center'
            ...
            Title     ='<%=messageService.getString("e3ps.message.ket_message", "02762") %><%--참조 대상명--%>'
            Status    ='<%=messageService.getString("e3ps.message.ket_message", "00771") %><%--결재상태--%>'
            Creator   ='<%=messageService.getString("e3ps.message.ket_message", "01133") %><%--기안자--%>'
            CreateDate='<%=messageService.getString("e3ps.message.ket_message", "01335") %><%--등록일--%>'
            ArriveDate='<%=messageService.getString("e3ps.message.ket_message", "01300") %><%--도착일--%>'
            />
