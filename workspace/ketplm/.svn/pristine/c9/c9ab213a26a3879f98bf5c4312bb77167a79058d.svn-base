var quiltyProblemList = {
	...
	createPaingGrid : function(customer,carType,year){
		this.grid = TreeGrid(CommonGrid.getPagingGridConfig({
			id : 'SampleSearchGrid',
			Sort : '-pjtNo',
			perPageOnChange : 'javascript:quiltyProblemList.search(Value);',
			Data : {
				Url : '/plm/ext/dashboard/quiltyProblemList?sortName=*Sort0',
				Method : 'POST',
				Format : 'Form',
				Timeout : 0,
				Param : {
			...
			Cols : [
					...
					{Name : 'problem', 	Width:50,  Align : 'Left', CanSort : '1', CanEdit : '0' ,Spanned:'1'},
		...
		//row click event
		Grids.OnClick = quiltyProblemList.goView;
		
		//download page  event
		Grids.OnDownloadPage = function(grid,row){
			grid.Data.Page.Format = 'Form';
			grid.Data.Page.Method = 'Post';
			grid.Data.Page.Url = '/plm/ext/dashboard/quiltyProblemList?sortName=*Sort0';
