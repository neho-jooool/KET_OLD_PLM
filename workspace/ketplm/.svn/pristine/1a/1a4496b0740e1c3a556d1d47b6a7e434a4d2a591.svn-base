...
<frameset cols=200,* framespacing=0 frameborder=no id=bottomFrame>
	<frame name=bottomLeftFrame frameborder=no  scrolling='no' src="<%=leftSrc%>" id=bottomLeftFrame noresize >
	<frame name=contName frameborder=no id=bottomRightFrame src="<%=contSrc%>" noresize>
</frameset>
<!-- NEW End -->
</frameset>
<noframes><body>
