...
$(document).ready(function(){
	$(document).attr('title',LocaleUtil.getMessage('09258'));//'금형 Try 조건표 [MOLD] 등록'
    ...
    var detailInfoHide = function(){$("#detailInfo").hide();};
    
    
    var detailInfoShow = function(){
        var imgLeft = $("#detailInfoImg").offset().left - 500;
        var imgTop = $("#detailInfoImg").offset().top- 300;
        $("#detailInfo").show();
        $("#detailInfo").offset({left : imgLeft, top : imgTop});
    }
    
    $(window).resize(function(){
    	detailInfoHide();
    })
    $("[name=cavityCount]").focus(detailInfoShow);
    
    $("[name=cavityCount]").blur(detailInfoHide);
    
    $("[name=cavityCount]").mouseover(detailInfoShow);
    
    $("[name=cavityCount]").mouseout(detailInfoHide);
    
    $("#detailInfoImg").mouseover(detailInfoShow);
    
    $("#detailInfoImg").mouseout(detailInfoHide);
});
//-->
</script>
...
<div class="contents-wrap">
    ...
    <div class="float-r" style="text-align:right">
        ...
        <span class="in-block v-middle"><span class="pro-table"><span class="pro-cell b-left"></span><span class="pro-cell b-center"><a href="javascript:TryCondition.createTryMold()" class="btn_blue"><%=messageService.getString("e3ps.message.ket_message", "02453") %><!-- 저장 --></a></span><span class="pro-cell b-right"></span></span></span>
        ...
        <table cellpadding="0" class="table-style-01" summary="">
            ...
            <tbody>
                <tr>
                    ...
                    <td colspan="3"><%=messageService.getString("e3ps.message.ket_message", "00574") %><!-- 가로 --> : <input type="text"  value="${tryMold.moldBaseSizeWidth}" name="moldBaseSizeWidth" class="width10" />&nbsp; <%=messageService.getString("e3ps.message.ket_message", "01908") %><!-- 세로 --> : <input type="text"  value="${tryMold.moldBaseSizeLength}" name="moldBaseSizeLength" class="width10" />&nbsp; <%=messageService.getString("e3ps.message.ket_message", "09283") %><!-- 높이 --> : <input type="text"  value="${tryMold.moldBaseSizeHeight}" name="moldBaseSizeHeight"  class="width10" /> mm</td>
                </tr>
                <tr>
                    ...
                    <td class="title"><%=messageService.getString("e3ps.message.ket_message", "09280") %><!-- Cavity 수 --> <br>[1Shot]<span class="red-star">*</span></td>
                    <td>
                        <input type="text" value="${tryMold.cavityCount}" name="cavityCount" class="width30" esse="true" esseLabel="<%=messageService.getString("e3ps.message.ket_message", "09280") %>"/>
                        <span style="margin-right:80px;"></span><img src="/plm/portal/images/exclamation.png" id="detailInfoImg" style="cursor:pointer;">
                        <div id="detailInfo" style="font: bold 1.1em/2.0em 나눔고딕; height:250px;width:450px; position:absolute; display:none;border:1px solid #B7D1E2;z-index:9999;background-color:#FACC2E;">
                        <div style="text-align:center;"><용어정의></div>
								<span style="padding-left: 5px;"></span>1. 총 Cavity 수 : 단일 금형 No. 에서 나올수 있는 최대 Cavity수<br>
								<span style="padding-left: 5px;"></span>2. Cavity 수 [1Shot] : 상/하측 금형이 1회 형개/폐되어 나오는 Cavity수<br>
								<span style="padding-left: 15px;"></span> ★ 예시) Insert 금형 [ 1 * 4 * 2 ]<br> 
								<span style="padding-left: 25px;">- 의미 : 상측1벌 * 하측 금형 1벌당 Cavity수 * 하측 금형 2벌<br>
								<span style="padding-left: 25px;">- 총 Cavity 수 : 1 * 4 * 2 [8 Cavity]<br>
								<span style="padding-left: 25px;">- Cavity 수 [1Shot] : 4 Cavity <br>
                        </div>
                    </td>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="7" >
                        ...
                        mm/s<span style ="color:#f60000;font-size:12px; margin-left:11px;"><b>※ C/T및 중량표시는 Cavity수[1Shot] 기준으로 입력</b></span></td>
                </tr>
                <tr>
                    ...
                    <td colspan="7" >
                        ...
                        mm<span style ="color:#f60000;font-size:12px; margin-left:20px;"><b>※ Insert 사출물 일 경우 Insert 중량을 반드시 입력</b></span></td>
                </tr>
                <tr>
