...
<!-------------------------------------- 상단 제목 버튼 끝 //-------------------------------------->
        ...
        <tr>
            ...
            <!------------------------------ 본문 Start //------------------------------>
                <table >
                <%if(CommonUtil.isAdmin() || isSalesRole) {%>
                <table style="width: 100%;">
                        <tr>
                            <td align="right">
                                <table>
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <td class="btn_blue" background="/plm/portal/images/btn_bg1.gif"><a
                                                        href="Javascript:saveRealCost();" class="btn_blue">회수비 수정</a></td>
                                                    <td style="width: 10px;"><img src="/plm/portal/images/btn_2.gif"></td>
                                                </tr>
                                            </table>
                                        </td>
                ...
                <tr>
                    ...
                    <td class="tdwhiteL0" colspan="3"><%=changeType%>&nbsp;</td>
                </tr>
                <tr>
                    <td class="tdblueL"><%=messageService.getString("e3ps.message.ket_message", "01498") %><%--변경 사유--%></td>
                    <td class="tdwhiteL0"><%=stopChageType%>&nbsp;</td>
                    <td class="tdblueL"><%=messageService.getString("e3ps.message.ket_message", "02020") %><%--시행일--%></td>
                    <td class="tdwhiteL0"><%=changeDate%>&nbsp;</td>
                </tr>
                <tr>
                    <td class="tdblueL">목표 회수비</td>
                    <td class="tdwhiteL0"><%=targetCost%>&nbsp;</td>
                    <td class="tdblueL">회수비 실적</td>
                    <%if(CommonUtil.isAdmin() || isSalesRole) {%>
                    <td class="tdwhiteL0"><input type="text" class="txt_field" style="width: 30%" value="<%=realCost%>" name="realCost" id="realCost"/></td>
                    <%}else{ %>
                    <td class="tdwhiteL0"><%=realCost%>&nbsp;</td>
                    <%} %>
