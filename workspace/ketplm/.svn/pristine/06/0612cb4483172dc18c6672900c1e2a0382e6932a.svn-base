...
<title><%=messageService.getString("e3ps.message.ket_message", "00777") %><%--결재완료함--%></title>
...
function search(){
  ...
  form01.method="post";
  form01.action = "/plm/servlet/e3ps/WorkspaceServlet?cmd=searchCompletedAppr";
  form01.submit();
}
          ...
          <td><table style="width:780px; height:28px;" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td align="right">
                    ...
                    <img src="/plm/portal/images/icon_navi.gif"><%=messageService.getString("e3ps.message.ket_message", "00759") %><%--결재대기--%>
                </td>
              </tr>
            </table></td>
        </tr>
                        ...
                        <div class="row-fluid">
                            <div style="WIDTH:100%;HEIGHT:100%">
                                <bdo Debug="1" AlertError="0"
                                    Layout_Url="/plm/jsp/wfm/CompletedWorkListGridLayout.jsp"
                                    ...
                                    Export_Data="TGData"
                                    Export_Param_File="Completed_Work_List"
                                ></bdo>
                            </div>
                        </div>
                    </div>
