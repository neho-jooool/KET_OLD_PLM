create or replace
FUNCTION FN_GET_DEPENDENCY_MOLD_WBS(v_task_oid IN VARCHAR2, v_task_plan_start_date IN VARCHAR2, v_pjt_oid IN VARCHAR2)
/*******************************************************************************
*  [PLM System 1차개선] 자동차 금형 WBS Task의 선행 Task List를 가져옴
********************************************************************************
*  FUNCTION NAME
*      FN_GET_DEPENDENCY_MOLD_WBS
********************************************************************************
...
END FN_GET_DEPENDENCY_MOLD_WBS;