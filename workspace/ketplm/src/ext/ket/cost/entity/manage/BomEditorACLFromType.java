 ...
 *
 * <p>
 * Use the <code>newBomEditorACLFromType</code> static factory method(s),
 * not the <code>BomEditorACLFromType</code> constructor, to construct instances
...
@GenAsPersistable(
   ...
   @GeneratedProperty(name="typeId", type=String.class),
   @GeneratedProperty(name="necessary", type=boolean.class),
   @GeneratedProperty(name="disabled", type=boolean.class, initialValue="false")
   })
public class BomEditorACLFromType extends _BomEditorACLFromType {
    ...
    *
    * @return    BomEditorACLFromType
    * @exception wt.util.WTException
    **/
   public static BomEditorACLFromType newBomEditorACLFromType()
            throws WTException {

      BomEditorACLFromType instance = new BomEditorACLFromType();
      instance.initialize();
      return instance;
   }
