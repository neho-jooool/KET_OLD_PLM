 ...
 *
 * <p>
 * Use the <code>newCostCurrencyInfo</code> static factory method(s), not
 * the <code>CostCurrencyInfo</code> constructor, to construct instances
...
@GenAsPersistable(interfaces={OwnPersistable.class}, 
   ...
   @GeneratedProperty(name="subVersion", type=Integer.class, initialValue="0"),
   @GeneratedProperty(name="pjtNo", type=String.class),
   },
   foreignKeys={
   @GeneratedForeignKey(name="costCurrencyLink", myRoleIsRoleA=false,
    foreignKeyRole=@ForeignKeyRole(name="master", type=ext.ket.cost.entity.ProductMaster.class,
	constraints=@PropertyConstraints(required=true)),
		myRole=@MyRole(name="costCurrency", cardinality=Cardinality.ONE_TO_MANY))
	   })
public class CostCurrencyInfo extends _CostCurrencyInfo {
    ...
    *
    * @return    CostCurrencyInfo
    * @exception wt.util.WTException
    **/
   public static CostCurrencyInfo newCostCurrencyInfo()
            throws WTException {

      CostCurrencyInfo instance = new CostCurrencyInfo();
      instance.initialize();
      return instance;
   }
