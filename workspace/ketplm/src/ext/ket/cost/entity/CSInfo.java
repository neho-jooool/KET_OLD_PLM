 ...
 *
 * <p>
 * Use the <code>newCSInfo</code> static factory method(s), not the <code>CSInfo</code>
...
@GenAsPersistable(interfaces={OwnPersistable.class}, 
   ...
   properties={
   @GeneratedProperty(name="infoType", type=String.class),
   @GeneratedProperty(name="rMatCode", type=String.class),
   @GeneratedProperty(name="importance", type=String.class),
   @GeneratedProperty(name="scrapInternal", type=String.class),
   @GeneratedProperty(name="scrapChina", type=String.class),
   @GeneratedProperty(name="version", type=Integer.class, initialValue="0")
   })
public class CSInfo extends _CSInfo {
    ...
    **/
   public static CSInfo newCSInfo()
            throws WTException {

      CSInfo instance = new CSInfo();
      instance.initialize();
      return instance;
   }
