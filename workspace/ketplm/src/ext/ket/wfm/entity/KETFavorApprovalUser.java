...
/**
 * <p>
 * Use the <code>newKETFavorApprovalUser</code> static factory method(s), not the <code>KETFavorApprovalUser</code> constructor, to construct instances of this class. Instances
...
public class KETFavorApprovalUser extends _KETFavorApprovalUser {
     ...
     * 
     * @return KETFavorApprovalUser
     * @exception wt.util.WTException
     **/
    public static KETFavorApprovalUser newKETFavorApprovalUser() throws WTException {

	KETFavorApprovalUser instance = new KETFavorApprovalUser();
	instance.initialize();
	return instance;
    }
     ...
     * does not include the type of the object. <BR>
     * <BR>
     ...
     * other attribute of the object. <BR>
     * <BR>
     * <B>Supported API: </B>false
     * 
