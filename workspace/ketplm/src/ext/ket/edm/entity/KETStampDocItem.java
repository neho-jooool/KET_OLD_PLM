 ...
 *
 * <p>
 * Use the <code>newKETStampDocItem</code> static factory method(s), not
 * the <code>KETStampDocItem</code> constructor, to construct instances
...
@GenAsPersistable(interfaces={FormatContentHolder.class, AccessControlled.class}, 
   ...
   properties={
   @GeneratedProperty(name="stampStatus", type=String.class)
   })
public class KETStampDocItem extends _KETStampDocItem {
    ...
    *
    * @return    KETStampDocItem
    * @exception wt.util.WTException
    **/
   public static KETStampDocItem newKETStampDocItem()
            throws WTException {

      KETStampDocItem instance = new KETStampDocItem();
      instance.initialize();
      return instance;
   }
