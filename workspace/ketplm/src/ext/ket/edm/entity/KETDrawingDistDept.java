 ...
 * 
 * <p>
 * Use the <code>newKETDrawingDistDept</code> static factory method(s), not the <code>KETDrawingDistDept</code> constructor, to construct instances of this class. Instances must be constructed using
...
, foreignKeys = { 
	@GeneratedForeignKey(name = "KETDrawingDistDeptLink"
		, foreignKeyRole = @ForeignKeyRole(name = "distReq"
		, type = ext.ket.edm.entity.KETDrawingDistRequest.class
		, constraints = @PropertyConstraints(required = true))
	, myRole = @MyRole(name = "distDept")) 
	})
public class KETDrawingDistDept extends _KETDrawingDistDept {
     ...
     * 
     * @return KETDrawingDistDept
     * @exception wt.util.WTException
     **/
    public static KETDrawingDistDept newKETDrawingDistDept() throws WTException {

	KETDrawingDistDept instance = new KETDrawingDistDept();
	instance.initialize();
	return instance;
    }
