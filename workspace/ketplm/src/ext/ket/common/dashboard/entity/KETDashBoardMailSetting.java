 ...
 *
 * <p>
 * Use the <code>newKETDashBoardMailSetting</code> static factory method(s),
 * not the <code>KETDashBoardMailSetting</code> constructor, to construct
...
@GenAsPersistable(
   ...
   @GeneratedForeignKey(myRoleIsRoleA=false,
      foreignKeyRole=@ForeignKeyRole(name="man", type=e3ps.groupware.company.People.class),
      myRole=@MyRole(name="dash", cardinality=Cardinality.ONE))
   })
public class KETDashBoardMailSetting extends _KETDashBoardMailSetting {
    ...
    *
    * @return    KETDashBoardMailSetting
    * @exception wt.util.WTException
    **/
   public static KETDashBoardMailSetting newKETDashBoardMailSetting()
            throws WTException {

      KETDashBoardMailSetting instance = new KETDashBoardMailSetting();
      instance.initialize();
      return instance;
   }
