...
public class GateCheckSheetDTO extends BaseDTO {
    private String pjtOid = "";
    private String gateCheckSheetOid = "";
    ...
    public void setTaskSelect(String taskSelect) {
	this.taskSelect = taskSelect;
    }

    public String getGateCheckSheetOid() {
	return gateCheckSheetOid;
    }

    public void setGateCheckSheetOid(String gateCheckSheetOid) {
	this.gateCheckSheetOid = gateCheckSheetOid;
    }
