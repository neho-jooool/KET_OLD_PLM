...
public class MigPartSendToErpSample3 implements RemoteAccess, Serializable {
    ...
    public static MigPartSendToErpSample3 manager = new MigPartSendToErpSample3();

    public MigPartSendToErpSample3() {
	...
	try {
	    ...
	    Kogger.debug(MigPartSendToErpSample3.class, "@start");
	    MigPartSendToErpSample3.manager.saveFromExcel();
	    Kogger.debug(MigPartSendToErpSample3.class, "@end");

	} catch (Exception e) {
	    Kogger.debug(MigPartSendToErpSample3.class, e);
	}
    }
