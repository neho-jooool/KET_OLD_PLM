 ...
 *
 * <p>
 * Use the <code>newKETPartNaming</code> static factory method(s), not the
 * <code>KETPartNaming</code> constructor, to construct instances of this
...
@GenAsPersistable(
   ...
   properties={
   @GeneratedProperty(name="namingCode", type=String.class),
   @GeneratedProperty(name="namingName", type=String.class),
   @GeneratedProperty(name="lev1NumberCodeType", type=String.class),
   @GeneratedProperty(name="lev2NumberCodeType", type=String.class),
   @GeneratedProperty(name="lev3NumberCodeType", type=String.class),
   @GeneratedProperty(name="lev4NumberCodeType", type=String.class),
   @GeneratedProperty(name="lev5NumberCodeType", type=String.class),
   @GeneratedProperty(name="useNaming", type=boolean.class)
   })
public class KETPartNaming extends _KETPartNaming {
    ...
    *
    * @return    KETPartNaming
    * @exception wt.util.WTException
    **/
   public static KETPartNaming newKETPartNaming()
            throws WTException {

      KETPartNaming instance = new KETPartNaming();
      instance.initialize();
      return instance;
   }
