...
public class KETWfmHelper implements Externalizable {


   private static final String RESOURCE = "e3ps.wfm.service.serviceResource";
   private static final String CLASSNAME = KETWfmHelper.class.getName();

   /**
    * <BR><BR><B>Supported API: </B>true
    **/
   public static final KETWfmService service = wt.services.ServiceFactory.getService(KETWfmService.class);
