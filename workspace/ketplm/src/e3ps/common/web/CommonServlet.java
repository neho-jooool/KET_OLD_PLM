...
public abstract class CommonServlet extends HttpServlet {
     ...
     *            PrintWriter 얻기위해
     */
    protected void alertNgoParent(HttpServletResponse res, String msg, String url) {
	try {
	    res.setContentType("text/html;charset=UTF-8");
	    PrintWriter out = res.getWriter();
	    String rtn_msg = "";
     ...
     *            PrintWriter 얻기위해
     */
    protected void alertNgoNcloseParent2(HttpServletResponse res, String msg, String url) {
	try {
	    res.setContentType("text/html;charset=UTF-8");
	    PrintWriter out = res.getWriter();
	    String rtn_msg = "";
    ...
    /**
     * <pre>
     * javascript alert 메시지를 보여주고 자식창에서 부모창 리로드 하면서 창닫기 .
     * </pre>
     * 
     * @param msg
     *            alert으로 보여줄 메시지
     ...
     *            PrintWriter 얻기위해
     */
    protected void alertNparentReloadNclose(HttpServletResponse res, String msg) {
	try {
	    res.setContentType("text/html;charset=UTF-8");
	    PrintWriter out = res.getWriter();
	    res.setContentType("text/html;charset=UTF-8");
