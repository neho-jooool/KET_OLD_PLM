...
public class KETCommonHelper implements Externalizable {


   private static final String RESOURCE = "e3ps.common.service.serviceResource";
   private static final String CLASSNAME = KETCommonHelper.class.getName();

   /**
    * <BR><BR><B>Supported API: </B>true
    **/
   public static final KETCommonService service = wt.services.ServiceFactory.getService(KETCommonService.class);
