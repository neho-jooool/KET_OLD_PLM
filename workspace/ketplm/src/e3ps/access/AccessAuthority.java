 ...
 *
 * <p>
 * Use the <code>newAccessAuthority</code> static factory method(s), not
 * the <code>AccessAuthority</code> constructor, to construct instances
...
@GenAsPersistable(
   ...
   properties={
   @GeneratedProperty(name="accessName", type=String.class),
   @GeneratedProperty(name="objectID", type=long.class),
   @GeneratedProperty(name="objClassName", type=String.class),
   @GeneratedProperty(name="isVR", type=boolean.class)
   },
   tableProperties=@TableProperties(compositeIndex1="+objectID", compositeIndex2="+objClassName")
)
public class AccessAuthority extends _AccessAuthority {
    ...
    **/
   public static AccessAuthority newAccessAuthority()
            throws WTException {

      AccessAuthority instance = new AccessAuthority();
      instance.initialize();
      return instance;
   }
