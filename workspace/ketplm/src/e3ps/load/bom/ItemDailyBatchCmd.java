...
public class ItemDailyBatchCmd {
    ...
    public static void main(String[] args) throws SQLException, IOException
    {
        ...
        {
            // 사용법 설명
            Kogger.debug(ItemDailyBatchCmd.class, ">>> Usage  : windchill e3ps.load.bom.ItemDailyBatchCmd userID passwd");
            return;
        }
    	...
    	String strFileName = "ItemDailyBatchLog_" + currentDate + "_" + currentTime.replace(":", "") + ".log";
    	...
    	Kogger.debug(ItemDailyBatchCmd.class, "@@@@@@@@@ strFilePath : " + strDirPath + "\\" + strFileName);
    	...
    	try {
	    		...
	    		vec = ItemMasterInterface.getItemMasterInfo("");							// 변경된 전체 부품 조회

	            Kogger.debug(ItemDailyBatchCmd.class,  "@@@@@@@@@@  SAP Part Interface [ vec size ] : " + vec.size() + "@@@@@@@@@@\n" );
	            fw.write(":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::\n" );
	    		...
	    		for( int i = 0; i < vec.size(); i++ ){
    	        	...
    	        	Kogger.debug(ItemDailyBatchCmd.class, "@@@@@@@@@@ " + i + "  번째 부품 생성 : " + strArry[0] +"@@@@@@@@@@");
	    			...
	    			if (partOid != null && !partOid.equals("") && !partOid.equals("null")){
	    				Kogger.debug(ItemDailyBatchCmd.class, "@@@@@@@@@@ 저장 성공!");
	    	    		fw.write(":::::::::::::: 저장 완료 :: + "  + partOid + "\n");
	    	    		fw.flush();
	    				ItemMasterInterface.setItemMasterResultInfo(hash, true);
	    			}else{
	    				Kogger.debug(ItemDailyBatchCmd.class, "@@@@@@@@@@ 저장 실패!");
	    	    		fw.write(":::::::::::::: 저장 실패 \n");
	    	    		fw.flush();
	    				ItemMasterInterface.setItemMasterResultInfo(hash, false);
	    			}
    		...
    		Kogger.error(ItemDailyBatchCmd.class, e);
    	}finally{
