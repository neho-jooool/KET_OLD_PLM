...
public class WorkCompletECACmd {
	...
	public static void main(String[] args) {
        ...
        {
            // 사용법 설명
            Kogger.debug(WorkCompletECACmd.class, ">>> Usage  : java e3ps.load.bom.WorkCompletECACmd userID passwd flag(M/P) ida2a2 ");
            return;
        }
		...
		try
		{
			Kogger.debug(WorkCompletECACmd.class, "WorkComplete(ECA) Start=========");			
			...
			Kogger.debug(WorkCompletECACmd.class, "WorkComplete(ECA) End=========");
		}
		catch (Exception e)
		{
			Kogger.debug(WorkCompletECACmd.class, "Error : "+e);
		}
	}
}
