...
public class MigProjectDocument_TEMP3 implements RemoteAccess, Serializable {
    ...
    public static MigProjectDocument_TEMP3 manager = new MigProjectDocument_TEMP3();

    public MigProjectDocument_TEMP3() {
	...
	try {
	    ...
	    Kogger.debug(MigProjectDocument_TEMP3.class, "@start");
	    MigProjectDocument_TEMP3.manager.saveFromExcel(fileName);
	    Kogger.debug(MigProjectDocument_TEMP3.class, "@end");

	} catch (Exception e) {
	    Kogger.debug(MigProjectDocument_TEMP3.class, e);
	}
    }
