package e3ps.bom.command.drawingdetails;
...
public class DrawingDetailsCmd extends AbstractAIFCommand
{
	...
	public DrawingDetailsCmd(JFrame frame, AbstractAIFUIApplication app)
    {
        this.app = app;
        parent = frame;
	...
	public DrawingDetailsCmd(JFrame frame, AbstractAIFUIApplication app, SearchBOMPanel searchPnl)
    {
        this.app = app;
	...
	private void init() 
	{
        ...
        try 
		{
			...
			urlStr = BOMBasicInfoPool.getServerCodebase().trim() + "jsp/bom/ViewRelatedList.jsp?type=dwg&poid=" +  itemOid.trim();
