...
public class DownwardExplosionCmd extends AbstractAIFCommand
{
    private JFrame parent;
    AbstractAIFUIApplication app;
    BOMRegisterApplicationPanel bomPanel;

    public DownwardExplosionCmd(JFrame frame, AbstractAIFUIApplication app)
    {
        this.app = app;
        parent = null;
    }

    public DownwardExplosionCmd() { }
    ...
    protected void executeCommand() throws Exception
    {
        try
        {
            ...
            setRunnable(new SearchItemFrame(parent, app, KETMessageService.service.getString("e3ps.bom.bom_editor_message", "00317")/*정전개*/));
