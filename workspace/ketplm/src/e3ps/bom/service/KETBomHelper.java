...
import e3ps.bom.service.KETBomService;
...
public class KETBomHelper implements Externalizable {


   private static final String RESOURCE = "e3ps.bom.service.serviceResource";
   private static final String CLASSNAME = KETBomHelper.class.getName();

   /**
    * <BR><BR><B>Supported API: </B>true
    **/
   public static final KETBomService service = wt.services.ServiceFactory.getService(KETBomService.class);
