...
public class KETPartHelper implements Externalizable {


   private static final String RESOURCE = "e3ps.bom.service.serviceResource";
   private static final String CLASSNAME = KETPartHelper.class.getName();

   /**
    * <BR><BR><B>Supported API: </B>true
    **/
   public static final KETPartService service = wt.services.ServiceFactory.getService(KETPartService.class);
