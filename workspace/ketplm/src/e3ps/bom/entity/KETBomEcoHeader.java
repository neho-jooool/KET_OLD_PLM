 ...
 *
 * <p>
 * Use the <code>newKETBomEcoHeader</code> static factory method(s), not
 * the <code>KETBomEcoHeader</code> constructor, to construct instances
...
@GenAsPersistable(superClass=CabinetManaged.class, interfaces={WTContained.class}, 
   ...
   @GeneratedProperty(name="attribute10", type=String.class, supportedAPI=SupportedAPI.PUBLIC,
      constraints=@PropertyConstraints(upperLimit=2000)),
   @GeneratedProperty(name="ecoHeaderNumber", type=String.class),
   ...
   @GeneratedProperty(name="isMultiple", type=String.class),
   @GeneratedProperty(name="ecoItemCode", type=String.class)
   })
public class KETBomEcoHeader extends _KETBomEcoHeader {
    ...
    **/
   public static KETBomEcoHeader newKETBomEcoHeader()
            throws WTException {

      KETBomEcoHeader instance = new KETBomEcoHeader();
      instance.initialize();
      return instance;
   }
