...
public class BOMECOBasicInfoPool {
	...
	private static String userEMail = "jungheerang@aaa.com";
	...
	private static String bomParentItemCodes = "";
	...
	public static final int getOrgId()
	{
		return orgId;
	}
	...
	public static final String getBomParentItemCodes() {
		return bomParentItemCodes;
	}
	...
	public static final void setOrgId(int inx) {
		orgId = inx;
	}
	...
	public static final void setBomParentItemCodes(String s) {
		bomParentItemCodes= s;
	}
