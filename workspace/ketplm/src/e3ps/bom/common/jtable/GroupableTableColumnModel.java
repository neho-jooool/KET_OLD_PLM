...
/**
 * Class which extends the functionality of DefaultColumnTableModel to also
 * provide capabilities to group columns. This can be used for instance to aid
 * in the layout of groupable table headers.
 */
