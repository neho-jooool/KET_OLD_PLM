...
public class CreateBaselineAction extends AbstractAIFAction
{
    private AbstractAIFUIApplication app;

    public CreateBaselineAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public CreateBaselineAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
