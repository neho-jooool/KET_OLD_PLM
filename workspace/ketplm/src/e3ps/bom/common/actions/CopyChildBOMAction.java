...
public class CopyChildBOMAction extends AbstractAIFAction
{
    private AbstractAIFUIApplication app;

    public CopyChildBOMAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public CopyChildBOMAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
