...
public class BOMPropertyInsertAction extends AbstractAIFAction {

    private AbstractAIFUIApplication app;

    public BOMPropertyInsertAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public BOMPropertyInsertAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
