...
public class CheckOutAction extends AbstractAIFAction
{
    private AbstractAIFUIApplication app;

    public CheckOutAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public CheckOutAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
