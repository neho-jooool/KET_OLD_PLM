...
public class CheckInAction extends AbstractAIFAction
{
    private AbstractAIFUIApplication app;

    public CheckInAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public CheckInAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
