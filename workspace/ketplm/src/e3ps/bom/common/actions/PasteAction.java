...
public class PasteAction extends AbstractAIFAction
{
    private AbstractAIFUIApplication app;

    public PasteAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public PasteAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
