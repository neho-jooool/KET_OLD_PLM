...
public class SearchBaselineAction extends AbstractAIFAction
{
    private AbstractAIFUIApplication app;

    public SearchBaselineAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public SearchBaselineAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
