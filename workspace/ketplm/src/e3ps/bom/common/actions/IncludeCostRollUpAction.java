...
public class IncludeCostRollUpAction extends AbstractAIFAction
{
    private AbstractAIFUIApplication app;

    public IncludeCostRollUpAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public IncludeCostRollUpAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
