...
public class AbortEndworkingAction extends AbstractAIFAction
{
    private AbstractAIFUIApplication app;

    public AbortEndworkingAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public AbortEndworkingAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
