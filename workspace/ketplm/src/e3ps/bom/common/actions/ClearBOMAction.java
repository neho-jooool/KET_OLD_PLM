...
public class ClearBOMAction extends AbstractAIFAction
{
    ...
    public ClearBOMAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public ClearBOMAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
