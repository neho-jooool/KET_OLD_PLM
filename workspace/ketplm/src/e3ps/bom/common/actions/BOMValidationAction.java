...
public class BOMValidationAction extends AbstractAIFAction
{
    private AbstractAIFUIApplication app;

    public BOMValidationAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public BOMValidationAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
