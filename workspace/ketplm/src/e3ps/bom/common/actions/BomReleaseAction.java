...
public class BomReleaseAction extends AbstractAIFAction 
{
    private AbstractAIFUIApplication app;

    public BomReleaseAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public BomReleaseAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
