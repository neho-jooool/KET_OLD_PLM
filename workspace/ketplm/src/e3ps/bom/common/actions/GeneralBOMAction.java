...
public class GeneralBOMAction extends AbstractAIFAction
{
    private AbstractAIFUIApplication app;

    public GeneralBOMAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public GeneralBOMAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
