...
public class ExitBOMAction extends AbstractAIFAction
{
    private AbstractAIFUIApplication app;

    public ExitBOMAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public ExitBOMAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
