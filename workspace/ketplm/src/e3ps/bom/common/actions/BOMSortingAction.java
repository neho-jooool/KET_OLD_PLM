...
public class BOMSortingAction extends AbstractAIFAction
{
    private AbstractAIFUIApplication app;

    public BOMSortingAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public BOMSortingAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
