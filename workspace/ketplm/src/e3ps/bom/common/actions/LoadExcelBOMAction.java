...
public class LoadExcelBOMAction extends AbstractAIFAction
{
    private AbstractAIFUIApplication app;

    public LoadExcelBOMAction(AbstractAIFUIApplication abstractaifuiapplication, JFrame frame, String s)
    {
        super(abstractaifuiapplication, frame, s);
    }

    public LoadExcelBOMAction(AbstractAIFUIApplication abstractaifuiapplication, String s)
    {
