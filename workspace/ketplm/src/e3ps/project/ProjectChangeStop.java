 ...
 *
 * <p>
 * Use the <code>newProjectChangeStop</code> static factory method(s), not
 * the <code>ProjectChangeStop</code> constructor, to construct instances
...
@GenAsPersistable(interfaces={ContentHolder.class , OwnPersistable.class}, 
   ...
   properties={
   @GeneratedProperty(name="changeDetil", type=String.class,
      constraints=@PropertyConstraints(upperLimit=3000)),
   @GeneratedProperty(name="changeDate", type=Timestamp.class),
   @GeneratedProperty(name="changeType", type=String.class),
   @GeneratedProperty(name="changeAttr1", type=String.class),
   @GeneratedProperty(name="changeAttr2", type=String.class),
   ...
   @GeneratedProperty(name="webEditorText", type=Object.class,
      ...
      columnProperties=@ColumnProperties(columnType=ColumnType.BLOB)),
   @GeneratedProperty(name="changeStopType", type=String.class,
      javaDoc="변경사유구분")
   },
   foreignKeys={
   @GeneratedForeignKey(
      foreignKeyRole=@ForeignKeyRole(name="pcsMaster", type=e3ps.project.ProjectMaster.class,
         constraints=@PropertyConstraints(required=true)),
      myRole=@MyRole(name="pcs"))
   })
public class ProjectChangeStop extends _ProjectChangeStop {
    ...
    *
    * @return    ProjectChangeStop
    * @exception wt.util.WTException
    **/
   public static ProjectChangeStop newProjectChangeStop()
            throws WTException {

      ProjectChangeStop instance = new ProjectChangeStop();
      instance.initialize();
      return instance;
   }
