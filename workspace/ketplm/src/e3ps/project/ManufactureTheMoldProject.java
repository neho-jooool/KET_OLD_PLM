// Generated ManufactureTheMoldProject%4CB422510148: ? 11/22/10 10:35:58
/* bcwti
 *
...
//##begin ManufactureTheMoldProject%4CB422510148.doc preserve=no
/**
 * ???
 * <p>
 * Use the <code>newManufactureTheMoldProject</code> static factory method(s),
 * not the <code>ManufactureTheMoldProject</code> constructor, to construct
 ...
 * @version   1.0
 **/
//##end ManufactureTheMoldProject%4CB422510148.doc

public class ManufactureTheMoldProject extends ForeignKeyLink implements Externalizable {
   ...
   private static final String CLASSNAME = ManufactureTheMoldProject.class.getName();

   //##begin MANUFACTURE_ROLE%MANUFACTURE_ROLE.doc preserve=no
   /**
    * Label for the attribute.
    **/
   //##end MANUFACTURE_ROLE%MANUFACTURE_ROLE.doc
   public static final String MANUFACTURE_ROLE = "manufacture";
   ...
   protected static final long OLD_FORMAT_VERSION_UID = 4230876832971364229L;
   ...
   protected boolean readVersion( ManufactureTheMoldProject thisObject, ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone )
            throws IOException, ClassNotFoundException {
   ...
   //##begin getManufacture%4CB42252009Cg.doc preserve=no
   /**
    * Gets the object for the association that plays role: MANUFACTURE_ROLE.
    *
    * @return    NumberCode
    **/
   //##end getManufacture%4CB42252009Cg.doc

   public NumberCode getManufacture() {
      //##begin getManufacture%4CB42252009Cg.body preserve=no

      return (NumberCode)getRoleAObject();
      //##end getManufacture%4CB42252009Cg.body
   }

   //##begin setManufacture%4CB42252009Cs.doc preserve=no
   /**
    * Sets the object for the association that plays role: MANUFACTURE_ROLE.
    *
    * @param     manufacture
    * @exception wt.util.WTPropertyVetoException
    **/
   //##end setManufacture%4CB42252009Cs.doc

   public void setManufacture( NumberCode manufacture )
            throws WTPropertyVetoException {
      //##begin setManufacture%4CB42252009Cs.body preserve=no

      setRoleAObject( (NumberCode) manufacture );
      //##end setManufacture%4CB42252009Cs.body
   }

   //##begin getMoldProject%4CB4225200EAg.doc preserve=no
   /**
    * Gets the object for the association that plays role: MOLD_PROJECT_ROLE.
    *
    * @return    MoldProject
    **/
   //##end getMoldProject%4CB4225200EAg.doc

   public MoldProject getMoldProject() {
      //##begin getMoldProject%4CB4225200EAg.body preserve=no

      return (MoldProject)getRoleBObject();
      //##end getMoldProject%4CB4225200EAg.body
   }

   //##begin setMoldProject%4CB4225200EAs.doc preserve=no
   /**
    ...
    * @exception wt.util.WTPropertyVetoException
    **/
   //##end setMoldProject%4CB4225200EAs.doc

   public void setMoldProject( MoldProject theMoldProject )
            throws WTPropertyVetoException {
      //##begin setMoldProject%4CB4225200EAs.body preserve=no

      setRoleBObject( (MoldProject) theMoldProject );
      //##end setMoldProject%4CB4225200EAs.body
   }
   ...
   //##begin newManufactureTheMoldProject%newManufactureTheMoldProjectf.doc preserve=no
   /**
    * Default factory for the class.
    *
    * @param     manufacture
    * @param     theMoldProject
    * @return    ManufactureTheMoldProject
    * @exception wt.util.WTException
    **/
   //##end newManufactureTheMoldProject%newManufactureTheMoldProjectf.doc

   public static ManufactureTheMoldProject newManufactureTheMoldProject( NumberCode manufacture, MoldProject theMoldProject )
            throws WTException {
      //##begin newManufactureTheMoldProject%newManufactureTheMoldProjectf.body preserve=no

      ManufactureTheMoldProject instance = new ManufactureTheMoldProject();
      instance.initialize( manufacture, theMoldProject );
      return instance;
      //##end newManufactureTheMoldProject%newManufactureTheMoldProjectf.body
   }
