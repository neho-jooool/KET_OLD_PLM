 ...
 *
 * <p>
 * Use the <code>newReviewDevelop</code> static factory method(s), not the
 * <code>ReviewDevelop</code> constructor, to construct instances of this
...
@GenAsPersistable(interfaces={OwnPersistable.class}, 
   ...
   properties={
   @GeneratedProperty(name="pastDesc", type=String.class,
      constraints=@PropertyConstraints(upperLimit=6000)),
   @GeneratedProperty(name="improveDesc", type=String.class,
      constraints=@PropertyConstraints(upperLimit=6000)),
   @GeneratedProperty(name="reviewDesc", type=String.class,
      constraints=@PropertyConstraints(upperLimit=6000)),
   @GeneratedProperty(name="attr1", type=String.class,
      constraints=@PropertyConstraints(upperLimit=2000)),
   @GeneratedProperty(name="pastType", type=PastType.class,
      constraints=@PropertyConstraints(required=true)),
   @GeneratedProperty(name="developtype", type=DevelopType.class,
      constraints=@PropertyConstraints(required=true))
   },
   foreignKeys={
   @GeneratedForeignKey(name="ReviewDevelopProjectLink", myRoleIsRoleA=false,
      foreignKeyRole=@ForeignKeyRole(name="project", type=e3ps.project.ReviewProject.class),
      myRole=@MyRole(name="review", cardinality=Cardinality.ONE))
   })
public class ReviewDevelop extends _ReviewDevelop {
    ...
    *
    * @return    ReviewDevelop
    * @exception wt.util.WTException
    **/
   public static ReviewDevelop newReviewDevelop()
            throws WTException {

      ReviewDevelop instance = new ReviewDevelop();
      instance.initialize();
      return instance;
   }
