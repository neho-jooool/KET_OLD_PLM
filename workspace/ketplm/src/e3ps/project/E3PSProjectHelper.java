...
import e3ps.project.E3PSProjectService;
...
public class E3PSProjectHelper implements Externalizable {


   private static final String RESOURCE = "e3ps.project.projectResource";
   private static final String CLASSNAME = E3PSProjectHelper.class.getName();

   /**
    * <BR><BR><B>Supported API: </B>true
    **/
   public static final E3PSProjectService service = wt.services.ServiceFactory.getService(E3PSProjectService.class);
