 ...
 *
 * <p>
 * Use the <code>newTryChange</code> static factory method(s), not the <code>TryChange</code>
...
@GenAsPersistable(interfaces={OwnPersistable.class}, 
   ...
   foreignKeys={
   @GeneratedForeignKey(
      foreignKeyRole=@ForeignKeyRole(name="trySchdule", type=e3ps.project.trySchdule.TrySchdule.class,
         constraints=@PropertyConstraints(required=true)),
      myRole=@MyRole(name="tryChange"))
   })
public class TryChange extends _TryChange {
    ...
    **/
   public static TryChange newTryChange()
            throws WTException {

      TryChange instance = new TryChange();
      instance.initialize();
      return instance;
   }
