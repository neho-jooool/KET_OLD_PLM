// Generated CarTypeTheOEMPlan%4C75A88E0321: ? 08/26/10 08:38:48
/* bcwti
 *
...
//##begin CarTypeTheOEMPlan%4C75A88E0321.doc preserve=no
/**
 *
 * <p>
 * Use the <code>newCarTypeTheOEMPlan</code> static factory method(s), not
 * the <code>CarTypeTheOEMPlan</code> constructor, to construct instances
 ...
 * @version   1.0
 **/
//##end CarTypeTheOEMPlan%4C75A88E0321.doc

public class CarTypeTheOEMPlan extends ForeignKeyLink implements Externalizable {
   ...
   private static final String CLASSNAME = CarTypeTheOEMPlan.class.getName();

   //##begin CAR_TYPE_ROLE%CAR_TYPE_ROLE.doc preserve=no
   /**
    * Label for the attribute.
    **/
   //##end CAR_TYPE_ROLE%CAR_TYPE_ROLE.doc
   public static final String CAR_TYPE_ROLE = "carType";
   ...
   protected static final long OLD_FORMAT_VERSION_UID = 2353664640093882279L;
   ...
   protected boolean readVersion( CarTypeTheOEMPlan thisObject, ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone )
            throws IOException, ClassNotFoundException {
   ...
   //##begin getCarType%4C75A88F01B9g.doc preserve=no
   /**
    * Gets the object for the association that plays role: CAR_TYPE_ROLE.
    *
    * @return    OEMProjectType
    **/
   //##end getCarType%4C75A88F01B9g.doc

   public OEMProjectType getCarType() {
      //##begin getCarType%4C75A88F01B9g.body preserve=no

      return (OEMProjectType)getRoleAObject();
      //##end getCarType%4C75A88F01B9g.body
   }

   //##begin setCarType%4C75A88F01B9s.doc preserve=no
   /**
    * Sets the object for the association that plays role: CAR_TYPE_ROLE.
    *
    * @param     carType
    * @exception wt.util.WTPropertyVetoException
    **/
   //##end setCarType%4C75A88F01B9s.doc

   public void setCarType( OEMProjectType carType )
            throws WTPropertyVetoException {
      //##begin setCarType%4C75A88F01B9s.body preserve=no

      setRoleAObject( (OEMProjectType) carType );
      //##end setCarType%4C75A88F01B9s.body
   }

   //##begin getOEMPlan%4C75A88F01C8g.doc preserve=no
   /**
    * Gets the object for the association that plays role: OEMPLAN_ROLE.
    *
    * @return    OEMPlan
    **/
   //##end getOEMPlan%4C75A88F01C8g.doc

   public OEMPlan getOEMPlan() {
      //##begin getOEMPlan%4C75A88F01C8g.body preserve=no

      return (OEMPlan)getRoleBObject();
      //##end getOEMPlan%4C75A88F01C8g.body
   }

   //##begin setOEMPlan%4C75A88F01C8s.doc preserve=no
   /**
    ...
    * @exception wt.util.WTPropertyVetoException
    **/
   //##end setOEMPlan%4C75A88F01C8s.doc

   public void setOEMPlan( OEMPlan theOEMPlan )
            throws WTPropertyVetoException {
      //##begin setOEMPlan%4C75A88F01C8s.body preserve=no

      setRoleBObject( (OEMPlan) theOEMPlan );
      //##end setOEMPlan%4C75A88F01C8s.body
   }
   ...
   //##begin newCarTypeTheOEMPlan%newCarTypeTheOEMPlanf.doc preserve=no
   /**
    * Default factory for the class.
    *
    * @param     carType
    * @param     theOEMPlan
    * @return    CarTypeTheOEMPlan
    * @exception wt.util.WTException
    **/
   //##end newCarTypeTheOEMPlan%newCarTypeTheOEMPlanf.doc

   public static CarTypeTheOEMPlan newCarTypeTheOEMPlan( OEMProjectType carType, OEMPlan theOEMPlan )
            throws WTException {
      //##begin newCarTypeTheOEMPlan%newCarTypeTheOEMPlanf.body preserve=no

      CarTypeTheOEMPlan instance = new CarTypeTheOEMPlan();
      instance.initialize( carType, theOEMPlan );
      return instance;
      //##end newCarTypeTheOEMPlan%newCarTypeTheOEMPlanf.body
   }
