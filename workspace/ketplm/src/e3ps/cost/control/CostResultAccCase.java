...
public class CostResultAccCase extends CostResultAcc {
    Connection conn = null;
    public void resultAccCase(String p_pk_cr_group,String rev_no,String p_group_case_count,String p_table_row) throws Exception{
        table_row 		 = p_table_row;
        group_case_count = p_group_case_count;
        table_row = Integer.toString(Integer.parseInt(table_row) * Integer.parseInt(group_case_count));
        ...
        sb.append("     and b.rev_no      = '" + rev_no + "'");
        sb.append("     and a.fk_pid      =  b.pk_pid                                 ");
        sb.append("     and substr(b.data_type,0,4)   = 'case'                                    ");
        sb.append("order by data_type,group_no                                             ");
        ...
        int table_count = Integer.parseInt(table_row) / Integer.parseInt(group_case_count);
        ...
        for(int j=0; j<table_count; j++){
            ...
            sb.append(" select case_count_1 ");
            sb.append("   from cost_request a, cost_productinfo b                                             ");
            sb.append("  where b.pk_cr_group = '" + p_pk_cr_group + "'");
            sb.append("    and b.rev_no      = '" + rev_no + "'");
            sb.append("    and a.fk_pid      =  b.pk_pid                                                      ");
            sb.append("    and b.group_no    = 'T" + k + "'");
            sb.append("    and b.data_type   = 'case0'                                                         ");
        ...
        if(p_group_case_count.equals("2")){
            k = "0";
            i = 1;
            ...
            for(int j=0; j<table_count; j++){
                ...
                sb.append("    and a.fk_pid      =  b.pk_pid                                                      ");
                sb.append("    and b.group_no    = 'T" + k + "'");
                sb.append("    and b.data_type   = 'case1'                                                         ");
        ...
        for(int t=0; t<open_count; t++ ){
            if(t == 0){
                ...
                if(p < Integer.parseInt(StringUtil.checkNullZero(case_count_1[j]))){
                    j = j;
                ...
                }else if(p == Integer.parseInt(StringUtil.checkNullZero(case_count_1[j]))){
                    if(Integer.parseInt(imsi_case_count_2[t]) > 0){
                        j = j;
                        if(q < Integer.parseInt(imsi_case_count_2[t])){
                            p = p;
            ...
            sb.append(" select pk_cr,       group_no,     case_count_2, case_type_user,  part_type,  ");
            sb.append("        data_type,   car_type,     su_year_1,    su_year_2,       su_year_3,  ");
            sb.append("        su_year_4,   su_year_5,    su_year_6,    su_year_7,       su_year_8,  ");
            sb.append("        customer_F,  customer_L,   royalty,      start_pro,       store,      ");
            sb.append("        dest,        client_cost,  ket_cost,     target_cost,      re_m_cost,  ");
            sb.append("        part_name,     part_no,         part_type,     pro_type,     make,	        ");
            sb.append("        mix_group,     usage,           meterial,      t_size,       w_size,	        ");
            sb.append("        p_size,        plating,         m_maker,       m_mone,       unitcost,       ");
            sb.append("        unitcost_txt,  grade_name,      grade_color,   order_con,    h_weight,	    ");
            sb.append("        h_scrap,       t_weight,        recycle,       die_no,       cavity,	        ");
            sb.append("        make_type,     pro_1,           ton,           spm,          method_type,    ");
            sb.append("        pro_level,     pro_level_txt,   plating_type,  plating_cost, type_1,	        ");
            sb.append("        type_2,        t_mone,          type_cost,     t_order,      pack_type,	    ");
            sb.append("        in_pack,       out_pack,        dis_cost,      yazaki_ro,    yzk_mone,	    ");
            sb.append("        m_su,          mold_cost,       mold_c_type,   line_su,      sul_cost,	    ");
            sb.append("        etc_cost,      part_note                                                     ");
            sb.append("   from cost_request a,cost_productinfo b                                                           ");
            sb.append("  where a.fk_pid =  b.pk_pid                                                                        ");
            sb.append("    and a.pk_cr = '" + list_pk_[t] + "'");
            System.out.println("list_pk_[t] : "+list_pk_[t] );
            ...
            try{
                ...
                while(rs.next()){
                    ...
                    p_group_case_count		= StringUtil.checkNull( Integer.toString(rs.getInt("case_type_user")));
                    data_type_[j]		    = StringUtil.checkNull(rs.getString("data_type"));
                    car_type_[j]		    = StringUtil.checkNull(rs.getString("car_type"));
                    a_su_year_1[j]         	= StringUtil.checkNullZero(rs.getString("su_year_1"));
                    a_su_year_2[j]    		= StringUtil.checkNullZero(rs.getString("su_year_2"));
                    a_su_year_3[j]			= StringUtil.checkNullZero(rs.getString("su_year_3"));
                    a_su_year_4[j]			= StringUtil.checkNullZero(rs.getString("su_year_4"));
                    a_su_year_5[j]       	= StringUtil.checkNullZero(rs.getString("su_year_5"));
                    a_su_year_6[j] 			= StringUtil.checkNullZero(rs.getString("su_year_6"));
                    a_su_year_7[j]			= StringUtil.checkNullZero(rs.getString("su_year_7"));
                    a_su_year_8[j]			= StringUtil.checkNullZero(rs.getString("su_year_8"));
            ...
            for(int e=0; e<=Integer.parseInt(StringUtil.checkNullZero(case_count_1[kk])); e++){
                for(int t=0; t<=Integer.parseInt(case_count_2[kk][e]); t++){
                    ...
                    if(StringUtil.checkNull(pro_type[kk][e][t]).equals("assy")){								//조립
                        ...
                        plus  = new BigDecimal(StringUtil.checkNullZero(assy_g_depr_cost[kk]));
                        ...
                        plus  = new BigDecimal(StringUtil.checkNullZero(sub_g_depr_cost[e]));
                        minus = new BigDecimal(StringUtil.Roundformat(g_depr_cost[kk][e][t],4));
                    ...
                    if(IsNew){
                        try{
                            ...
                            pstmt = conn.prepareStatement(sb.toString());
                            pstmt.setString(1, usd_rate                        );
                            pstmt.setString(2, yen_rate                        );
                            ...
                            pstmt.setString(66, "case"                          );
                            pstmt.setString(67, data_type_[kk]	                          );
                        ...
                        try{
                            ...
                            sb.append("      ,case_type_admin      = 'case' ");
                            sb.append("      ,case_type_user        = '" + data_type_[kk]	 +"'");
