 ...
 *
 * <p>
 * Use the <code>newKETEarlyWarningPlan</code> static factory method(s),
 * not the <code>KETEarlyWarningPlan</code> constructor, to construct instances
...
@GenAsPersistable(superClass=WTDocument.class, 
   ...
   properties={
   @GeneratedProperty(name="cftMember", type=String.class,
      javaDoc="조직도",
      constraints=@PropertyConstraints(upperLimit=4000)),
   @GeneratedProperty(name="manageDesc", type=String.class,
      javaDoc="중점관리 사항",
      constraints=@PropertyConstraints(upperLimit=4000)),
...
public class KETEarlyWarningPlan extends _KETEarlyWarningPlan {
    ...
    **/
   public static KETEarlyWarningPlan newKETEarlyWarningPlan()
            throws WTException {

      KETEarlyWarningPlan instance = new KETEarlyWarningPlan();
      instance.initialize();
      return instance;
   }
