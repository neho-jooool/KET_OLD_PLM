 ...
 *
 * <p>
 * Use the <code>newKETMoldStdPartLine</code> static factory method(s),
 * not the <code>KETMoldStdPartLine</code> constructor, to construct instances
...
@GenAsPersistable(
   ...
   properties={
   @GeneratedProperty(name="partOid", type=String.class),
   @GeneratedProperty(name="partNo", type=String.class),
   @GeneratedProperty(name="changeType", type=String.class),
   @GeneratedProperty(name="moldEcoOid", type=String.class),
   ...
   foreignKeys={
   @GeneratedForeignKey(name="KETMoldStdPartLink", myRoleIsRoleA=false,
      foreignKeyRole=@ForeignKeyRole(name="doc", type=e3ps.ecm.entity.KETMoldECADocLink.class),
      myRole=@MyRole(name="part"))
   })
public class KETMoldStdPartLine extends _KETMoldStdPartLine {
    ...
    *
    * @return    KETMoldStdPartLine
    * @exception wt.util.WTException
    **/
   public static KETMoldStdPartLine newKETMoldStdPartLine()
            throws WTException {

      KETMoldStdPartLine instance = new KETMoldStdPartLine();
      instance.initialize();
      return instance;
   }
