...
import e3ps.ecm.service.KETEcmService;
...
public class KETEcmHelper implements Externalizable {


   private static final String RESOURCE = "e3ps.ecm.service.serviceResource";
   private static final String CLASSNAME = KETEcmHelper.class.getName();

   /**
    * <BR><BR><B>Supported API: </B>true
    **/
   public static final KETEcmService service = wt.services.ServiceFactory.getService(KETEcmService.class);
