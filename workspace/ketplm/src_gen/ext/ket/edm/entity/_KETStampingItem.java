...
public abstract class _KETStampingItem implements wt.content.FormatContentHolder, wt.access.AccessControlled, java.io.Externalizable {
   static final long serialVersionUID = 1;

   static final java.lang.String RESOURCE = "ext.ket.edm.entity.entityResource";
   static final java.lang.String CLASSNAME = KETStampingItem.class.getName();

   /**
    * @see ext.ket.edm.entity.KETStampingItem
    */
   ...
   public void readExternal(java.io.ObjectInput input) throws java.io.IOException, java.lang.ClassNotFoundException {
      ...
      readVersion( (ext.ket.edm.entity.KETStampingItem) this, input, readSerialVersionUID, false, false );
   }
   ...
   protected boolean readVersion( KETStampingItem thisObject, java.io.ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone ) throws java.io.IOException, java.lang.ClassNotFoundException {
