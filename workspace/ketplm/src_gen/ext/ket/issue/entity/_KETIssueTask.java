...
public abstract class _KETIssueTask extends wt.enterprise.Managed implements wt.content.ContentHolder, java.io.Externalizable {
   static final long serialVersionUID = 1;

   static final java.lang.String RESOURCE = "ext.ket.issue.entity.entityResource";
   static final java.lang.String CLASSNAME = KETIssueTask.class.getName();

   /**
    * 요청항목
    *
    * @see ext.ket.issue.entity.KETIssueTask
    */
    ...
    * @see ext.ket.issue.entity.KETIssueTask
    */
   public static final java.lang.String RE_START_REASON = "reStartReason";
   static int RE_START_REASON_UPPER_LIMIT = -1;
    ...
    * @see ext.ket.issue.entity.KETIssueTask
    */
   public java.lang.String getReStartReason() {
    ...
    * @see ext.ket.issue.entity.KETIssueTask
    */
   public void setReStartReason(java.lang.String reStartReason) throws wt.util.WTPropertyVetoException {
      reStartReasonValidate(reStartReason);
      this.reStartReason = reStartReason;
   }
   void reStartReasonValidate(java.lang.String reStartReason) throws wt.util.WTPropertyVetoException {
      if (RE_START_REASON_UPPER_LIMIT < 1) {
         try { RE_START_REASON_UPPER_LIMIT = (java.lang.Integer) wt.introspection.WTIntrospector.getClassInfo(CLASSNAME).getPropertyDescriptor("reStartReason").getValue(wt.introspection.WTIntrospector.UPPER_LIMIT); }
         catch (wt.introspection.WTIntrospectionException e) { RE_START_REASON_UPPER_LIMIT = 200; }
      }
      if (reStartReason != null && !wt.fc.PersistenceHelper.checkStoredLength(reStartReason.toString(), RE_START_REASON_UPPER_LIMIT, true))
         throw new wt.util.WTPropertyVetoException("wt.introspection.introspectionResource", wt.introspection.introspectionResource.UPPER_LIMIT,
               new java.lang.Object[] { new wt.introspection.PropertyDisplayName(CLASSNAME, "reStartReason"), java.lang.String.valueOf(java.lang.Math.min(RE_START_REASON_UPPER_LIMIT, wt.fc.PersistenceHelper.DB_MAX_SQL_STRING_SIZE/wt.fc.PersistenceHelper.DB_MAX_BYTES_PER_CHAR)) },
               new java.beans.PropertyChangeEvent(this, "reStartReason", this.reStartReason, reStartReason));
   }
    ...
    * @see ext.ket.issue.entity.KETIssueTask
    */
   public static final java.lang.String ISSUE_MASTER = "issueMaster";
   /**
    * @see ext.ket.issue.entity.KETIssueTask
    */
   public static final java.lang.String ISSUE_MASTER_REFERENCE = "issueMasterReference";
   ...
   void issueMasterReferenceValidate(wt.fc.ObjectReference the_issueMasterReference) throws wt.util.WTPropertyVetoException {
      if (the_issueMasterReference == null || the_issueMasterReference.getReferencedClass() == null)
         throw new wt.util.WTPropertyVetoException("wt.introspection.introspectionResource", wt.introspection.introspectionResource.REQUIRED_ATTRIBUTE,
               new java.lang.Object[] { new wt.introspection.PropertyDisplayName(CLASSNAME, "issueMasterReference") },
   ...
   public static final long EXTERNALIZATION_VERSION_UID = 4247313892041692003L;
   ...
   public void writeExternal(java.io.ObjectOutput output) throws java.io.IOException {
      ...
      output.writeObject( reStartReason );
   ...
   protected void super_writeExternal_KETIssueTask(java.io.ObjectOutput output) throws java.io.IOException {
      super.writeExternal(output);
   }

   public void readExternal(java.io.ObjectInput input) throws java.io.IOException, java.lang.ClassNotFoundException {
      long readSerialVersionUID = input.readLong();
      readVersion( (ext.ket.issue.entity.KETIssueTask) this, input, readSerialVersionUID, false, false );
   }
   protected void super_readExternal_KETIssueTask(java.io.ObjectInput input) throws java.io.IOException, java.lang.ClassNotFoundException {
   ...
   public void writeExternal(wt.pds.PersistentStoreIfc output) throws java.sql.SQLException, wt.pom.DatastoreException {
      ...
      output.setString( "reStartReason", reStartReason );
   ...
   public void readExternal(wt.pds.PersistentRetrieveIfc input) throws java.sql.SQLException, wt.pom.DatastoreException {
      ...
      reStartReason = input.getString( "reStartReason" );
   ...
   boolean readVersion4247313892041692003L( java.io.ObjectInput input, long readSerialVersionUID, boolean superDone ) throws java.io.IOException, java.lang.ClassNotFoundException {
      if ( !superDone )
         super.readExternal( input );
      ...
      reStartReason = (java.lang.String) input.readObject();
   ...
   protected boolean readVersion( KETIssueTask thisObject, java.io.ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone ) throws java.io.IOException, java.lang.ClassNotFoundException {
      boolean success = true;

      if ( readSerialVersionUID == EXTERNALIZATION_VERSION_UID )
         return readVersion4247313892041692003L( input, readSerialVersionUID, superDone );
      else
   ...
   protected boolean super_readVersion_KETIssueTask( _KETIssueTask thisObject, java.io.ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone ) throws java.io.IOException, java.lang.ClassNotFoundException {
