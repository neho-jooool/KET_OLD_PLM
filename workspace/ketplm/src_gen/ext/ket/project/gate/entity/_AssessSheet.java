...
public abstract class _AssessSheet extends wt.doc.WTDocument implements java.io.Externalizable {
   static final long serialVersionUID = 1;

   static final java.lang.String RESOURCE = "ext.ket.project.gate.entity.entityResource";
   static final java.lang.String CLASSNAME = AssessSheet.class.getName();

   /**
    * Check Sheet Name
    *
    * @see ext.ket.project.gate.entity.AssessSheet
    */
   ...
   public static final long EXTERNALIZATION_VERSION_UID = -8450535689918866245L;
   ...
   protected void super_writeExternal_AssessSheet(java.io.ObjectOutput output) throws java.io.IOException {
      super.writeExternal(output);
   }

   public void readExternal(java.io.ObjectInput input) throws java.io.IOException, java.lang.ClassNotFoundException {
      long readSerialVersionUID = input.readLong();
      readVersion( (ext.ket.project.gate.entity.AssessSheet) this, input, readSerialVersionUID, false, false );
   }
   protected void super_readExternal_AssessSheet(java.io.ObjectInput input) throws java.io.IOException, java.lang.ClassNotFoundException {
   ...
   boolean readVersion_8450535689918866245L( java.io.ObjectInput input, long readSerialVersionUID, boolean superDone ) throws java.io.IOException, java.lang.ClassNotFoundException {
      if ( !superDone )
         super.readExternal( input );
   ...
   protected boolean readVersion( AssessSheet thisObject, java.io.ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone ) throws java.io.IOException, java.lang.ClassNotFoundException {
      boolean success = true;

      if ( readSerialVersionUID == EXTERNALIZATION_VERSION_UID )
         return readVersion_8450535689918866245L( input, readSerialVersionUID, superDone );
      else
   ...
   protected boolean super_readVersion_AssessSheet( _AssessSheet thisObject, java.io.ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone ) throws java.io.IOException, java.lang.ClassNotFoundException {
