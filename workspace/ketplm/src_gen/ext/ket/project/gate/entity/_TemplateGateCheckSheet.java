...
public abstract class _TemplateGateCheckSheet extends wt.fc.WTObject implements java.io.Externalizable {
   static final long serialVersionUID = 1;

   static final java.lang.String RESOURCE = "ext.ket.project.gate.entity.entityResource";
   static final java.lang.String CLASSNAME = TemplateGateCheckSheet.class.getName();

   /**
    * 체크시트명칭
    *
    * @see ext.ket.project.gate.entity.TemplateGateCheckSheet
    */
   ...
   protected void super_writeExternal_TemplateGateCheckSheet(java.io.ObjectOutput output) throws java.io.IOException {
      super.writeExternal(output);
   }

   public void readExternal(java.io.ObjectInput input) throws java.io.IOException, java.lang.ClassNotFoundException {
      long readSerialVersionUID = input.readLong();
      readVersion( (ext.ket.project.gate.entity.TemplateGateCheckSheet) this, input, readSerialVersionUID, false, false );
   }
   protected void super_readExternal_TemplateGateCheckSheet(java.io.ObjectInput input) throws java.io.IOException, java.lang.ClassNotFoundException {
   ...
   protected boolean readVersion( TemplateGateCheckSheet thisObject, java.io.ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone ) throws java.io.IOException, java.lang.ClassNotFoundException {
   ...
   protected boolean super_readVersion_TemplateGateCheckSheet( _TemplateGateCheckSheet thisObject, java.io.ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone ) throws java.io.IOException, java.lang.ClassNotFoundException {
