...
public abstract class _CADCategory extends wt.fc.EnumeratedType {
   static final long serialVersionUID = 1;

   static final java.lang.String RESOURCE = "e3ps.edm.edmResource";
   static final java.lang.String CLASSNAME = new CADCategory().getClass().getName();

   static final java.lang.String CLASS_RESOURCE = "e3ps.edm.CADCategoryRB";
   ...
   static wt.fc.EnumeratedType[] _valueSet() {
      if (valueSet == null) synchronized (_CADCategory.class) {
   ...
   public static CADCategory newCADCategory(int secretHandshake) throws java.lang.IllegalAccessException {
      validateFriendship(secretHandshake);
      return new CADCategory();
   }

   public static CADCategory toCADCategory(java.lang.String internal_value) throws wt.util.WTInvalidParameterException {
      return (CADCategory) toEnumeratedType(internal_value, _valueSet());
   }

   public static CADCategory getCADCategoryDefault() {
      return (CADCategory) defaultEnumeratedType(_valueSet());
   }

   public static CADCategory[] getCADCategorySet() {
      CADCategory[] set = new CADCategory[_valueSet().length];
      java.lang.System.arraycopy(valueSet, 0, set, 0, valueSet.length);
      return set;
   }

   public wt.fc.EnumeratedType[] getValueSet() {
      return getCADCategorySet();
   }
   ...
   static wt.fc.EnumeratedType[] initializeLocaleSet(java.util.Locale locale) throws java.lang.Throwable {
      return instantiateSet(CADCategory.class.getMethod( "newCADCategory", new java.lang.Class<?>[] { java.lang.Integer.TYPE }), CLASS_RESOURCE, locale);
   }
}
