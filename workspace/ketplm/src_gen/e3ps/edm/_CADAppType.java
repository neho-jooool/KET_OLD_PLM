...
public abstract class _CADAppType extends wt.fc.EnumeratedType {
   static final long serialVersionUID = 1;

   static final java.lang.String RESOURCE = "e3ps.edm.edmResource";
   static final java.lang.String CLASSNAME = new CADAppType().getClass().getName();

   static final java.lang.String CLASS_RESOURCE = "e3ps.edm.CADAppTypeRB";
   ...
   static wt.fc.EnumeratedType[] _valueSet() {
      if (valueSet == null) synchronized (_CADAppType.class) {
   ...
   public static CADAppType newCADAppType(int secretHandshake) throws java.lang.IllegalAccessException {
      validateFriendship(secretHandshake);
      return new CADAppType();
   }

   public static CADAppType toCADAppType(java.lang.String internal_value) throws wt.util.WTInvalidParameterException {
      return (CADAppType) toEnumeratedType(internal_value, _valueSet());
   }

   public static CADAppType getCADAppTypeDefault() {
      return (CADAppType) defaultEnumeratedType(_valueSet());
   }

   public static CADAppType[] getCADAppTypeSet() {
      CADAppType[] set = new CADAppType[_valueSet().length];
      java.lang.System.arraycopy(valueSet, 0, set, 0, valueSet.length);
      return set;
   }

   public wt.fc.EnumeratedType[] getValueSet() {
      return getCADAppTypeSet();
   }
   ...
   static wt.fc.EnumeratedType[] initializeLocaleSet(java.util.Locale locale) throws java.lang.Throwable {
      return instantiateSet(CADAppType.class.getMethod( "newCADAppType", new java.lang.Class<?>[] { java.lang.Integer.TYPE }), CLASS_RESOURCE, locale);
   }
}
