...
public abstract class _NumberCodeType extends wt.fc.EnumeratedType {
   static final long serialVersionUID = 1;

   static final java.lang.String RESOURCE = "e3ps.common.code.codeResource";
   static final java.lang.String CLASSNAME = new NumberCodeType().getClass().getName();

   static final java.lang.String CLASS_RESOURCE = "e3ps.common.code.NumberCodeTypeRB";
   ...
   static wt.fc.EnumeratedType[] _valueSet() {
      if (valueSet == null) synchronized (_NumberCodeType.class) {
   ...
   public static NumberCodeType newNumberCodeType(int secretHandshake) throws java.lang.IllegalAccessException {
      validateFriendship(secretHandshake);
      return new NumberCodeType();
   }

   public static NumberCodeType toNumberCodeType(java.lang.String internal_value) throws wt.util.WTInvalidParameterException {
      return (NumberCodeType) toEnumeratedType(internal_value, _valueSet());
   }

   public static NumberCodeType getNumberCodeTypeDefault() {
      return (NumberCodeType) defaultEnumeratedType(_valueSet());
   }

   public static NumberCodeType[] getNumberCodeTypeSet() {
      NumberCodeType[] set = new NumberCodeType[_valueSet().length];
      java.lang.System.arraycopy(valueSet, 0, set, 0, valueSet.length);
      return set;
   }

   public wt.fc.EnumeratedType[] getValueSet() {
      return getNumberCodeTypeSet();
   }
   ...
   static wt.fc.EnumeratedType[] initializeLocaleSet(java.util.Locale locale) throws java.lang.Throwable {
      return instantiateSet(NumberCodeType.class.getMethod( "newNumberCodeType", new java.lang.Class<?>[] { java.lang.Integer.TYPE }), CLASS_RESOURCE, locale);
   }
}
