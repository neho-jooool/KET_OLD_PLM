...
public abstract class _KETProdECABomLink extends wt.fc.ObjectToObjectLink implements java.io.Externalizable {
   static final long serialVersionUID = 1;

   static final java.lang.String RESOURCE = "e3ps.ecm.entity.entityResource";
   static final java.lang.String CLASSNAME = KETProdECABomLink.class.getName();

   /**
    * @see e3ps.ecm.entity.KETProdECABomLink
    */
   public static final java.lang.String MASS_CHANGE_YN = "massChangeYn";
   static int MASS_CHANGE_YN_UPPER_LIMIT = -1;
   java.lang.String massChangeYn;
   /**
    * @see e3ps.ecm.entity.KETProdECABomLink
    */
   public java.lang.String getMassChangeYn() {
      return massChangeYn;
   }
   /**
    * @see e3ps.ecm.entity.KETProdECABomLink
    */
   public void setMassChangeYn(java.lang.String massChangeYn) throws wt.util.WTPropertyVetoException {
      massChangeYnValidate(massChangeYn);
      this.massChangeYn = massChangeYn;
   }
   void massChangeYnValidate(java.lang.String massChangeYn) throws wt.util.WTPropertyVetoException {
      if (MASS_CHANGE_YN_UPPER_LIMIT < 1) {
         try { MASS_CHANGE_YN_UPPER_LIMIT = (java.lang.Integer) wt.introspection.WTIntrospector.getClassInfo(CLASSNAME).getPropertyDescriptor("massChangeYn").getValue(wt.introspection.WTIntrospector.UPPER_LIMIT); }
         catch (wt.introspection.WTIntrospectionException e) { MASS_CHANGE_YN_UPPER_LIMIT = 200; }
      }
      if (massChangeYn != null && !wt.fc.PersistenceHelper.checkStoredLength(massChangeYn.toString(), MASS_CHANGE_YN_UPPER_LIMIT, true))
         throw new wt.util.WTPropertyVetoException("wt.introspection.introspectionResource", wt.introspection.introspectionResource.UPPER_LIMIT,
               new java.lang.Object[] { new wt.introspection.PropertyDisplayName(CLASSNAME, "massChangeYn"), java.lang.String.valueOf(java.lang.Math.min(MASS_CHANGE_YN_UPPER_LIMIT, wt.fc.PersistenceHelper.DB_MAX_SQL_STRING_SIZE/wt.fc.PersistenceHelper.DB_MAX_BYTES_PER_CHAR)) },
               new java.beans.PropertyChangeEvent(this, "massChangeYn", this.massChangeYn, massChangeYn));
   }
    ...
    * @see e3ps.ecm.entity.KETProdECABomLink
    */
   public static final java.lang.String RELATED_PARENT_PART_LIST = "relatedParentPartList";
   static int RELATED_PARENT_PART_LIST_UPPER_LIMIT = -1;
   java.lang.String relatedParentPartList;
   /**
    * @see e3ps.ecm.entity.KETProdECABomLink
    */
   public java.lang.String getRelatedParentPartList() {
      return relatedParentPartList;
   }
   /**
    * @see e3ps.ecm.entity.KETProdECABomLink
    */
   public void setRelatedParentPartList(java.lang.String relatedParentPartList) throws wt.util.WTPropertyVetoException {
      relatedParentPartListValidate(relatedParentPartList);
      this.relatedParentPartList = relatedParentPartList;
   }
   void relatedParentPartListValidate(java.lang.String relatedParentPartList) throws wt.util.WTPropertyVetoException {
      if (RELATED_PARENT_PART_LIST_UPPER_LIMIT < 1) {
         try { RELATED_PARENT_PART_LIST_UPPER_LIMIT = (java.lang.Integer) wt.introspection.WTIntrospector.getClassInfo(CLASSNAME).getPropertyDescriptor("relatedParentPartList").getValue(wt.introspection.WTIntrospector.UPPER_LIMIT); }
         catch (wt.introspection.WTIntrospectionException e) { RELATED_PARENT_PART_LIST_UPPER_LIMIT = 200; }
      }
      if (relatedParentPartList != null && !wt.fc.PersistenceHelper.checkStoredLength(relatedParentPartList.toString(), RELATED_PARENT_PART_LIST_UPPER_LIMIT, true))
         throw new wt.util.WTPropertyVetoException("wt.introspection.introspectionResource", wt.introspection.introspectionResource.UPPER_LIMIT,
               new java.lang.Object[] { new wt.introspection.PropertyDisplayName(CLASSNAME, "relatedParentPartList"), java.lang.String.valueOf(java.lang.Math.min(RELATED_PARENT_PART_LIST_UPPER_LIMIT, wt.fc.PersistenceHelper.DB_MAX_SQL_STRING_SIZE/wt.fc.PersistenceHelper.DB_MAX_BYTES_PER_CHAR)) },
               new java.beans.PropertyChangeEvent(this, "relatedParentPartList", this.relatedParentPartList, relatedParentPartList));
   }
   ...
   public static final long EXTERNALIZATION_VERSION_UID = 1844659687059142298L;
   ...
   public void writeExternal(java.io.ObjectOutput output) throws java.io.IOException {
      ...
      output.writeObject( massChangeYn );
      output.writeObject( planDate );
      output.writeObject( preVersion );
      output.writeObject( relatedDieNo );
      output.writeObject( relatedParentPartList );
      output.writeObject( secureBudgetYn );
   }

   protected void super_writeExternal_KETProdECABomLink(java.io.ObjectOutput output) throws java.io.IOException {
      super.writeExternal(output);
   }

   public void readExternal(java.io.ObjectInput input) throws java.io.IOException, java.lang.ClassNotFoundException {
      long readSerialVersionUID = input.readLong();
      readVersion( (e3ps.ecm.entity.KETProdECABomLink) this, input, readSerialVersionUID, false, false );
   }
   protected void super_readExternal_KETProdECABomLink(java.io.ObjectInput input) throws java.io.IOException, java.lang.ClassNotFoundException {
   ...
   public void readExternal(wt.pds.PersistentRetrieveIfc input) throws java.sql.SQLException, wt.pom.DatastoreException {
      ...
      massChangeYn = input.getString( "massChangeYn" );
      planDate = input.getTimestamp( "planDate" );
      preVersion = input.getString( "preVersion" );
      relatedDieNo = input.getString( "relatedDieNo" );
      relatedParentPartList = input.getString( "relatedParentPartList" );
      secureBudgetYn = input.getString( "secureBudgetYn" );
   }

   boolean readVersion1844659687059142298L( java.io.ObjectInput input, long readSerialVersionUID, boolean superDone ) throws java.io.IOException, java.lang.ClassNotFoundException {
      if ( !superDone )
         super.readExternal( input );
      ...
      massChangeYn = (java.lang.String) input.readObject();
      ...
      relatedParentPartList = (java.lang.String) input.readObject();
      secureBudgetYn = (java.lang.String) input.readObject();
      return true;
   }

   protected boolean readVersion( KETProdECABomLink thisObject, java.io.ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone ) throws java.io.IOException, java.lang.ClassNotFoundException {
      boolean success = true;

      if ( readSerialVersionUID == EXTERNALIZATION_VERSION_UID )
         return readVersion1844659687059142298L( input, readSerialVersionUID, superDone );
      else
   ...
   protected boolean super_readVersion_KETProdECABomLink( _KETProdECABomLink thisObject, java.io.ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone ) throws java.io.IOException, java.lang.ClassNotFoundException {
