...
public abstract class _KETEarlyWarningPlan extends wt.doc.WTDocument implements java.io.Externalizable {
   static final long serialVersionUID = 1;

   static final java.lang.String RESOURCE = "e3ps.ews.entity.entityResource";
   static final java.lang.String CLASSNAME = KETEarlyWarningPlan.class.getName();

   /**
    * 조직도
    *
    * @see e3ps.ews.entity.KETEarlyWarningPlan
    */
   public static final java.lang.String CFT_MEMBER = "cftMember";
   static int CFT_MEMBER_UPPER_LIMIT = -1;
   java.lang.String cftMember;
   /**
    * 조직도
    *
    * @see e3ps.ews.entity.KETEarlyWarningPlan
    */
   public java.lang.String getCftMember() {
      return cftMember;
   }
   /**
    * 조직도
    ...
    * @see e3ps.ews.entity.KETEarlyWarningPlan
    */
   public void setCftMember(java.lang.String cftMember) throws wt.util.WTPropertyVetoException {
      cftMemberValidate(cftMember);
      this.cftMember = cftMember;
   }
   void cftMemberValidate(java.lang.String cftMember) throws wt.util.WTPropertyVetoException {
      if (CFT_MEMBER_UPPER_LIMIT < 1) {
         try { CFT_MEMBER_UPPER_LIMIT = (java.lang.Integer) wt.introspection.WTIntrospector.getClassInfo(CLASSNAME).getPropertyDescriptor("cftMember").getValue(wt.introspection.WTIntrospector.UPPER_LIMIT); }
         catch (wt.introspection.WTIntrospectionException e) { CFT_MEMBER_UPPER_LIMIT = 4000; }
      }
      if (cftMember != null && !wt.fc.PersistenceHelper.checkStoredLength(cftMember.toString(), CFT_MEMBER_UPPER_LIMIT, true))
         throw new wt.util.WTPropertyVetoException("wt.introspection.introspectionResource", wt.introspection.introspectionResource.UPPER_LIMIT,
               new java.lang.Object[] { new wt.introspection.PropertyDisplayName(CLASSNAME, "cftMember"), java.lang.String.valueOf(java.lang.Math.min(CFT_MEMBER_UPPER_LIMIT, wt.fc.PersistenceHelper.DB_MAX_SQL_STRING_SIZE/wt.fc.PersistenceHelper.DB_MAX_BYTES_PER_CHAR)) },
               new java.beans.PropertyChangeEvent(this, "cftMember", this.cftMember, cftMember));
   }
    ...
    * @see e3ps.ews.entity.KETEarlyWarningPlan
    */
   public static final java.lang.String MANAGE_DESC = "manageDesc";
   static int MANAGE_DESC_UPPER_LIMIT = -1;
   java.lang.String manageDesc;
   /**
    * 중점관리 사항
    *
    * @see e3ps.ews.entity.KETEarlyWarningPlan
    ...
    * @see e3ps.ews.entity.KETEarlyWarningPlan
    */
   public void setManageDesc(java.lang.String manageDesc) throws wt.util.WTPropertyVetoException {
      manageDescValidate(manageDesc);
      this.manageDesc = manageDesc;
   }
   void manageDescValidate(java.lang.String manageDesc) throws wt.util.WTPropertyVetoException {
      if (MANAGE_DESC_UPPER_LIMIT < 1) {
         try { MANAGE_DESC_UPPER_LIMIT = (java.lang.Integer) wt.introspection.WTIntrospector.getClassInfo(CLASSNAME).getPropertyDescriptor("manageDesc").getValue(wt.introspection.WTIntrospector.UPPER_LIMIT); }
         catch (wt.introspection.WTIntrospectionException e) { MANAGE_DESC_UPPER_LIMIT = 4000; }
      }
      if (manageDesc != null && !wt.fc.PersistenceHelper.checkStoredLength(manageDesc.toString(), MANAGE_DESC_UPPER_LIMIT, true))
         throw new wt.util.WTPropertyVetoException("wt.introspection.introspectionResource", wt.introspection.introspectionResource.UPPER_LIMIT,
               new java.lang.Object[] { new wt.introspection.PropertyDisplayName(CLASSNAME, "manageDesc"), java.lang.String.valueOf(java.lang.Math.min(MANAGE_DESC_UPPER_LIMIT, wt.fc.PersistenceHelper.DB_MAX_SQL_STRING_SIZE/wt.fc.PersistenceHelper.DB_MAX_BYTES_PER_CHAR)) },
               new java.beans.PropertyChangeEvent(this, "manageDesc", this.manageDesc, manageDesc));
   }
   ...
   public static final long EXTERNALIZATION_VERSION_UID = -7778940917217195699L;
   ...
   public void writeExternal(java.io.ObjectOutput output) throws java.io.IOException {
      ...
      output.writeObject( cftMember );
      output.writeObject( manageDesc );
   }

   protected void super_writeExternal_KETEarlyWarningPlan(java.io.ObjectOutput output) throws java.io.IOException {
      super.writeExternal(output);
   }

   public void readExternal(java.io.ObjectInput input) throws java.io.IOException, java.lang.ClassNotFoundException {
      long readSerialVersionUID = input.readLong();
      readVersion( (e3ps.ews.entity.KETEarlyWarningPlan) this, input, readSerialVersionUID, false, false );
   }
   protected void super_readExternal_KETEarlyWarningPlan(java.io.ObjectInput input) throws java.io.IOException, java.lang.ClassNotFoundException {
   ...
   public void writeExternal(wt.pds.PersistentStoreIfc output) throws java.sql.SQLException, wt.pom.DatastoreException {
      ...
      output.setString( "cftMember", cftMember );
      output.setString( "manageDesc", manageDesc );
   }
   ...
   public void readExternal(wt.pds.PersistentRetrieveIfc input) throws java.sql.SQLException, wt.pom.DatastoreException {
      ...
      cftMember = input.getString( "cftMember" );
      manageDesc = input.getString( "manageDesc" );
   }

   boolean readVersion_7778940917217195699L( java.io.ObjectInput input, long readSerialVersionUID, boolean superDone ) throws java.io.IOException, java.lang.ClassNotFoundException {
      if ( !superDone )
         super.readExternal( input );
      ...
      cftMember = (java.lang.String) input.readObject();
      manageDesc = (java.lang.String) input.readObject();
      return true;
   }

   protected boolean readVersion( KETEarlyWarningPlan thisObject, java.io.ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone ) throws java.io.IOException, java.lang.ClassNotFoundException {
      boolean success = true;

      if ( readSerialVersionUID == EXTERNALIZATION_VERSION_UID )
         return readVersion_7778940917217195699L( input, readSerialVersionUID, superDone );
      else
   ...
   protected boolean super_readVersion_KETEarlyWarningPlan( _KETEarlyWarningPlan thisObject, java.io.ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone ) throws java.io.IOException, java.lang.ClassNotFoundException {
